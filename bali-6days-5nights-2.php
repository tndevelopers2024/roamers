...
<body>
    ...
    <div class="container">
        ...
        <section class="destination mt-0 mt-lg-5" style="background-color: white; border-radius: 20px;" id="overview">
                ...
                <div class="row g-4 flex-column-reverse flex-md-row align-items-center">
                    ...
                    <div class="col-md-7">
                        <div class="travel-des p-3 p-md-4">
                            <h2 class="mb-3 pt-3">
                                Welcome to the world of Bali!
                            </h2>

                            <p style="color: #555; line-height: 1.8; text-align: justify;" class="desk-desc d-none d-md-block">
                                Embark on an enchanting 6-day journey through the heart of Bali, where ancient spirituality meets tropical luxury. From the emerald rice terraces of Ubud and the sacred Monkey Forest to the iconic sea temples of Tanah Lot and Uluwatu, this curated experience offers the perfect blend of culture, adventure, and relaxation. <br><br>
                                Immerse yourself in vibrant local markets, rejuvenate with traditional Balinese wellness, and soak in world-class sunsets at Seminyak's most exclusive beach clubs. Explore the turquoise waters of Nusa Penida and find peace amidst the lush jungle villas of Ubud. This trip is designed to showcase the very best of the 'Island of the Gods'.
                            </p>

                            <!-- Mobile description (truncated with toggle) -->
                            <p style="color: #555;" class="mob-desc d-block d-md-none">
                                Bali is a mesmerizing island of breathtaking cliffs, emerald rice terraces, and golden sunsets. With its vibrant beach clubs and deep-seated spiritual heritage, it's the ultimate destination for both relaxation and discovery.

                                <br>
                                <span id="dots">......</span>
                                <span id="moreText" style="display: none;"><br><br>
                                    From exploring the iconic T-Rex cliff at Nusa Penida to finding serenity in ancient sea temples and lush monkey forests, this itinerary offers an authentic Balinese experience you'll never forget. Dive into the local food scene, experience traditional wellness, and let the Island of Gods capture your heart!
                                </span>
                            </p>
                            ...
                            <div onclick="toggleReadMore()"
                                ...
                                <span id="readMoreBtn" class="read-more-icon" style="cursor: pointer;">
                                    <i class="fa-solid fa-circle-chevron-down " style="
     color: #4ec0db; 
                            ...
                            <div class="accordion" id="accordionExample">
                                    ...
                                    <h2 class="accordion-header" id="headingOne">
                                        <button
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <span>Arrival in Bali | A Beautiful Beginning</span>
                                            </div>
                                        ...
                                        <div class="accordion-body" style="background-color: #f5fdff;">
                                            ...
                                            <ul class="ps-lg-3 ps-0">
                                                <li class=""><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                    ...
                                                    Arrival & Comfortable transfer to Ubud
                                                </li>
                                                <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>Private transfer to Ubud
                                                </li>
                                                <li><i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>Check-in to your private Pool
                                                    Villa
                                                </li>
                                                <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>Time to relax and unwind
                                                </li>
                                                <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>
                                                    Romantic Candlelight dinner arranged at the villa
                                                </li>
                                                <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>
                                ...
                                <div class="accordion-item mb-4 border  overflow-hidden">
                                    <h2 class="accordion-header" id="headingTwo">
                                        <button
                                            class="accordion-button rounded-4 collapsed d-flex justify-content-between align-items-center text-dark fw-bold"
                                            ...
                                            <div class="d-flex align-items-center w-100">
                                                <span
                                                    ...
                                                    2</span>
                                                <span>Adventure ATV & Romantic Bali Swing
                                                </span>
                                    ...
                                    <div id="collapseTwo" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body" style="background-color: #f5fdff;">
                                            ...
                                            <ul class="ps-lg-3 ps-0">
                                                <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>Bali Swing experience amidst
                                                    lush greenery
                                                </li>
                                                <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>
                                                    ATV ride through jungle trails at Kuber Bali Adventure
                                                <li><i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>Visit Tegalalang Rice Terrace
                                                </li>
                                                <li><i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>Return to villa and relax in
                                                    your private pool
                                                </li>
                                        ...
                                        <button
                                            ...
                                            <div class="d-flex align-items-center w-100">
                                                <span
                                                    class="badge bg-primary rounded-pill me-3 px-3 py-2 animated-badge">Day
                                                    3</span>
                                                <span>A Leisure Day | Cretya Ubud & Sunsets</span>
                                                <i class="bi bi-chevron-down ms-auto transition-arrow"
                                                    style="color:#0c63e4;"></i>
                                            </div>
                                        </button>
                                    ...
                                    <div id="collapse3" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body bg-white px-4 py-3">
                                            <ul class="ps-lg-3 ps-0">
                                                <li><i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>
                                                    Wake up to the refreshing morning & have Floating Breakfast
                                                </li>
                                                <li>
                                                    <i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>
                                                    Visit Monkey Forest & go to Coffee Plantation
                                                </li>
                                                <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>
                                                    Experience traditional Balinese coffee tasting including Luwak
                                                    coffee
                                                    Or Visit Tibumana Waterfalls (optional)
                                                </li>
                                                <li><i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>
                                                    Afternoon visit to Cretya Ubud: A Dayclub for Couples
                                                <li><i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>
                                                    Infinity pool access, Views of Tegalalang Rice Terrace
                                                </li>
                                                <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>A Club with Relaxed ambiance
                                                    with food, beverages & music
                                                </li>
                                                <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>Return to villa & overnight stay
                                                    in Ubud, beverages & music
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                        ...
                                        <button
                                            ...
                                            <div class="d-flex align-items-center w-100">
                                                <span
                                                    class="badge bg-primary rounded-pill me-3 px-3 py-2 animated-badge">Day
                                                    4</span>
                                                <span> Transfer to Seminyak | Beachside Evenings</span>
                                                <i class="bi bi-chevron-down ms-auto transition-arrow"
                                                    style="color:#0c63e4;"></i>
                                            </div>
                                        </button>
                                    ...
                                    <div id="collapse5" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body bg-white px-4 py-3">
                                            <ul class="ps-lg-3 ps-0">
                                                <li><i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>
                                                    Savour Delicious Breakfast & Checkout
                                                </li>
                                                <li>
                                                    <i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>
                                                    Private transfer to Seminyak & Resort Check-in
                                                </li>
                                                <li>
                                                    <i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>
                                                    Day at leisure, Couple spa experience
                                                </li>
                                                <li>
                                                    <i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>
                                                    Sunset at Seminyak Beach & Cafe Hopping
                                                </li>
                                                <li>
                                                    <i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>
                                                    Explore Seminyak Flea Market
                                                </li>
                                                <li>
                                                    <i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>
                                                    Visit Potato Head Beach Club for a relaxed beachfront evening
                                        ...
                                        <button
                                            ...
                                            <div class="d-flex align-items-center w-100">
                                                <span
                                                    class="badge bg-primary rounded-pill me-3 px-3 py-2 animated-badge">Day
                                                    5</span>
                                                <span> Nusa Penida Island Escape</span>
                                                <i class="bi bi-chevron-down ms-auto transition-arrow"
                                                    style="color:#0c63e4;"></i>
                                            </div>
                                        </button>
                                    ...
                                    <div id="collapse6" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body bg-white px-4 py-3">
                                            <ul class="ps-lg-3 ps-0">
                                                <li><i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>
                                                    Early morning pickup & speedboat transfer
                                                </li>
                                                <li>
                                                    <i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>
                                                ...
                                                <li>
                                                    <i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>
                                                    Return to Bali by evening & overnight stay in Seminyak
                                                </li>
                                        ...
                                        <button
                                            ...
                                            <div class="d-flex align-items-center w-100">
                                                <span
                                                    class="badge bg-primary rounded-pill me-3 px-3 py-2 animated-badge">Day
                                                    6</span>
                                                <span> Leisure Morning & Departure</span>
                                                <i class="bi bi-chevron-down ms-auto transition-arrow"
                                                    style="color:#0c63e4;"></i>
                                            </div>
                                        </button>
                                        ...
                                        <div class="accordion-body bg-white px-4 py-3">
                                            <ul class="ps-lg-3 ps-0">
                                                ...
                                                <li>
                                                    <i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>
                                                    Leisure time by the beach or café
                                                </li>
                                                <li>
                                                    <i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>
                                                    Optional visit to Uluwatu Temple
                                                </li>
                                                <li>
                                                    <i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>
                                                ...
                                                <li>
                                                    <i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>
                                                    End your honeymoon with unforgettable memories.
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                        ...
                        <section id="inclusion" class="">
                            <div class="important-notes"
                                ...
                                <div id="">
                                    <p>
                                        ...
                                        Airport Transfer by AC Coach on private basis
                                    </p>

                                    <p> <i class="fa-solid fa-circle-check me-2 pulse" style="color: green;"></i>
                                        Tours as mentioned on the above program
                                    </p>

                                    <p> <i class="fa-solid fa-circle-check me-2 pulse" style="color: green;"></i>
                                        Entrance Ticket to Tourism object as per mentioned in the day wise Itinerary
                                    </p>

                                    <p> <i class="fa-solid fa-circle-check me-2 pulse" style="color: green;"></i>
                                        Accommodation & Meals as per program
                                    </p>
                                    <p> <i class="fa-solid fa-circle-check me-2 pulse" style="color: green;"></i>
                                        Nusa Penida Tour as per Program </p>
                                    <p>
                                        <i class="fa-solid fa-circle-check me-2 pulse" style="color: green;"></i>
                                        English Speaking Driver cum Guide during Arrival - Tour Departure
                                    </p><span class="mobile-br"><br></span>

                                    <p><i class="fa-solid fa-circle-check me-2 pulse" style="color: green;"></i>
                                        Welcome garland at airport
                                    </p>
                            ...
                            <div class="important-notes"
                                ...
                                <h3 class="head" style="text-align: center; margin-bottom: 20px; margin-left: 10px;">
                                    Exclusion</h3>
                                <div>
                                    <p> <i class="fa-solid fa-circle-xmark me-2 pulse" style="color: red;"></i>Tipping
                                        guide & Insurance</p>

                                    <p><i class="fa-solid fa-circle-xmark me-2 pulse" style="color: red;"></i>
                                        Personal Expenses (Shopping, mini bar, laundry dll)
                                        </a>
                                    </p>
                                    ...
                                    <p><i class="fa-solid fa-circle-xmark me-2 pulse" style="color: red;"></i>
                                        Toursim Levy (Tourism Tax Rp 150,000 Per Person)
                                    </p>
                                </div>
                            </div>
                        </section>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="price-sticky" style="position: sticky;">
                            <div class="priceCard shadow" style="border-radius: 10px;">
                                <img src="https://images.unsplash.com/photo-1537996194471-e657df975ab4?auto=format&fit=crop&q=80&w=600" alt="Bali Banner"
                                ...
                                <div class="p-2">
                                    <div class="inner-box"
                                        ...
                                        <h5 class="special-offer">
                                            ...
                                            <!-- <span class="new-price"></span><span class="new-price">OPEN</span> -->
                                        </h5>
    ...
    <!-- <div class="mobile-bottom-bar">
        <div class="bottom-bar-content">
            ...
            <a href="Bali-grouptrip-form.php" class="btn-book">Dates & Costing</a>
        </div>
    </div> -->
  ...
  <i class="fa-solid fa-circle-chevron-up "
     style="
        color: #4ec0db; 
       background-color:rgb(255, 255, 255); 
       font-size: 16px; 
