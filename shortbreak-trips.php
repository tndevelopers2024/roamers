...
<main>
  ...
  <div class=container>
    ...
    <ul class="nav-pills upper-nav mt-5 ">
      ...
      <li><a class="trip-3 active rounded-pill me-3 shadow" href="#section3 ">Short Break Trips</a></li>
    ...
    <!-- Short Break Trips -->
    <div id="section3" class="section active mb-5">
      <div class="container">
        <div class="row">
                ...
                <div class="event-card">
                  <div class="event-content" style="position: relative;">
                    ...
                    <div style="position: absolute; top: 0; left: 0; width: 100%; z-index: 2; margin-top: 229px; ">
                      ...
                      <div class="event-price-section " style=" margin: 0;  padding: 0px 12px 0px 12px;">
