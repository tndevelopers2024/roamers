...
<body>
  ...
  <section class="trip-home">
    <div class="container" style="  position: relative;">
      ...
      <!-- <ul class="des-sub">
        <li>
          Matrimandir <img src="assets/img/icon/Arrow-head.png" class="arrow-right" alt="roamers-trip">
        </li>
        <li>
          Paradise Beach <img src="assets/img/icon/Arrow-head.png" class="arrow-right" alt="roamers-trip">
        </li>
        <li>
          Mangrove Forest
        </li>
      ...
      <div class="row desktop-inform">
        <div class="col-md-4 col-4">
          <div class="trip-inner">
            ...
            <h2><span class="pondi-price"></span>/-</h2>
          </div>
        </div>
        <div class="col-md-4 col-4">
          <div class="trip-inner">
      ...
      <div class="row">
        ...
        <div class="col-md-7" style="display: grid; place-items: center;">
          <div class="travel-des">
            ...
            <a style="width: 200px" href="pondicherry-form" class="btn Get-Itinerary butn butn__new"> <i
              ...
              <!-- <div class="accordion-item ai1">
                ...
                <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                  ...
                  <div class="accordion-body">
                    ...
                    <ul class="acc-inner">
                      <li>
                        Hello Roamers! Get ready to embark on an exciting journey as we head from Chennai to
                        Pondicherry.
                      </li>
              ...
              <div class="accordion-item ai1">
                <h2 class="accordion-header" id="headingTwo">
                  <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo"
                    ...
                    <div class="days"> Day 1</div>: ARRIVAL & EXPLORING PONDY CHARMS
                  </button>
                </h2>
                <div id="collapseTwo" class="accordion-collapse collapse show" aria-labelledby="headingTwo"
                  ...
                  <div class="accordion-body">
                    ...
                    <ul class="acc-inner">
                      <li>
                        Hello Roamers! Let's assemble by 8 AM at the designated point in Chennai and gear up for an
                        exciting adventure!
                      </li>
                      <li>
                        Let’s check into Resort. Time to hop on a boat for a scenic ride along the backwaters to reach
                        'Paradise Beach' a secluded oasis.
                      </li>
                      <li>
                        Dive into the refreshing water or simply relax in the tranquility of this paradise-like setting.
                      </li>
                      <li>
                        Let’s explore 'White Town'—quaint streets, Rock beach, French churches, cool boutiques, vibrant
                        cafes, and Instagram-worthy spots await the gang!
                      </li>
                      <li>
                        Let’s return to the resort and have leisure time with fellow travellers, have a delicious dinner
                        and settle in for an overnight stay.
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div class="accordion-item ai1">
                <h2 class="accordion-header" id="headingTwo">
                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                    ...
                    <div class="days"> Day 2</div>: PICHAVARAM MANGROVE ADVENTURE | SERENITY & SANDUNES BEACH
                  </button>
                </h2>
                <div id="collapse3" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                  ...
                  <div class="accordion-body">
                    ...
                    <ul class="acc-inner">
                      <li>
                        Sunrise at Serenity Beach awaits!
                      </li>
                      <li>
                        Let’s Savour breakfast with the team, then kickstart our day.
                      </li>
                      <li>
                        We’ll head to the world's 2nd largest mangrove forest, Pichavaram Mangrove Forest.
                      </li>
                      <li>
                        Enjoy an adventurous boating experience amidst this rare, rooted landscape.
                      </li>
                      <li>
                        Let’s end our day at Sand Dunes Paradise Beach, a true heaven for beach lovers.
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div class="accordion-item ai1">
                <h2 class="accordion-header" id="headingTwo">
                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                    ...
                    <div class="days">
                      DAY 3 </div>: AUROVILLE | MATRI MANDIR, SOUND GARDEN & FAREWELL
                  </button>
                </h2>
                <div id="collapse6" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                  ...
                  <div class="accordion-body">
                    ...
                    <ul class="acc-inner">
                      <li>Let’s check out, and post-breakfast, our journey leads to Auroville.</li>
                      <li>We’ll go on a short trail to witness the Golden Matrimandir, an architectural marvel known for
                        its spiritual significance.</li>
                      <li>
                        Let’s indulge in a farewell lunch with Roamers at a popular local cafe.
                      </li>
                      <li>
                        Next, we’ll take a casual stroll through Auroville Village for street shopping and cafe hopping.
                      </li>
                      <li>
                        It’s time to bid farewell to Roamers and this amazing place.
                      </li>
                      <li>
                        We’ll drive back to Chennai, carrying with us great memories and newfound friendships from this
              ...
              <div class="accordion-item ai1">
                ...
                <div id="collapse4" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                  ...
                  <div class="accordion-body">
                    ...
                    <ul class="acc-inner">
                      <li>
                        In just 3 days, we shared thrills, spills, and countless good times. Let's plan a reunion
            ...
            <div class="wrapper">
              ...
              <section id="first-tab-group" class="tabgroup">
                <div id="tab1">
                  ...
                  <p>
                    Includes Pichavaram Mangrove Boating.
                  </p>
                  <p>
          ...
          <div class="sticky-sidebar">
            ...
            <div class="trip-tab">
              <ul class="nav nav-pills trip-nav mb-3" id="pills-tab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                  <button class="nav-link " id="pills-apr-tab" data-bs-toggle="pill" data-bs-target="#pills-jan"
                    type="button" role="tab" aria-controls="pills-apr" aria-selected="false">Jan</button>
                </li>
                <li class="nav-item" role="presentation">
                  <button class="nav-link" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-feb"
                    type="button" role="tab" aria-controls="pills-home" aria-selected="true">Feb</button>
                </li> -->
                <li class="nav-item" role="presentation">
                  <button class="nav-link active" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-mar"
                    type="button" role="tab" aria-controls="pills-home" aria-selected="true">Mar</button>
                </li>
                <li class="nav-item" role="presentation">
                  <button class="nav-link" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-apr"
                    type="button" role="tab" aria-controls="pills-home" aria-selected="true">Apr</button>
                </li>
              ...
              <div class="tab-content tab-con" id="pills-tabContent">
                ...
                <!-- <div class="tab-pane fade" id="pills-jan" role="tabpanel" aria-labelledby="pills-apr-tab">
                  <div class="upcoming-slot ">
                    <h3>Jan 10</h3>
                  </div>
                ...
                <!-- <div class="tab-pane fade" id="pills-feb" role="tabpanel" aria-labelledby="pills-apr-tab">
                  <div class="upcoming-slot ">
                    <h3>Feb 07</h3>
                  </div>
                ...
                <div class="tab-pane fade show active" id="pills-mar" role="tabpanel" aria-labelledby="pills-apr-tab">
                  <div class="upcoming-slot ">
                    <h3>Mar 07</h3>
                  </div>
            ...
            <div class="occupancy">
              <div class="price-occupancy">
                <select class="price-occupancy1" name="" id="">
                  <option value="8490">Double Sharing</option>
                  <!-- <option value="">Quad Sharing</option> -->
                  <option value="7490" selected>Triple Sharing</option>
                </select>
              </div>
              <div class="price-occupancy">
            ...
            <div class="price">
              <h4>Price</h4>
              <p id="price">₹7,490 <span class="per-person">Per Person</span></p>
            </div>
            <script>
    ...
    <div class="slider">
      <div class="slider-container">
        ...
        <div class="slider-item2">
          <div class="silder-pad">
            <div class="slid-img">
              <img class="cus-img" src="assets/img/pondicherry/Media/pichavaram.jpg" alt="roamers-Gallery">
            </div>
            <div class="cust-inner">
              <h3> </h3>
