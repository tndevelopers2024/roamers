...
<head>
    ...
    <meta name="description" content="Roamers - Ultimate Ladakh Circuit - 7 Days with Umling La & Tso Moriri" />
    <meta name="author" content="Themeland" />
    <meta property="og:image:width" content="700" />
    <meta property="og:image:height" content="500" />

    <!-- Basic Open Graph tags -->
    <meta property="og:title" content="Roamers - Ultimate Ladakh Circuit - 7 Days" />
    <meta property="og:description"
        content="Join our Ultimate Ladakh Circuit for an unforgettable 7-day adventure covering Leh, Nubra, Pangong, Hanle, Umling La, and Tso Moriri." />
    ...
    <meta name="twitter:title" content="Roamers - Ultimate Ladakh Circuit - 7 Days" />
          ...
          style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: contain; object-position: top; z-index: 0; opacity: 1;">  -->
                ...
                <div class="" style="position: relative; z-index: 1; text-align: center;">
                    ...
                    <ul class="banner-hight-bottom p-0"
                        ...
                        <li class=" me-2 mobile-small-text"
            ...
            <div class="container">
                <section class="destination mt-0 mt-lg-5"
                    ...
                    id="overview">
                    <img style="width:820px; margin-top:210px" src="assets/img/ladakh/elements/about-bg.png"
                        class="about-bg-img" alt="">
                            ...
                            <div class="col-md-7">
                                <div class="travel-des p-3 p-md-4">
                                    ...
                                    <p style="color: #555;" class="desk-desc d-none d-md-block">
                                        Get ready to experience Ladakh like never before! Whether you're riding through
                                        the rugged mountains
                                        on a bike or joining the journey in a comfy Traveller, this adventure covers it
                                        all: Leh, Khardung
                                        La, Nubra Valley, Pangong Lake, Hanle, Umling La, Tso Moriri, and more. From
                                        epic
                                        roads and
                                        dramatic landscapes
                                        to starry nights and unforgettable memories, this trip is built for those who
                                        crave both adventure
                                        and adventure only!
                                        <br><br>
                                        Ride through some of the world’s highest motorable passes, enjoy camel rides and
                                        ATVs in Nubra, and
                                        feel the calm magic of Pangong’s crystal-clear waters. Reach Umling La, sitting
                                        even higher than
                                        Everest Base Camp, and witness the pristine beauty of Tso Moriri Lake. This trip
                                        blends adventure,
                                        fun, and raw beauty into one epic experience. It’s not just a Ride, it’s the
                                        kind of journey you’ll remember forever.
                                    ...
                                    <p style="color: #555;" class="mob-desc d-block d-md-none">
                                        ...
                                        <span id="moreText" style="display: none;"><br><br>
                                            Ride through some of the world’s highest motorable passes, enjoy camel rides
                                            and ATVs in Nubra,
                                            and feel the calm magic of Pangong’s crystal-clear waters. Reach Umling La,
                                            sitting even higher
                                            than Everest Base Camp, and witness the pristine beauty of Tso Moriri Lake.
                                            This trip blends
                                            adventure,
                                            fun, and raw beauty into one epic experience.
     ...
     margin-top: 5px;">
                    ...
                    <img src="assets/img/wayanad/Edakkal%20caves.jpg" class="img-fluid w-100"
                      alt="Wayanad" style="border-radius: 10px; height: 350px; object-fit: cover;">
                                        ...
                                        <div class="swiper-slide">
                                            <img src="assets/img/ladakh/ladakh-img2.jpg"
                                                class="img-fluid w-100 about-img" alt="Wayanad">
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="container cont-fluid">
                    <div class="row">
                        ...
                        <div class="col-md-8 mt-0 mt-md-5 ">
                            <h3 class="mt-5 mt-md-0 head"
                                style="text-align: center; margin-bottom: 20px; margin-left: 10px;">
                                Trip Itinerary
                            </h3>
                            <div>
                                            ...
                                            <button
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <span class="badge bg-primary rounded-pill me-3 px-3 py-2">Day
                                                        1</span>
                                                    <span>Arrival in Leh - Leisure day for Accumulisation</span>
                                                </div>
                                            ...
                                            <div class="accordion-body" style="background-color: #f5fdff;">
                                                <ul class="ps-lg-3 ps-0">
                                                    <li>
                                                        ...
                                                        Arrive at Leh airport after a stunning flight over the majestic
                                                        Himalayas.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        Meet Roamers representative who will assist you with a
                                                        comfortable transfer to your hotel.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        Complete the check-in formalities and meet your co-travellers
                                                        and relax at leisure
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        Go for a short walk around your hotel, visit Leh Market or
                                                        Shanti Stupa. accumulate yourself to the altitude better.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                            ...
                                            <button
                                                ...
                                                <div class="d-flex align-items-center w-100">
                                                    <span
                                                        ...
                                                        2</span>
                                                    <span>Leh → Nubra Valley via Khardung La</span>
                                            ...
                                            <div class="accordion-body bg-white px-4 py-3">
                                                <ul class="ps-lg-3 ps-0">
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        Start your day with a delicious breakfast at your hotel in Leh,
                                                        get ready for the adventure ahead.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        Gear up for an unforgettable drive as you begin your ascent
                                                        along one of the highest motorable roads in the world.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        Feel the thrill as you drive towards Nubra Valley, nestled
                                                        between the Karakoram and Ladakh ranges, offering dramatic views
                                                        all around.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        The first major stop is Khardung-La Pass, sitting at a
                                                        staggering 5,359 meters, where you'll have time to take in the
                                                        sweeping mountain vistas.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        Descend along the route tracing the Shyok River, entering the
                                                        stunning landscapes of Nubra Valley, also known as Ldumra or the
                                                        Valley of Flowers.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        As you approach Diskit, the heart of Nubra, visit the famed
                                                        Diskit Monastery, home to a towering 106-foot statue of Maitreya
                                                        Buddha overlooking the valley.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        Later, head to the white-sand dunes of Hunder, a cold desert
                                                        with surreal scenery straight out of a dream.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        Here, you can opt to enjoy unique experiences like a
                                                        double-humped Bactrian camel ride or an adventurous ATV ride
                                                        across the dunes (at your own cost).
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        After a full day of exploration, make your way to the campsite
                                                        or hotel where you’ll be staying.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                            ...
                                            <button
                                                ...
                                                <div class="d-flex align-items-center w-100">
                                                    <span
                                                        class="badge bg-primary rounded-pill me-3 px-3 py-2 animated-badge">Day
                                                        3</span>
                                                    <span>Nubra → Charming Pangong Lake</span>
                                                    <i class="bi bi-chevron-down ms-auto transition-arrow"
                                                        style="color:#0c63e4;"></i>
                                                </div>
                                            </button>
                                            ...
                                            <div class="accordion-body bg-white px-4 py-3">
                                                <ul class="ps-lg-3 ps-0">
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        Wake up to the serene views of Nubra Valley and prepare for yet
                                                        another adventurous drive.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        En route, pass through the picturesque villages of Agam and
                                                        Shyok, known for their untouched beauty and peaceful landscapes.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        As the journey unfolds, you'll be greeted by the first glimpses
                                                        of ‘Pangong Lake’ an awe-inspiring sight that makes the ride
                                                        truly worthwhile.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        Situated at an altitude of 4,300 meters, Pangong is one of the
                                                        highest saltwater lakes in the world, stretching over 136 km
                                                        with a width of around 4 km.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        Spend time soaking in the tranquility of the lake and admiring
                                                        how the surrounding mountains reflect beautifully in its
                                                        ever-changing blue waters.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        Don't forget to stop by the famous "3 Idiots" movie spot, a
                                                        perfect place for fun photos and memories.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        After taking in the views, check in at your campsite by the
                                                        lakeside and enjoy a warm, delicious dinner.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        Overnight Camping near Pangong Lake.
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                            ...
                                            <button
                                                ...
                                                <div class="d-flex align-items-center w-100">
                                                    <span
                                                        class="badge bg-primary rounded-pill me-3 px-3 py-2 animated-badge">Day
                                                        4</span>
                                                    <span>Pangong → Hanle via Chushul</span>
                                                    <i class="bi bi-chevron-down ms-auto transition-arrow"
                                                        style="color:#0c63e4;"></i>
                                                </div>
                                            </button>
                                            ...
                                            <div class="accordion-body bg-white px-4 py-3">
                                                <ul class="ps-lg-3 ps-0">
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        Wake up to the breathtaking beauty of Pangong Lake and enjoy a
                                                        warm breakfast at your lakeside campsite.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        Afterward, gear up for an offbeat and adventurous drive to the
                                                        remote village of Hanle, nestled deep in the Changthang region
                                                        of Ladakh.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        Begin by passing through the quiet town of Chushul, with a stop
                                                        at the historically significant Rezang La War Memorial.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        Built in memory of the brave soldiers who laid down their lives
                                                        in the 1962 Indo-China War, the memorial is a powerful reminder
                                                        of their courage and sacrifice.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        After paying your respects, continue the journey with a lunch
                                                        stop along the way, depending on the time and location.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        Drive across the scenic Loma Bridge spanning the Indus River and
                                                        make your way through Ladakh’s striking high-altitude terrain.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        By evening, arrive in the peaceful village of Hanle and check in
                                                        to your welcoming homestay for some well-deserved rest & a
                                                        delicious dinner.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                            ...
                                            <button
                                                ...
                                                <div class="d-flex align-items-center w-100">
                                                    <span
                                                        class="badge bg-primary rounded-pill me-3 px-3 py-2 animated-badge">Day
                                                        5</span>
                                                    <span>Hanle → Umling La Pass → Tso Moriri Lake</span>
                                                    <i class="bi bi-chevron-down ms-auto transition-arrow"
                                                        style="color:#0c63e4;"></i>
                                                </div>
                                            </button>
                                            ...
                                            <div class="accordion-body bg-white px-4 py-3">
                                                <ul class="ps-lg-3 ps-0">
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        Start your day with a hearty breakfast at the homestay and
                                                        prepare for one of the most exciting adventures of your Ladakh
                                                        journey.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        Buckle up Roamers! Set out on a thrilling drive to Umling La
                                                        Pass, the highest motorable road in the world.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        Drive through Ladakh’s surreal high-altitude desert landscapes
                                                        while crossing ‘Photi La Pass’ en route.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        Arrive at Umling La Pass (5,640 m), even higher than Everest
                                                        Base Camp, a perfect spot for a memorable picture of your Ladakh
                                                        journey.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        Begin the descent through remote Ladakhi villages and vast
                                                        high-altitude plains, crossing Nurbu La Pass along the way.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        Continue your scenic drive towards the magnificent Tso Moriri
                                                        Lake, one of the most pristine high-altitude lakes in Ladakh.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        By evening, arrive at the tranquil shores of Tso Moriri Lake,
                                                        surrounded by dramatic mountains and endless blue waters.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        Check in to your camp or guesthouse and unwind in the peaceful
                                                        atmosphere of this remote Himalayan paradise.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        Relish a warm dinner & Overnight stay near Tso Moriri.
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                            ...
                                            <button
                                                ...
                                                <div class="d-flex align-items-center w-100">
                                                    <span
                                                        class="badge bg-primary rounded-pill me-3 px-3 py-2 animated-badge">Day
                                                        6</span>
                                                    <span>Tso Moriri Lake → Leh (Farewell Night)</span>
                                                    <i class="bi bi-chevron-down ms-auto transition-arrow"
                                                        style="color:#0c63e4;"></i>
                                                </div>
                                            </button>
                                            ...
                                            <div class="accordion-body bg-white px-4 py-3">
                                                <ul class="ps-lg-3 ps-0">
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        Wake up early to witness the beautiful sunrise over the serene
                                                        waters of Tso Moriri Lake.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        After breakfast, begin your scenic drive back to Leh.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        En route, pass the stunning landscapes of Tso Kar Lake and the
                                                        vast high-altitude plains of More Plains.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        Continue the journey by crossing the iconic Tanglang La Pass,
                                                        one of the highest mountain passes in the world.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        Arrive in Leh by evening and check in to your hotel.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        Later, you may explore the vibrant Leh market for shopping, café
                                                        hopping, and tasting local Ladakhi delicacies.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                            ...
                                            <button
                                                ...
                                                <div class="d-flex align-items-center w-100">
                                                    <span
                                                        class="badge bg-primary rounded-pill me-3 px-3 py-2 animated-badge">Day
                                                        7</span>
                                                    <span>End of the Ladakh Expedition & Departure from Leh</span>
                                                    <i class="bi bi-chevron-down ms-auto transition-arrow"
                                                        style="color:#0c63e4;"></i>
                                                </div>
                                            </button>
                                            ...
                                            <div class="accordion-body bg-white px-4 py-3">
                                                <ul class="ps-lg-3 ps-0">
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        Wake up and get ready for a relaxed morning as we prepare to
                                                    ...
                                                    <li>
                                                        ...
                                                        experiences and new friendships. Drop at Leh Airport
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;">
                                                        </i>
                                                        If you have late flights, visit Leh Gurudhwara or Magnetic hill.
                                                        Bye Roamers, What an
                            ...
                            <section id="inclusion">
                                <div class="important-notes shadow"
                                    style="border-radius: 30px; background-color:rgb(245, 255, 246);">
                                    <h3 class="head"
                                    ...
                                    <div>
                                        ...
                                        <p>
                                            <i class="fa-solid fa-circle-check me-2 pulse" style="color: #1fa463;"></i>
                                            Fuel included for the entire bike journey, covering the route from Leh to
                                            Leh
                                        </p>
                                        <p>
                                            <i class="fa-solid fa-circle-check me-2 pulse" style="color: #1fa463;"></i>
                                            Comfortable travel in a Tempo Traveler or cab for those selecting the
                                            non-biking option
                                        </p>
                                        <p>
                                            <i class="fa-solid fa-circle-check me-2 pulse" style="color: #1fa463;"></i>
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <p>1 night in a traditional homestay in Hanle</p>
                                            </li>
                                            <li>
                                                <p>1 night in camp or guesthouse near Tso Moriri Lake</p>
                                            </li>
                                        </ul>
                                        </p>
                                        <p>
                                        ...
                                        <p>
                                            <i class="fa-solid fa-circle-check me-2 pulse" style="color: #1fa463;"></i>
                                            <span style="font-size: 0.95em; color: #555;">
                                                (Kindly note: Private taxi service for individual transfers will not be
                                                provided; group
                                        ...
                                        <p>
                                            <i class="fa-solid fa-circle-check me-2 pulse" style="color: #1fa463;"></i>
                                            <span style="font-size: 0.95em; color: #555;">
                                                <b>Note:</b> It's advisable to carry your own helmet for better fit and
                                                comfort
                                            </span>
                                        </p>
                            ...
                            <!-- Exclusion Section -->
                            <div class="important-notes shadow"
                                style="border-radius: 30px; background-color: rgb(255, 244, 244);" id="exclusion">
                                ...
                                <div>
                                    ...
                                    <p>
                                        <i class="fa-solid fa-circle-xmark me-2 pulse" style="color: #ff6b6b;"></i>
                                        Any meals, snacks, or beverages not specifically mentioned in the inclusions,
                                        such as lunch during
                                        travel days, mineral water, or alcoholic drinks.
                                    </p>
                                    <p>
                                        <i class="fa-solid fa-circle-xmark me-2 pulse" style="color: #ff6b6b;"></i>
                                        Personal expenses including but not limited to laundry, telephone bills,
                                        souvenirs, entry fees to
                                        monasteries or monuments, camera/video charges, tips, camel rides, or river
                                        rafting.
                                    </p>
                                    <p>
                                        <i class="fa-solid fa-circle-xmark me-2 pulse" style="color: #ff6b6b;"></i>
                                        Expenses incurred due to unforeseen circumstances like natural disasters,
                                        landslides, or road
                                    ...
                                    <p>
                                        <i class="fa-solid fa-circle-xmark me-2 pulse" style="color: #ff6b6b;"></i>
                                        Any damage caused to the motorcycle (excluding engine damage) during the trip
                                        will be the
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="price-sticky" style="position: sticky;">
                                ...
                                <div class="priceCard shadow" style="border-radius: 30px;">
                                    <video src="assets/video/ladakh.mov" autoplay loop muted playsinline
                                        alt="Wayanad Banner" style="object-fit:cover; border-radius: 30px;">
                                    </video>
                                </div>
