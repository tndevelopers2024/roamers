                        ...
                        <a href="ooty">
                            <div class="trip-card-inner">
                                ...
                                <div class="silder-inner silder-inner1">
                                    ...
                                    <div class="inner">
                                        <p>
                                            <img src="assets/img/images/loc.svg" alt="location-icon">
                                            Nilgiri, Coonoor, Coimbatore
                                        </p>
                        ...
                        <a href="varkala-grouptrip">
                            <div class="trip-card-inner">
                                ...
                                <div class="silder-inner silder-inner1">
                                    ...
                                    <h2>Varkala & Munroe Flashpacking</h2>
                                    <div class="inner">
                                        <p>
                                            <img src="assets/img/images/loc.svg" alt="location-icon">
                                            Varkala, Munroe Island, Trivandrum
                                        </p>
                                        <h4 class="sta">Starts at</h4>
                                    </div>
                                    <div class="inner">
                                        <h4 style="padding-right: 20px;">
                                            <img src="assets/img/images/date.svg" alt="second location-icon">
                                            <span class="varkala-dates">Jan 12, Feb 16</span>
                                        </h4>
                                        <h4>
                                            <span class="varkala-price">₹8,490</span>
                                        </h4>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="trip-card-inner">
                                ...
                                <div class="silder-inner silder-inner1">
                                    ...
                                    <div class="inner">
                                        ...
                                        <h4>
                                            <span class="wayanad-price">₹7,990</span>
                                        </h4>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="trip-card-inner">
                                ...
                                <div class="silder-inner silder-inner1">
                                    ...
                                    <div class="inner">
                                        ...
                                        <h4>
                                            <span class="spiti-price">₹21,990</span>
                                        </h4>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="trip-card-inner">
                                ...
                                <div class="silder-inner silder-inner1">
                                    ...
                                    <div class="inner">
                                        <h4 style="padding-right: 20px;">
                                            <img src="assets/img/images/date.svg" alt="second location-icon">
                                            <span class="pondi-dates">Nov 24, Dec 09, 23</span>
                                        </h4>
                                        <h4>
                                            <span class="pondi-price"></span>
                                        </h4>
                                    </div>
                                </div>
                            </div>
                        ...
                        <a href="kolukkumalai-trek">
                            <div class="trip-card-inner">
                                ...
                                <div class="silder-inner silder-inner1">
                                    ...
                                    <h2>Munnar with Kolukkumalai Bagpacking</h2>
                                    <div class="inner">
                                        <p>
                                            <img src="assets/img/images/loc.svg" alt="location-icon">
                                            Munnar
                                    ...
                                    <div class="inner">
                                        <h4 style="padding-right: 20px;">
                                            <img src="assets/img/images/date.svg" alt="second location-icon">
                                            <span class="munnar-dates">Jan 12, Feb 16</span>
                                        </h4>
                                        <h4>
                                            <span class="munnar-price">₹7,990</span>
                                        </h4>
                                    </div>
                                </div>
                            </div>
                        ...
                        <a href="chikmagalur">
                            <div class="trip-card-inner">
                                ...
                                <div class="silder-inner silder-inner1">
                                    ...
                                    <h2>Chikmagalur Bagpacking</h2>
                                    <div class="inner">
                                        <p>
                                            <img src="assets/img/images/loc.svg" alt="location-icon">
                                            Chikmagalur, Z point, Hebbe Falls
                                        </p>
                                        <h4 class="sta">Starts at</h4>
                                    </div>
                                    <div class="inner">
                                        ...
                                        <h4>
                                            <span class="chik-price">₹7,990</span>
                                        </h4>
                                    </div>
                                </div>
                            </div>
                        ...
                        <a href="kodaikanal">
                            <div class="trip-card-inner">
                                ...
                                <div class="silder-inner silder-inner1">
                                    ...
                                    <h2>Kodaikanal Trek with Poombarai</h2>
                                    <div class="inner">
                                        <p>
                                            <img src="assets/img/images/loc.svg" alt="location-icon">
                                            Perumal peak, Vattakanal, Poombarai
                                        </p>
                                        <h4 class="sta">Starts at</h4>
                                    </div>
                                    <div class="inner">
                                        <h4 style="padding-right: 20px;">
                                            <img src="assets/img/images/date.svg" alt="second location-icon">
                                            <span class="kodai-dates">Jan 26, Feb 10</span>
                                        </h4>
                                        <h4>
                                            <span id="kodai-price">₹7,999</span>
                                        </h4>
                                    </div>
                                </div>
                            </div>
