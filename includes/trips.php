                        ...
                        <a href="munnar-alleppey3">
                            ...
                            <div class="silder-inner silder-inner1">
                                <div class="inner inner2 inner-home">
                                    <h3>3 DAYS / 2 NIGHTS</h3>
                                    <h4><img src="assets/img/images/loc1.svg" class="exicon"
                                            alt="second location-icon">EX: Kochi, Chennai
                                    </h4>
                                </div>
                                <h2>Munnar Alleppey</h2>
                                <p><img src="assets/img/images/loc.svg" alt="location-icon"> Munnar, Alappuzha
                                </p>
                                <div class="inner">
                                    <h4 style="padding-right: 20px;"><img src="assets/img/images/date.svg"
                                            alt="second location-icon">
                    ...
                    <!-- <div class="swiper-slide">
                        <a href="kerala">
                            ...
                            <div class="silder-inner silder-inner1">
                                ...
                                <div class="inner">
                                    <p><img src="assets/img/images/loc.svg" alt="location-icon">Vagamon, Varkala,
                                        Alleppey</p>
                                    <h4 class="sta">Starts at </h4>
                                </div>
            ...
            <a href="kodaikanal">
              ...
              <div class="silder-inner silder-inner1">
                ...
                <div class="inner">
                  ...
                  <h4><span id="kodai-price">₹7,999</span> </h4>
                </div>
              </div>
            </a>
          </div> -->
