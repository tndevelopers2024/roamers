        ...
        <div class="container ">
            <div class="collapse navbar-collapse" id="navbarNav"
                ...
                <ul class="navbar-nav m-0 main-nav menu-none1">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#backpacking"> Backpacking trips</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#shortbreak">Short Break trips</a>
                    </li>
            ...
            <a class="navbar-brand" href="index.php">
                ...
                <img src="../assets/img/Logo/Roamers.png" class="img-fluid d-block d-md-none" alt="logo"></a>
