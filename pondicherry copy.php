      ...
      <div class="row">
              ...
              <div class="accordion-item ai1">
                <h2 class="accordion-header" id="headingTwo">
                  <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo"
                    ...
                    <div class="days"> Day 1</div>: AUROVILLE EXPLORATION, BEACH AND PONDICHERRY
                  </button>
                </h2>
                <div id="collapseTwo" class="accordion-collapse collapse show" aria-labelledby="headingTwo"
                  ...
                  <div class="accordion-body">
                    ...
                    <ul class="acc-inner">
                      <li>
                        Hello Roamers! Let's assemble by 7 AM at the designated point in Chennai and gear up for an
                        exciting adventure!
                      </li>
                      <li>
                        Let's Begin our journey to Auroville. Go on short trial and witness the Golden
                        Matrimandir. An architectural marvel tranquility.
                      </li>
                      <li>
                        Let's take a casual stroll in Auroville Community Village, grab some lunch together, and then
                        let's go shopping!
                      </li>
                      <li>
                        Next up, let's soak in the tranquil atmosphere of Auroville Beach, renowned for its serene hush
                        and exotic charm.
                      </li>
                      <li>
                        Late eve, we'll check into our hotel in Pondicherry, unwind, enjoy leisure time, and have a
              ...
              <div class="accordion-item ai1">
                <h2 class="accordion-header" id="headingTwo">
                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                    ...
                    <div class="days"> Day 2</div>: EXPLORING PONDI CHARMS
                  </button>
                </h2>
                <div id="collapse3" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                  ...
                  <div class="accordion-body">
                    ...
                    <ul class="acc-inner">
                      <li>
                        After delish breakfast, let's head to Chunnambar Boat House and hop on a boat for a scenic ride
                        along the backwaters to
                      ...
                      <li>
                        Post lunch, we'll visit Pondicherry's iconic Lighthouse for city and Bay of Bengal panoramic
                        views.
                      </li>
                      <li>
                        Start exploring 'White Town', the French colony. Quaint
                        streets, French Churches, cool boutiques, vibrants
                        cafes, street shopping, and instagram-worthy pic awaits gang!
                      </li>
                      <li>
                        Experience the vibrant nightlife, relish delicious street foods while exploring Pondicherry, and
              ...
              <div class="accordion-item ai1">
                <h2 class="accordion-header" id="headingTwo">
                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                    ...
                    <div class="days">
                      DAY 3 </div>: SERINITY BEACH AND MANGROVE ADVENTURE | FAREWELL
                  </button>
                </h2>
                <div id="collapse6" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                  ...
                  <div class="accordion-body">
                    ...
                    <ul class="acc-inner">
                      <li>Sunrise at Serentiy Beach!</li>
                      <li>Have a delish breakfast with team  and let's kickstart our day</li>
                      <li>
                         Let's head to world's Second largest Magrove Forest, Pichavaram Mangrove Forest.
                      </li>
                      <li>
                      Enjoy the adventurous boating in the midst of this rooted rare site.                   
                    </li>
                      <li>
                        It's time to depart Roamers, bidding farewell to this amazing place. we'll drive
                        back to Chennai, let's carry with us great memories and newfound friendships from this
                        unforgettable journey. <br></br>
                        We'll reach Chennai by 10 Pm approx.
                      </li>
                    </ul>
                  </div>
                </div>
        ...
        <div class="col-md-4">
          <div class="sticky-sidebar">
              ...
              <ul class="nav nav-pills trip-nav mb-3" id="pills-tab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                  <button class="nav-link" id="pills-profile-tab" data-bs-toggle="pill" data-bs-target="#pills-profile"
                    type="button" role="tab" aria-controls="pills-profile" aria-selected="false">Nov</button>
                </li>
                <li class="nav-item" role="presentation">
                  <button class="nav-link" id="pills-apr-tab" data-bs-toggle="pill" data-bs-target="#pills-apr"
                    type="button" role="tab" aria-controls="pills-apr" aria-selected="false">Dec</button>
                </li>
            ...
            <div class="occupancy">
              <div class="price-occupancy">
                <select class="price-occupancy1" name="" id="">
                  <option value="7999">Double Sharing</option>
                  <!-- <option value="">Quad Sharing</option> -->
                  <option value="6999" selected>Triple Sharing</option>
                </select>
              </div>
              <div class="price-occupancy">
            ...
            <div class="price">
              <h4>Price</h4>
              <p id="price">₹6,999 <span class="per-person">Per Person</span></p>
            </div>
            <script>
