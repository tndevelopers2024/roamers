...
======================================== -->
  ...
  <section class="form-home">
    ...
    <ul class="banner-nav">
      ...
      <li class="locate"><a href="kodaikanal">Kodaikanal Trek & Camp</a></li>
      <li>Booking</li>
    </ul>
  </section>
  ...
  <section class=" form-content-holder">
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-8">
          <form enctype="multipart/form-data" class="form" id="booking-form" action="kodaikanal-contact.php"
            method="POST">
            <h2 class="form-heading">
              Kodaikanal Trek & Camp
            </h2>
            <div class="column">
              ...
              <div class="check-box">
                <label>
                  <input type="radio" checked name="traval-date" id="traval-date" value="OCT 30">OCT 30
                </label>
              </div>
