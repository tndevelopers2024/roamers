...
<head>
  ...
  <title>Roamers - Andaman Honeymoon (Form)</title> <!-- SEO Meta Description -->
  <!-- SEO Meta Description -->
  <meta name="description" content="Roamers - Andaman Honeymoon (Form)" />
  <meta name="author" content="Themeland" />
  <meta property="og:image:width" content="700" />
  <meta property="og:image:height" content="500" />

  <!-- Basic Open Graph tags -->
  <meta property="og:title" content="Roamers - Andaman Honeymoon (Form)" />
  ...
  <meta name="twitter:title" content="Roamers - Andaman Honeymoon (Form)" />
...
<body>
  ...
  <div class="text-center mb-4">
    <h1 class="booking-form-head">
      ANDAMAN ISLANDS ~ DREAMY HONEYMOON
    </h1>
  ...
  <section class="">
    <div class="container">
      <form action="andaman-honeymoon-trip-mail.send.php" method="POST" autocomplete="off">
  ...
  <script>
    document.addEventListener("DOMContentLoaded", function () {
      fetch("./dynamic/database.json") // Check this path
        ...
        .then(data => {
          const locationKey = "andaman-honeymoon";
          ...
          if (startingPriceElem) {
            startingPriceElem.textContent = `Starting Price: ₹32,500/- `;
          } else {
  ...
  <script>
    document.addEventListener("DOMContentLoaded", function () {
      fetch("./dynamic/database.json") // to change the price ... 
        ...
        .then(data => {
          const locationKey = "andaman-honeymoon"; // Change to "ooty" if needed
          const locationData = data[locationKey];
