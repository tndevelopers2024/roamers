...
<head>
  ...
  <meta name="description" content="Munnar & Alleppey" />
...
<body>
  ...
  <section class="trip-home" style="background-image: url('assets/img/Kerala/KeralaCover.jpg');">
    <div class="container" style="  position: relative;">
      ...
      <ul class="des-sub">
        <li>
          Munnar <img src="assets/img/icon/Arrow-head.png" class="arrow-right" alt="roamers-trip">
        </li>
        <li>
          Eravikulam<img src="assets/img/icon/Arrow-head.png" class="arrow-right" alt="roamers-trip">
        <li>
          Alappuzha
        </li>
      </ul>
        ...
        <div class="col-md-7" style="display: grid; place-items: center;">
          <div class="travel-des">
            <h2 style=" margin-bottom:15px; text-align:left !important;"
              ...
              Kerala Escapade - Mountains, Backwater, And Bliss!
            </h2>
            <p>
              Get ready for our Kerala backpacking extravaganza! We'll kick off in the lush hills of Munnar, where
              adventure awaits with ziplining, speedboating, wildlife spotting, and a visit to a beautiful waterfall.
            </p>
            <p>
              Then, it’s off to Alleppey for mesmerizing backwaters, a unique Houseboat stay, delicious Kerala
              cuisine. Unforgettable moments await as we explore 'God's Own
              Country'! 🌄🌊🌟
            </p>
              ...
              <div class="accordion-item ai1">
                <h2 class="accordion-header" id="headingOne">
                  <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne"
                    ...
                    <div class="days"> DAY 1</div>: MUNNAR ARRIVAL | ERAVIKULAM NATIONAL PARK & WATERFALLS
                  </button>
                </h2>
                <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                  ...
                  <div class="accordion-body">
                    ...
                    <ul class="acc-inner">
                      <li>
                        Hello, Roamers! Meet your fellow travellers and trip captains as we kick start our journey to
                        God's Own Country, Kerala.
                      </li>
                      <li>
                        Arrive in Munnar and freshen up before heading to Anamudi Peak, Eravikulam National Park.
                      </li>
                      <li>
                        Enjoy a 20-minute hike through nature to reach the viewpoint. Keep an eye out for the elusive
                        Nilgiri Tahr and return back.
                      </li>
                      <li>
                        Next, visit the beautiful Lakkom Waterfalls. Refresh yourself or relax in the tranquil
                        surroundings.
                      </li>
                      <li>
                        Return to the hotel and end your day with a delightful dinner. Then, unwind with a campfire,
                        music, games, and lots of fun under the stars.
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div class="accordion-item ai1">
                <h2 class="accordion-header" id="headingTwo">
                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                    ...
                    <div class="days"> DAY 2</div>: MATTUPETTY, ZIPLINE & ALLEPPEY HOUSEBOAT STAY
                  </button>
                </h2>
                <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                  ...
                  <div class="accordion-body">
                    ...
                    <ul class="acc-inner">
                      <li>
                        Good morning, Roamers! After breakfast, get ready for an adventurous day. Head to the stunning
                        Mattupetty Dam and enjoy some thrilling speed boating.
                      </li>
                      <li>
                        Next up, prepare for excitement with a zipline adventure, amidst mountains and clouds, along
                        with a giant swing & more.
                      </li>
                      <li>
                        Drive to Alleppey, known as the 'Backwater Capital of India,' and enjoy the scenic route.</li>
                      <li>
                        Check into the floating paradise, the Houseboat. Capture the sunset with tea and snacks as we
                        cruise along the mesmerising backwaters.
                      </li>
                      <li>End the night with a farewell dinner, music, dance in the middle of the water and followed by
                        overnight stay in Houseboat.</li>
                    </ul>
                  </div>
                </div>
              </div>
              ...
              <div class="accordion-item ai1">
                <h2 class="accordion-header" id="headingTwo">
                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                    ...
                    <div class="days"> DAY 3</div>: ALAPPUZHA BEACH, FORT KOCHI, RETURN
                  </button>
                </h2>
                <div id="collapse3" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                  ...
                  <div class="accordion-body">
                    ...
                    <ul class="acc-inner">
                      <li>
                        Wake up to serene backwater views from the Alleppey Houseboat. After breakfast, check out and
                        visit Alappuzha Beach.</li>
                      <li>
                        Take some time for shopping and pick up souvenirs for your loved ones, or simply enjoy some ‘me’
                        time.</li>
                      <li>
                        Finally, drive to Kochi. If time permits, visit Fort Kochi and explore the many facets of the
                        Queen of the Arabian Sea.
                      </li>
                      <li>
                        Farewell, Roamers! See you soon, with more hugs and memories to come!</li>
                    </ul>
                  </div>
                </div>
              </div>
            ...
            <div class="wrapper">
              ...
              <section id="first-tab-group" class="tabgroup">
                <div id="tab1">
                  ...
                  <p>
                    2 Breakfast, 1 lunch & 2 Dinner [Hotel Stay & HouseBoat Stay]
                  </p>
                  <p>
        ...
        <div class="col-md-4">
          <div class="sticky-sidebar">
              ...
              <ul class="nav nav-pills trip-nav mb-3" id="pills-tab" role="tablist">
                <li class="nav-item" role="presentation">
                  <button class="nav-link active" id="pills-apr-tab" data-bs-toggle="pill" data-bs-target="#pills-apr"
                    type="button" role="tab" aria-controls="pills-aug" aria-selected="true">Sep</button>
                </li>
                <li class="nav-item" role="presentation">
            ...
            <div class="trip-form">
              ...
              <a href="munnar-alleppey-form" class="btn butn butn__new">Book Now</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="slider-container">
        <div class="slider-item2 ">
          <div class="silder-pad">
            <div class="slid-img">
              <img class="cus-img" src="assets/img/munnar/Aazhapuzha.jpg" alt="roamers-Gallery">
            </div>
        ...
        <div class="slider-item2">
          <div class="silder-pad">
            <div class="slid-img">
              <img class="cus-img" src="assets/img/munnar/Alleppeybeach.jpg" alt="roamers-Gallery">
            </div>
            <div class="cust-inner">
              <h3> </h3>
        ...
        <div class="slider-item2">
          <div class="silder-pad">
            <div class="slid-img">
              <img class="cus-img" src="assets/img/munnar/Eravikulamnationalpark3.jpg" alt="roamers-Gallery"
        ...
        <div class="slider-item2">
          <div class="silder-pad">
            <div class="slid-img">
              <img class="cus-img" src="assets/img/munnar/Houseboatalleppey.webp" alt="roamers-Gallery"
                style="object-fit:cover;">
            </div>
            <div class="cust-inner">
              <h3> </h3>
              <!-- <h2>Houseboat Alleppey</h2> -->
            </div>
          </div>
        </div>
        ...
        <div class="slider-item2">
          <div class="silder-pad">
            <div class="slid-img">
              <img class="cus-img" src="assets/img/munnar/Lakkamwaterfalls.webp" alt="roamers-Gallery"
                style="object-fit:cover;">
            </div>
            <div class="cust-inner">
              <h3> </h3>
              <!-- <h2>Lakkam Waterfalls</h2> -->
            </div>
          </div>
        </div>
