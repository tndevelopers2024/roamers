...
<head>
  ...
  <meta name="description" content="Meghalaya" />
      ...
      <div class="row desktop-inform">
        <div class="col-md-4 col-4">
          <div class="trip-inner">
            ...
            <p>Starting Price</p>
            <h2><span class="meghalaya-price"></span> /-</h2>
          </div>
        </div>
        <div class="col-md-4 col-4">
          <div class="trip-inner">
      ...
      <div class="row">
        <div class="col-4 col-md-4">
          <div class="trip-inner">
            ...
            <h2 style="color: black;">₹19,990 /-</h2>
          </div>
        </div>
        <div class="col-4 col-md-4">
          <div class="trip-inner">
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <div class="sticky-sidebar">
            ...
            <div class="occupancy">
              <div class="price-occupancy">
                <select class="price-occupancy1" name="" id="">
                  <option value="₹21,990">Double Sharing</option>
                  <!-- <option value="">Quad Sharing</option> -->
                  <option value="₹19,990" selected>Triple Sharing</option>
                </select>
              </div>
              <div class="price-occupancy">
            ...
            <div class="price">
              <h4>Price</h4>
              <p id="price">₹19,990 <span class="per-person">Per Person</span></p>
            </div>
