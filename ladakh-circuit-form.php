...
<head>
    ...
    <meta property="og:description" content="Book your Ultimate Ladakh Circuit - 7 Days adventure." />
    ...
    <meta name="twitter:description" content="Book your Ultimate Ladakh Circuit - 7 Days adventure." />
    ...
    .price-box {
      ...
      padding:3px 6px;
        ...
        .background-image {
            ...
            width: 100%;
            height: 100%;
            background: url('https://roamers.in/assets/img/ladakh/ladakh-img3.jpg');
...
<body>
    ...
    <div class="text-center mb-4">
        <h1 class="booking-form-head">
            Ultimate Ladakh Circuit - 7 Days</h1>
    ...
    <section class="">
        <div class="container">
            <form action="ladakh-circuit-mail-send.php" method="POST" autocomplete="off">
