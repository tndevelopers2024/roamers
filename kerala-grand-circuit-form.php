    ...
    .price-box {
      ...
      padding:3px 6px;
        ...
        .background-image {
            ...
            width: 100%;
            height: 100%;
            background: url('https://roamers.in/assets/img/Kerala/Kerala-photos.jpg');
...
<body>
    ...
    <section class="">
        <div class="container">
            <form action="kerala-grand-circuit-mail-send.php" method="POST" autocomplete="off">
                                ...
                                <div class="per-form">
                                  ...
                                  <option value=""></option> -->
                                            ...
                                            <div class="input-field mt-4">
                                                ...
                                                <div class="input-field mt-4">
                                                    <select id="pickup" name="pickup" class="form-select mt-4" required><option value="" disabled selected>Select the Location</option><option value="Kochi">Kochi</option></select>
                                                </div>
                    ...
                    <div class="col order-lg-2 order-1 shadow-lg p-4" style="border-radius:20px">
                        <div class="row px-2 px-md-4">
                            ...
                            <div class="cost-col mt-3" style="border-radius: 20px;">
                                ...
                                <div class="mt-5">
                                    <p> NOTE: INR 2,500/- extra per person for double sharing upgrade.</p> <br>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            fetch("./dynamic/database.json") // Check this path
                ...
                .then(data => {
                    const locationKey = "kerala_grand_circuit";
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            fetch("./dynamic/database.json") // to change the price ... 
                ...
                .then(data => {
                    const locationKey = "kerala_grand_circuit"; // Change to "ooty" if needed
                    const locationData = data[locationKey];
