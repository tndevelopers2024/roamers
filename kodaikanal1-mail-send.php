...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        $mail->isHTML(true);
        $mail->Subject = 'NEW Kodaikanal  BOOKING RECEIVED';
        $mail->AddEmbeddedImage('assets/img/kodaikanal/Kodai.jpg', 'srilankaimg');
        ...
        '>
            <div style='background: linear-gradient(90deg, #4ec0db 0%, #1e90ff 100%); padding: 32px 0 18px 0; text-align: center;'>
                <img src='cid:srilankaimg' alt='srilankaimg' style='width: 100%; max-width: 520px; height: 380px; object-fit: cover; border-radius: 12px; box-shadow: 0 2px 12px rgba(0,0,0,0.08); margin-bottom: 18px;' />
            ...
            <div style='background: #4ec0db; color: #fff; text-align: center; padding: 14px 0; font-size: 1.08rem; letter-spacing: 0.5px;'>
                Thank you for booking your Kodaikanal  Escapade with Roamers! <span style='margin-left:8px;'><img src='https://img.icons8.com/ios-filled/20/ffffff/checked-checkbox.png' style='vertical-align:middle;'/></span>
            </div>
        </div>
        ";
        ...
        <body>
            <div class="thankyou-container">
                ...
                <div class="thankyou-msg">
                    Your Kodaikanal booking has been received.<br>
