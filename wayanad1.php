              ...
              <div class="accordion-item ai1">
                <h2 class="accordion-header" id="headingOne">
                  <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne"
                    ...
                    <div class="days">
                      Day 1 </div>: ARRIVAL | EDAKKAL CAVES, KARAPUZHA ADVENTURES & MORE
                  </button>
                </h2>
                <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                  ...
                  <div class="accordion-body">
                    ...
                    <ul class="acc-inner">
                      <li>
                        Hello Roamers! Meet your team and trip leader, and let's kick-start our Wayanad journey.
                      </li>
                      <li>Reach Wayanad. After a quick freshen-up and breakfast, let’s begin our day with a hike to
                        Edakkal Caves. Explore the ancient wonders and soak in the historical vibes of the caves.
                      </li>
                      <li>
                        Check-in to our cozy resort,
                      </li>
                      <li>
                        Next, we'll head to the tranquil Karapuzha Dam and adventure. Experience the longest Zipline,
                        giant swing, and more adventure, or simply relax in these serene landscapes.
                      </li>
                      <li>
                        Return back to the resort and it’s time for fun. Campfire, music, games, dance, and more
                        bonding.
                      </li>
                      <li>Enjoy an appetising dinner and an overnight stay at the resort.
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div class="accordion-item ai1">
                <h2 class="accordion-header" id="headingTwo">
                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                    ...
                    <div class="days"> Day 2 </div>: SUNRISE TREK, WATERFALLS HOPPING & GLASS BRIDGE | CAMPING
                  </button>
                </h2>
                <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                  ...
                  <div class="accordion-body">
                    ...
                    <ul class="acc-inner">
                      <li>
                        Hey team, get ready for the early morning adventure. We’re trekking to Kurumbalakotta to witness
                        the golden sunrise, a moment to be captured.
                      <li>
                        Return to the resort, freshen up, have breakfast, and check out.
                      </li>
                      <li>
                        Next, let's visit Kanthanpara Waterfalls, an enchanting beauty. Dip in the small pool or simply
                        relax in the tranquil atmosphere.
                      </li>
                      <li>
                        After lunch, let’s hop on a jeep safari on the untamed roads and reach the stunning 900 Kandi
                        Glass Bridge. Enjoy the most picturesque view in all of Wayanad.
                      </li>
                      <li>
                        Finally, let's check in at our campsite, relax a bit, and join the campfire under the stars.
                      </li>
                      <li>
                      ...
                      <li>Relish a scrumptious dinner and rest in your camps.</li>
                    </ul>
                  </div>
                </div>
              </div>
              ...
              <div class="accordion-item ai1">
                <h2 class="accordion-header" id="headingTwo">
                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                    ...
                    <div class="days"> Day 3</div>: BANASURA DAM, POOKODE BOATING & SHOPPING | FAREWELL
                  </button>
                </h2>
                <div id="collapse3" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                  ...
                  <div class="accordion-body">
                    ...
                    <ul class="acc-inner">
                      <li>
                        Wake up and relish a delicious breakfast at your campsite, and let’s go for a river hike and
                        visit private waterfalls (if time permits).
                      </li>
                      <li>
                        Next, let’s head to Banasura Sagar Dam, one of the world's largest earthen dams, a true wonder
                        of Wayanad.
                      </li>
                      <li>
                        After lunch, we’ll visit Pookode Lake and enjoy boating or just relax beside the beautiful lake.
                      </li>
                      <li>
                        Lastly, it's shopping time. Visit the famous centres in Wayanad, and buy souvenirs for your
                        loved ones.
                      </li>
                      <li>
