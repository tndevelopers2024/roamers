...
<head>
  ...
  <style>
    ...
    .background-image {
      ...
      width: 100%;
      height: 100%;
      background: url('assets/img/chikmangalur/Media/10.jpg');
...
<body>
  ...
  <section class="">
    <div class="container">
      <form action="chikmagalur-mail-send-christmas-new-year.php" method="POST" autocomplete="off">
  ...
  <script>
    document.addEventListener("DOMContentLoaded", function () {
      fetch("./dynamic/varkala-data.json") // Check this path
        ...
        .then(data => {
          const locationKey = "chikmagalur-meghalaya-christmas-new-year";
          ...
          if (startingPriceElem) {
            startingPriceElem.textContent = `Starting Price: ₹9,499/- `;
          } else {
  ...
  <script>
    document.addEventListener("DOMContentLoaded", function () {
      fetch("./dynamic/varkala-data.json") // to change the price ... 
        ...
        .then(data => {
          const locationKey = "chikmagalur-meghalaya-christmas-new-year"; // Change to "ooty" if needed
          const locationData = data[locationKey];
      ...
      if (nextBtn2) {
        nextBtn2.addEventListener("click", (e) => {
          ...
          const confirmationHTML = `
            ...
            <div class="div"><i class="fa-solid fa-plane-departure"></i> <p><b>Trip :</b> CHIKMAGALUR BAGPACKING</p></div>
