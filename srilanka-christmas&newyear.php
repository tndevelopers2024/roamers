...
<head>
    ...
    <meta property="og:image:secure_url"
        content="https://www.roamers.in/assets/img/Sirlanka/srilanka-images-by-roamers%20(6).webp" width="600"
                        ...
                        <div class="swiper miniSlider px-px-md-0 py-3">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <img src="assets/img/Sirlanka/srilanka-images-by-roamers (48).webp" ,
                                        class="img-fluid w-100" alt="Ladakh 3"
                                        style="border-radius: 10px; height: 350px; object-fit: cover;">
                                </div>
                                <div class="swiper-slide">
                                    <img src="assets/img/Sirlanka/srilanka-images-by-roamers (46).webp" ,
                                        class="img-fluid w-100" alt="Ladakh 3"
                                        style="border-radius: 10px; height: 350px; object-fit: cover;">
                                </div>
                                <div class="swiper-slide">
                                    <img src="assets/img/Sirlanka/srilanka-images-by-roamers (6).webp"
                                        class="img-fluid w-100" alt="Ladakh 1"
                                        style="border-radius: 10px; height: 350px; object-fit: cover;">
                                </div>

                                <div class="swiper-slide">
                                    <img src="assets/img/Sirlanka/srilanka-images-by-roamers (26).webp" ,
                                        class="img-fluid w-100" alt="Ladakh 3"
                                        style="border-radius: 10px; height: 350px; object-fit: cover;">
                                </div>
                            </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="price-sticky" style="position: sticky;">
                            ...
                            <div class="priceCard shadow" style="border-radius: 10px;">
                                <img src="assets/img/Sirlanka/srilanka-images-by-roamers (47).webp"
