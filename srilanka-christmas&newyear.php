...
<head>
    ...
    <meta property="og:image:secure_url"
        content="https://www.roamers.in/assets/img/sri-lanka/sri-lanka-gallery-06.avif" width="600"
...
<body>
                        ...
                        <div class="col">
                            <div class="enhanced-box">
                                ...
                                <div>
                                    ...
                                    <div class="info-value srilanka-price"><span>/-</span></div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-7">
                        <div class="travel-des p-3 p-md-4">
                            ...
                            <p style="color: #555;" class="desk-desc d-none d-md-block">
                                This isn’t your basic Sri Lanka trip - we’re going all in! From climbing the legendary
                                Sigiriya Rock
                                Fortress at sunrise (yes, the one people always regret skipping) to epic train journey
                                at Ella, watching
                                sunsets from colonial Galle Fort, Beach Hopping at Bentota, this trip is a full-circle
                                rollercoaster
                                through the island’s best!

                                <br> <br>We’re talking about royal cities like Kandy, the misty tea hills of Nuwara
                                Eliya, entering
                                elephant paradise, at Pinnawala, serene boat safaris, chill beach days & Wild water
                                adventures in
                                Bentota, ending big in buzzing Colombo City with an epic farewell. </br><br>

                                Packed with nature, culture, and crazy good squad vibes, Don’t think much, this unique
                                itinerary crafted
                            ...
                            <p style="color: #555;" class="mob-desc d-block d-md-none">
                                ...
                                <span id="moreText" style="display: none;"><br><br>
                                    Beach Hopping at Bentota, this trip is a full-circle rollercoaster through the
                                    island’s best! We’re
                                    talking about royal cities like Kandy, the misty tea hills of Nuwara Eliya, entering
                                    elephant
                                    paradise, at Pinnawala, serene boat safaris, chill beach days & Wild water
                                    adventures in Bentota,
                                    ending big in buzzing Colombo City with an epic farewell.

                                    <br><br>Packed with nature, culture, and crazy good squad vibes, Don’t think much,
                                    this unique
                        ...
                        <div class="swiper miniSlider px-px-md-0 py-3">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <img src="assets/img/sri-lanka/sri-lanka-gallery-48.avif" ,
                                        class="img-fluid w-100" alt="Ladakh 3"
                                        style="border-radius: 10px; height: 350px; object-fit: cover;">
                                </div>
                                <div class="swiper-slide">
                                    <img src="assets/img/sri-lanka/sri-lanka-gallery-46.avif" ,
                                        class="img-fluid w-100" alt="Ladakh 3"
                                        style="border-radius: 10px; height: 350px; object-fit: cover;">
                                </div>
                                <div class="swiper-slide">
                                    <img src="assets/img/sri-lanka/sri-lanka-gallery-06.avif"
                                        class="img-fluid w-100" alt="Ladakh 1"
                                        style="border-radius: 10px; height: 350px; object-fit: cover;">
                                </div>

                                <div class="swiper-slide">
                                    <img src="assets/img/sri-lanka/sri-lanka-gallery-26.avif" ,
                                        class="img-fluid w-100" alt="Ladakh 3"
                                        style="border-radius: 10px; height: 350px; object-fit: cover;">
                                </div>
                            </div>
                    ...
                    <div class="col-md-8">
                            ...
                            <div class="accordion" id="accordionExample">
                                        ...
                                        <div class="accordion-body" style="background-color: #f5fdff;">
                                            ...
                                            <ul class="ps-lg-3 ps-0">
                                                <li class=""><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>Meet your fellow Roamers
                                                    travellers & Trip Captain at
                                                    Colombo Airport / Assigned Meetup Point

                                                </li>
                                                <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>Let's begin our journey through
                                                    lush countryside to the
                                                    historic village of <span class="fw-bold">Sigiriya</span>

                                                </li>
                                                <li><i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>Check into the hotel and unwind
                                                    with a hot cup of Ceylon tea
                                                </li>
                                                <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>Chill session by the pool with
                                                    local bites, stories, and
                                                    bonding with your new travel fam

                                                </li>
                                                <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>Savour a delicious dinner &
                                ...
                                <div class="accordion-item mb-4 border  overflow-hidden"
                                        ...
                                        <button
                                            ...
                                            <div class="d-flex align-items-center w-100">
                                                <span
                                                    ...
                                                    2</span>
                                                <span> Sunrise Trek to Sigirya & Pinnawala Elephant Orphanage | Kandy
                                                </span>
                                    ...
                                    <div id="collapseTwo" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body" style="background-color: #f5fdff;">
                                            ...
                                            <ul class="ps-lg-3 ps-0">
                                                <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>Wake
                                                    up Roamers, get ready for your lifetime adventure! </li>
                                                <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>
                                                    Early morning <span class="fw-bold">hike</span> to the iconic <span
                                                        class="fw-bold">Sigiriya
                                                        Rock Fortress</span>, A 5th-century Royal citadel floating
                                                    paradise above the jungle </li>
                                                <li><i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>Enjoy the panoramic views and
                                                    the magical Sunrise from the
                                                    Fortress.
                                                </li>
                                                <li><i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>Our
                                                    journey next brings us to the famous <span class="fw-bold">Pinnawala
                                                        Elephant
                                                        Orphanage</span>, Witness gentle giants in a peaceful sanctuary,
                                                    Elephant lovers real treat!

                                                </li>
                                                <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>Up
                                                    next let's head to <span class="fw-bold">Kandy</span>, the last
                                                    royal capital of Sri Lanka

                                                </li>
                                                <li><i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>Enjoy evening leisure, take
                                                    strolls by <span class="fw-bold">Kandy Lake</span> & colorful local
                                                    markets

                                                </li>
                                                <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>Relish the Dinner with the Team
                                ...
                                <div class="accordion-item mb-4 border  overflow-hidden" style="border-radius: 10px;">
                                    ...
                                    <div id="collapse3" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body bg-white px-4 py-3">
                                            <ul class="ps-lg-3 ps-0">
                                                <li><i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>Morning Roamers, time to head to
                                                    Kandy's most visited spot:
                                                    Temple of <span class="fw-bold"> Sacred Tooth Relic</span>: Sacred
                                                    shrine that houses a relic
                                                    of Lord Buddha </li>
                                                <li><i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>Up
                                                    next, our journey leads to <span class="fw-bold">Hillstation</span>!
                                                    Our First visit is to the
                                                    <span class="fw-bold">hilltop Hanuman Temple</span> Rooted to
                                                    ancient Ramayana Tales.

                                                </li>
                                                <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>After, let's go on a tour of the
                                                    local tea factory and sip
                                                    freshly brewed Ceylon Tea with a plantation view. Time for some
                                                    Instagrammable Pictures
                                                    Roamers!

                                                </li>
                                                <li><i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>Reach <span
                                                        class="fw-bold">Nuwara Eliya</span>,
                                                    affectionately called "Little England" for its cool climate,
                                                    cottages, and rose gardens
                                                </li>
                                                <li><i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>Walk around <span
                                                        class="fw-bold">Gregory Lake</span> or
                                                    stop at <span class="fw-bold">cozy cafés</span>.
                                                </li>
                                                <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>Savour Dinner & Overnight stay
                                                    in Nuwara Eliya
                                ...
                                <div class="accordion-item mb-4 border overflow-hidden" style="border-radius: 10px;">
                                    ...
                                    <div id="collapse4" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body bg-white px-4 py-3">
                                            <ul class="ps-lg-3 ps-0">
                                                <li><i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>Hey
                                                    Romers! t let's drive to <span class="fw-bold">Ella</span> to board
                                                    Board the world-renowned
                                                    an epic <span class="fw-bold">Train journey</span> </li>
                                                <li><i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i> A
                                                    Scenic slow journey through cloud forests, tea valleys, and tunnels.
                                                    This journey you'll
                                                    remember forever. </li>
                                                <li><i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>Explore the iconic<span
                                                        class="fw-bold">Nine Arch
                                                        Bridge</span> – a photogenic marvel of colonial engineering
                                                    nestled in greenery</li>
                                                <li><i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>Time to enjoy our Lunch with
                                                    sweeping views of Ella's
                                                    rolling hills.</li>
                                                <li><i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>Next we'll Stop by <span
                                                        class="fw-bold"> Ravana
                                                        Falls</span> , witness mesemerising falls</li>
                                                <li><i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>We'll arrive by evening for a
                                                    golden sunset at the iconic
                                                    <span class="fw-bold">Galle Fort</span> (UNESCO site).
                                                </li>
                                                <li><i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>Explore Galle on your own with
                                                    the team, spend time
                                                    exploring Dutch reformed spots or relax by the beach (Trip captain
                                                    will provide you the super
                                                    spots)</li>
                                                <li><i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3"
                                ...
                                <div class="accordion-item mb-4 border  overflow-hidden" style="border-radius: 10px;">
                                    ...
                                    <div id="collapse5" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body bg-white px-4 py-3">
                                            <ul class="ps-lg-3 ps-0">
                                                <li><i class="fa-regular fa-circle-dot  me-2 icon-blue"
                                                        style="font-size: 0.65rem;"></i>Post
                                                    Breakfast let's move to our most relaxable city <span
                                                        class="fw-bold">Bentota</span> </li>
                                                <li><i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>First, we'll head to <span
                                                        class="fw-bold"> Madu River Boat
                                                        Safari</span>, gliding through secret waterways flanked by lush
                                                    mangrove forests. </li>
                                                <li><i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>Check into your beach side
                                                    resorts, relax for a while.

                                                </li>
                                                <li><i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i><span class="fw-bold">Water
                                                        Sports</span> Extravaganza
                                                    (Bentota Beach) Choose your adventure: Jet skiing / Banana boat
                                                    rides / Para Motoring & More
                                ...
                                <div class="accordion-item mb-4 border  overflow-hidden" style="border-radius: 10px;">
                                    ...
                                    <div id="collapse6" class="accordion-collapse collapse" aria-labelledby="headingSix"
                                        ...
                                        <div class="accordion-body bg-white px-4 py-3">
                                            <ul class="ps-lg-3 ps-0">
                                                <li><i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>Roamers Start slow with a
                                                    chilled-out morning by the sea and
                                                    savour breakfast.

                                                </li>
                                                <li><i class="fa-regular fa-circle-dot  me-2 icon-blue"
                                                        style="font-size: 0.65rem;"></i>Time to
                                                    Roll into <span class="fw-bold">Colombo</span> - the heart of Sri
                                                    Lanka

                                                </li>
                                                <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>City
                                                    tour highlights: The serene <span class="fw-bold"> Gangaramaya
                                                        Temple </span> The stately
                                                    <span class="fw-bold"> Independence Square </span> stroll at <span
                                                        class="fw-bold"> Galle Face
                                                        Green</span> Browse boutique shops and <span
                                                        class="fw-bold">local markets </span> local
                                                    markets
                                                </li>
                                                <li><i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>
                                                    Have Lunch at iconic spot Celebrate with your crew, or choose a
                                                    special Lunch at the famed
                                                    <span class="fw-bold">Ministry of Crab </span>(Founded by cricket
                                                    legends Sangakkara &
                                                    Jayawardene, this globally acclaimed seafood restaurant is a must
                                                    for foodies and fans alike)
                                                </li>
                                                <li><i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>Alright Roamers we've come to
                                                    end of our Journey, just turn
                                                    around and see how the strangers has become your best friends</li>
                                                <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>Time
                                                    for <span class="fw-bold">Farewell dinner</span> , organised by
                                                    Roamers. Let's feast at the
                                                    dinner and celebrate our last night in Sri Lanka, A night to
                                                    remember!</li>
                                                <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                ...
                                <div class="accordion-item mb-4 border  overflow-hidden" style="border-radius: 10px;">
                                    ...
                                    <div id="collapse7" class="accordion-collapse collapse" aria-labelledby="headingSix"
                                        ...
                                        <div class="accordion-body bg-white px-4 py-3">
                                            <ul class="ps-lg-3 ps-0">
                                                <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>Transfer to the airport
                                                    depending on your flight time
                                                </li>
                                                <li><i class="fa-regular fa-circle-dot  me-2 icon-blue"
                                                        style="font-size: 0.65rem;"></i>Group
                                                    hugs, selfies and bye byes, let's plan for a reunion soon!
                                                </li>
                                                <li><i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>Head home with a heart full of
                                                    memories and new travel
                                                    friends!
                                                </li>
                                            </ul>
                                        </div>
                            ...
                            <div class="important-notes shadow "
                                ...
                                <div id="">
                                    ...
                                    <p> <i class="fa-solid fa-circle-check me-2 pulse"
                                            style="color: green;"></i>Accomodation: 3-star
                                        Hotels/ Resorts superior stays
                                    </p>

                                    <p> <i class="fa-solid fa-circle-check me-2 pulse" style="color: green;"></i>Meals:
                                        06 Breakfasts, 4
                                        Dinners (including Farewell Dinner)
                                    </p>

                                    <p> <i class="fa-solid fa-circle-check me-2 pulse"
                                            style="color: green;"></i>Transportation:
                                        Air-conditioned coach throughout the tour (as per itinerary)

                                    </p>
                                    <p> <i class="fa-solid fa-circle-check me-2 pulse"
                                            style="color: green;"></i>Complementary 2x500ml
                                    ...
                                    <p> <i class="fa-solid fa-circle-check me-2 pulse"
                                            style="color: green;"></i>Sigiriya Rock Fortress
                                    </p><span class="mobile-br"><br></span>
                                    <p> <i class="fa-solid fa-circle-check me-2 pulse"
                                            style="color: green;"></i>Pinnawala Elephant
                                        Orphanage</p>
                                    <p> <i class="fa-solid fa-circle-check me-2 pulse" style="color: green;"></i>Sacred
                                        Temple of the
                                        Tooth Relic (Kandy)
                                    </p>
                                    <p> <i class="fa-solid fa-circle-check me-2 pulse" style="color: green;"></i>Ganga
                                        Ramaya Temple </p>
                                    <span class="mobile-br"><br></span>
                                    <p> <i class="fa-solid fa-circle-check me-2 pulse" style="color: green;"></i>Madu
                                        River Boat Safari
                                    </p><span class="mobile-br"><br></span>
                                    <p> <i class="fa-solid fa-circle-check me-2 pulse" style="color: green;"></i>Turtle
                                        Hatchery</p><span class="mobile-br"><br></span>
                                    <p> <i class="fa-solid fa-circle-check me-2 pulse" style="color: green;"></i>Gem
                                        Museum visit
                                    </p><span class="mobile-br"><br></span>
                                    <p> <i class="fa-solid fa-circle-check me-2 pulse"
                                            style="color: green;"></i>Parking, Toll Charges &
                                        all Taxes
                                    </p><span class="mobile-br"><br></span>
                                    <p> <i class="fa-solid fa-circle-check me-2 pulse" style="color: green;"></i>No
                                        hidden charges </p>
                        ...
                        <div class="important-notes shadow"
                            ...
                            <h3 class="head" style="text-align: center; margin-bottom: 20px; margin-left: 10px;">
                                Exclusion</h3>
                            <div>
                                <p> <i class="fa-solid fa-circle-xmark me-2 pulse" style="color: red;"></i>Air Ticket
                                </p><span class="mobile-br"><br></span>
                                ...
                                <p><i class="fa-solid fa-circle-xmark me-2 pulse" style="color: red;"></i>If Early/late
                                    airport
                                ...
                                <p><i class="fa-solid fa-circle-xmark me-2 pulse" style="color: red;"></i>Lunch and 2
                                    Dinner Meals on
                                    tour.


                                </p>
                                <p><i class="fa-solid fa-circle-xmark me-2 pulse" style="color: red;"></i>Early Check In
                                    (before 3 AM)
                                    and Late Check Out (after 11 AM) at the hotel.
                                </p>
                                <p><i class="fa-solid fa-circle-xmark me-2 pulse" style="color: red;"></i>Tips and
                                    Portage.


                                </p>
                                <p><i class="fa-solid fa-circle-xmark me-2 pulse" style="color: red;"></i>Any expense
                                    due to nature or
                                ...
                                <p><i class="fa-solid fa-circle-xmark me-2 pulse" style="color: red;"></i>Applicable TCS
                                    & GST
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="price-sticky" style="position: sticky;">
                            ...
                            <div class="priceCard shadow" style="border-radius: 10px;">
                                <img src="assets/img/sri-lanka/sri-lanka-gallery-47.avif"
                                    alt="Ladakh Banner 3" style=" object-fit:cover; border-radius: 10px;">
                            </div>
            ...
            <div class="swiper rewind-swiper" style="overflow: visible !important;">
                <div class="swiper-wrapper">
                    ...
                    <!-- Slide 16 -->
                     <div class="swiper-slide">
                        <div class="rewind-card">
                            <img src="assets/img/sri-lanka/sri-lanka-gallery-31.avif" alt="Sri Lanka 16">
                        </div>
                    </div>
    ...
    <div class="mobile-bottom-bar">
        <div class="bottom-bar-content">
            ...
            <a href="srilanka-form-christmas&newyear-special.php" class="btn-book">Dates & Costing</a>
        </div>
    </div>
