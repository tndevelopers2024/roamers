            ...
            <div class="col">
              <div class="enhanced-box">
                ...
                <div>
                  ...
                  <div class="info-value chikmangalur-price"><span>/-</span></div>
                </div>
              </div>
            </div>
                ...
                <div class="p-2">
                  ...
                  <div class="inner-box" style="background-color: #f0f0f0; padding: 15px; border-radius: 30px;">
                    ...
                    <div class="trip-form p-0">
                      <a href="chikmagalur-form.php" class="btn butn butn__new bg-" style="border-radius: 30px;">Dates
                        & Costing</a>
                    </div>
                  </div>
                </div>
    ...
    <div class="bottom-bar-content">
      <div class="price-box ">
        ...
        <div class="price-info">
          <span class="price-amount chikmangalur-price">/-</span>
          <span class="per-person">(Per Person)</span>
        </div>
      </div>
      <a href="chikmagalur-form.php" class="btn-book">Dates & Costing</a>
    </div>
  </div>
