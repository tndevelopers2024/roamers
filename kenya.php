...
<head>
    ...
    <title>Roamers - Kenya-new</title>

    <!-- SEO Meta Description -->
    <meta name="description" content="Kenya-new" />
    <meta name="author" content="Themeland" />
    <meta property="og:image" content="https://roamers.in/assets/img/Kenya/Media/overview-2.jpg" />
    <meta property="og:image:secure_url" content="https://roamers.in/assets/img/Kenya/Media/overview-2.jpg" />
    <meta property="og:image:width" content="700" />
    <meta property="og:image:height" content="500" />
    <meta property="og:title" content="Kenya-new Packages" />
    <meta property="og:description"
        content="Discover the best Kenya-new packages with Roamers. Explore stunning beaches, cliffs, and cultural experiences. Book your Kenya-new trip today!" />
    <meta property="og:url" content="https://roamers.in/Kenya-new.php" />
    ...
    <style>
        * {
        ...
        .banner-bg-static {
            background-image: url('https://wondervision.in/static/e8ea4f3a0a627c4e9d374c1e4f771d90/5335f/Kenya_Banner_Wonder_Vision_Holidays_b55ae86197.png');
            height: 100vh;
            padding: 0;
            position: relative;
            background-size: cover;
...
<body>
    ...
    <section class="trip-home banner-bg-static" id="tripSection"
        ...
        <!-- Local Background Video (Hidden to show image banner) -->
        <!--
        <div style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; z-index: 0; overflow: hidden; background: #000;">
            <video autoplay loop muted playsinline style="width: 100%; height: 100%; object-fit: cover; pointer-events: none;">
                <source src="assets/img/Kenya/video/Kenya-banner-video.mp4" type="video/mp4">
            </video>
        </div>
        -->
    ...
    <style>
        .about-area {
            ...
            /* background-image: linear-gradient(rgba(255, 255, 255, 0.8), rgba(255, 255, 255, 0)), url('assets/img/Kenya/Kenya-testimonial-bg.avif'); */
            background-size: cover;
        ...
        .icon-box {
            ...
            margin-right: 25px;
            flex-shrink: 0;
            box-shadow: 0 0 15px rgba(47, 175, 145, 0.3);
            transition: all 0.3s ease;
            position: relative;
            z-index: 2;
        }
        ...
        .feature-item:hover .icon-box {
            transform: translateY(-5px);
            background: #DDF5EE;
            box-shadow: 0 0 20px rgba(47, 175, 145, 0.4);
        }
    ...
    <section class="Kenya-packages-section"
        style="padding: 50px 0px 50px 0px; background-color: #fff; position: relative; overflow: hidden;">

        <h2 class="head reveal-up" style="margin-bottom: 40px; position: relative; z-index: 2;">KENYA TOUR PACKAGES
        </h2>
        <div class="container" style="position: relative; z-index: 2;">
            <!-- Background Trees attached to container -->
            <img src="assets/img/Kenya/Kenya-left -tree.png" alt="" class="bg-tree-left">
            <img src="assets/img/Kenya/Kenya-right-tree.png" alt="" class="bg-tree-right">

            <div class="row packages-scroll-row">
                <div class="col-lg-4 col-md-6">
                    <div class="package-card-wrap">
                        <a href="Kenya-group-trip.php" class="card-modern">
                            <div class="card-top-badges">
                                <span class="badge-rating"><i class="fa-solid fa-star"></i> 4.9</span>
                            </div>
                            <img src="https://commons.wikimedia.org/wiki/Special:Redirect/file/Giraffe_and_zebra_in_Maasai_Mara,_Kenya.jpg" alt="Magical Maasai Mara"
                                class="card-img">
                            <div class="card-white-gradient"></div>

                            <div class="card-content">
                                <h3 class="card-title">Magical Maasai Mara</h3>
                                <p class="card-location"><i class="fa-solid fa-location-dot"></i> Maasai Mara, Kenya
                                </p>
                                ...
                                <div class="card-category-pill pill-group">
                                    <i class="fa-solid fa-binoculars"></i> Safari Trip
                                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="package-card-wrap">
                        <a href="#" class="card-modern">
                            ...
                            <img src="https://commons.wikimedia.org/wiki/Special:Redirect/file/Amboseli_Park_-_Kilimanjaro_elephant.jpg" alt="Amboseli Safari Escape"
                                class="card-img">
                            <div class="card-white-gradient"></div>

                            <div class="card-content">
                                <h3 class="card-title">Amboseli Safari Escape</h3>
                                <p class="card-location"><i class="fa-solid fa-location-dot"></i> Amboseli, Kenya
                                </p>
                                ...
                                <div class="card-category-pill pill-private">
                                    <i class="fa-solid fa-paw"></i> Wildlife Trip
                                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="package-card-wrap">
                        <a href="#" class="card-modern">
                            ...
                            <img src="https://commons.wikimedia.org/wiki/Special:Redirect/file/Red_elephant.jpg"
                                alt="Tsavo Wild Adventure" class="card-img">
                            <div class="card-white-gradient"></div>

                            <div class="card-content">
                                <h3 class="card-title">Tsavo Wild Adventure</h3>
                                <p class="card-location"><i class="fa-solid fa-location-dot"></i> Tsavo, Kenya
                                </p>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="package-card-wrap">
                        <a href="#" class="card-modern">
                            ...
                            <img src="https://commons.wikimedia.org/wiki/Special:Redirect/file/Flamingoes-Lake_Nakuru.jpg"
                                alt="Lake Nakuru Wildlife Escape" class="card-img">
                            <div class="card-white-gradient"></div>

                            <div class="card-content">
                                <h3 class="card-title">Lake Nakuru Wildlife Escape</h3>
                                <p class="card-location"><i class="fa-solid fa-location-dot"></i> Lake Nakuru, Kenya
                                </p>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="package-card-wrap">
                        <a href="#" class="card-modern">
                            ...
                            <img src="https://commons.wikimedia.org/wiki/Special:Redirect/file/Samburu_Elephant.jpg"
                                alt="Samburu Wilderness Journey" class="card-img">
                            <div class="card-white-gradient"></div>

                            <div class="card-content">
                                <h3 class="card-title">Samburu Wilderness Journey</h3>
                                <p class="card-location"><i class="fa-solid fa-location-dot"></i> Samburu, Kenya
                                </p>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="package-card-wrap">
                        <a href="Kenya-honeymoon-trip.php" class="card-modern">
                            <div class="card-top-badges">
                                <span class="badge-rating"><i class="fa-solid fa-star"></i> 5.0</span>
                            </div>
                            <img src="https://commons.wikimedia.org/wiki/Special:Redirect/file/Safari_vehicles_watching_lion_couple_in_Maasai_Mara,_Kenya.jpg"
                                alt="Kenya Safari Honeymoon" class="card-img">
                            <div class="card-white-gradient"></div>

                            <div class="card-content">
                                <h3 class="card-title">Kenya Safari Honeymoon</h3>
                                <p class="card-location"><i class="fa-solid fa-location-dot"></i> Maasai Mara, Kenya
                                </p>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 mb-5 mb-lg-0 reveal-left">
                    <div class="about-img-wrapper">
                        ...
                        <div class="about-img-1">
                            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS9QyWSa-ohIQ5wUhaK_ybr9j4GSOJNdIlsY-_5IakKMQ&s=10" alt="Kenya Safari">
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6 reveal-right">
                    <div class="about-content">
                        <span class="section-subtitle" style="color: #35B8D4;">Explore Kenya</span>
                        <h2 class="section-title">Highlights of Kenya</h2>

                        <ul class="feature-list">
                            <li class="feature-item animate reveal-up" style="transition-delay: 0.1s;">
                                <div class="icon-box">
                                    <img src="assets/img/icon/lion.svg" alt="Lion">
                                </div>
                                <div class="feature-text">
                                    <h4>Big Five Safari</h4>
                                    <p>Experience Kenya's iconic wildlife, including lions, elephants, leopards, rhinos and buffalo in their natural habitats.</p>
                                </div>
                            </li>

                            <li class="feature-item animate reveal-up" style="transition-delay: 0.2s;">
                                <div class="icon-box">
                                    <img src="assets/img/icon/giraffe.svg" alt="Giraffe">
                                </div>
                                <div class="feature-text">
                                    <h4>Maasai Mara</h4>
                                    <p>Discover the legendary Maasai Mara, famous for vast savannahs, incredible wildlife and unforgettable safari experiences.</p>
                                </div>
                            </li>

                            <li class="feature-item animate reveal-up" style="transition-delay: 0.3s;">
                                <div class="icon-box">
                                    <img src="assets/img/icon/wildebeest.svg" alt="Wildebeest">
                                </div>
                                <div class="feature-text">
                                    <h4>Great Migration</h4>
                                    <p>Witness one of nature's greatest spectacles as vast herds cross the Maasai Mara during the annual migration.</p>
                                </div>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="rewind-card">
                            <img src="assets/img/Kenya/Rewind/rewind-1.jpg" alt="Giraffe and zebra in Maasai Mara, Kenya">
                        </div>
                    </div>
                    ...
                    <div class="swiper-slide">
                        <div class="rewind-card">
                            <img src="assets/img/Kenya/Rewind/rewind-2.jpg" alt="Elephant in Maasai Mara, Kenya">
                        </div>
                    </div>
                    ...
                    <div class="swiper-slide">
                        <div class="rewind-card">
                            <img src="assets/img/Kenya/Rewind/rewind-3.jpg" alt="Zebra herd, Maasai Mara National Reserve, Kenya">
                        </div>
                    </div>
                    ...
                    <div class="swiper-slide">
                        <div class="rewind-card">
                            <img src="assets/img/Kenya/Rewind/rewind-4.jpg" alt="Maasai Mara Sunrise">
                        </div>
                    </div>
                    ...
                    <div class="swiper-slide">
                        <div class="rewind-card">
                            <img src="assets/img/Kenya/Rewind/rewind-5.jpg" alt="Lion in Maasai Mara, Kenya">
                        </div>
                    </div>
                    ...
                    <div class="swiper-slide">
                        <div class="rewind-card">
                            <img src="assets/img/Kenya/Rewind/rewind-6.jpg" alt="Giraffe in Maasai Mara, Kenya">
                        </div>
                    </div>
                    ...
                    <div class="swiper-slide">
                        <div class="rewind-card">
                            <img src="assets/img/Kenya/Rewind/rewind-7.jpg" alt="Safari vehicle parked under acacia tree on savanna, Maasai Mara, Kenya">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-card">
                            ...
                            <div class="testimonial-user">
                                <img src="assets/img/testimonials/Kenya.avif" alt="Shreya" class="testimonial-avatar">
                                <div class="testimonial-user-info">
                                    <h4>Shreya</h4>
                                    <span>Kenya Group Trip</span>
                                </div>
                            </div>
                        </div>
                    </div>
