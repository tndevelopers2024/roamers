...
<body>
    ...
    <section class="">
        <div class="container">
            <form action="kerala-onam-mail-send.php" method="POST" autocomplete="off">
            ...
            fetch("./dynamic/varkala-data.json") // Check this path
                ...
                .then(data => {
                    ...
                    if (startingPriceElem) {
                        startingPriceElem.textContent = `Starting Price: ₹8499/- `;
                    } else {
  ...
  if (e.target && e.target.id === "confirm-btn") {
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            fetch("./dynamic/varkala-data.json") // to change the price ... 
                ...
                .then(data => {
                    const locationKey = "kerala-onam"; // Change to "ooty" if needed
                    const locationData = data[locationKey];
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            ...
            <div class="div"><i class="fa-solid fa-plane-departure"></i> <p><b>Trip :</b> Kerala-onam</p></div>
