...
<head>
    ...
    <title>Roamers - Varkala Trip 3 Days 2 Nights</title>
    ...
    <section class="trip-home" class="banner-marigin-section" id="tripSection"
        ...
        <div class="container-lg" style="position: relative; text-align: center;">
            ...
            <h2 class="banner-hight-top ms-2"
                ...
                CLASSIC VARKALA WITH TRIVANDRUM
            </h2>
                        ...
                        <div class="swiper miniSlider px-px-md-0 py-3">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <img src="https://roamers.in/assets/img/varkala/varkala-1.jpg"
                                        class="img-fluid w-100" alt="Varkala Beach"
                                        style="border-radius: 10px; height: 350px; object-fit: cover;">
                                </div>
                                <div class="swiper-slide">
                                    <img src="https://roamers.in/assets/img/varkala/black-beach.jpg"
                                        class="img-fluid w-100" alt="Varkala Black Beach"
                                        style="border-radius: 10px; height: 350px; object-fit: cover;">
                                </div>
                                <div class="swiper-slide">
                                ...
                                <div class="swiper-slide">
                                    <img src="https://roamers.in/assets/img/varkala/kappilbeach.jpg"
                                        class="img-fluid w-100" alt="Kappil Beach Varkala"
                                        style="border-radius: 10px; height: 350px; object-fit: cover;">
                                </div>
                                <div class="swiper-slide">
                                    <img src="assets/img/varkala/qxz3xossdn9zmjz8cmrx.avif" class="img-fluid w-100"
                                        alt="Kappil Beach Varkala"
                                        style="border-radius: 10px; height: 350px; object-fit: cover;">
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="accordion-body" style="background-color: #f5fdff;">
                                            ...
                                            <ul class="ps-lg-3 ps-0">
                                                <li class=""><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                    ...
                                                    Meet our representative for a smooth pickup and check-in at the
                                                    resort & relax.
                                                </li>
                                                <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>Kick start your day with an
                                                    exhilarating cable car ride to the epic Jatayu Earth Center
                                                </li>
                                                <li><i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>Reach the top to witness the
                                                    giant Jatayu sculpture, a mythical bird from the Ramayana and enjoy
                                                    the panoramic views
                                                </li>
                                                <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>Freshen up and relax, then head
                                                    to the iconic Varkala Cliff. Enjoy vibrant cliffside cafes,
                                                    activities, unique shops and stunning views.
                                                </li>
                                                <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>
                                                    Witness a magical sunset at Varkala Beach, the perfect start to your
                                                    adventure.
                                                </li>
                                                <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>
                                ...
                                <div class="accordion-item mb-4 border  overflow-hidden">
                                        ...
                                        <button
                                            ...
                                            <div class="d-flex align-items-center w-100">
                                                <span
                                                    ...
                                                    2</span>
                                                <span> Beach, Forts, Kayaks & Nightlife
                                                </span>
                                    ...
                                    <div id="collapseTwo" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body" style="background-color: #f5fdff;">
                                            ...
                                            <ul class="ps-lg-3 ps-0">
                                                <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>Relish your breakfast and get
                                                    ready for the day!
                                                </li>
                                                <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>
                                                    Step back in time at the historic Anjengo Fort and the iconic
                                                    Varkala Lighthouse.
                                                <li><i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>Head to unique Black Sand Beach
                                                    (Thiruvambadi Beach) or Edava beach for a scenic stroll
                                                </li>
                                                <li><i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>Stop by the postcard-perfect
                                                    Kappil Beach for some serene vibes.
                                                </li>
                                                <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>Turn up the adventure with
                                                    kayaking through the lush Varkala mangroves.
                                                </li>
                                                <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>
                                                    Relax back at your resort or head out to enjoy Varkala’s exciting
                                                    nightlife with its cafes, night clubs and more
                                                </li>
                                                <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>
                                                    Overnight stay in Varkala – stargazing, storytelling and bonding
                                                    under the moonlight.
                                                </li>
                                    ...
                                    <div id="collapse3" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body bg-white px-4 py-3">
                                            <ul class="ps-lg-3 ps-0">
                                                ...
                                                <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>And
                                                    finally, it’s time for <span class="fw-bold">Farewell</span> – but
                                                    remember, in Roamers, every
                  ...
                  <div class="inner-box" style="background-color: #f0f0f0; padding: 15px; border-radius: 10px;">
                    ...
                    <div class="trip-form p-0">
                      <a href="https://wa.me/message/QYDBK5TO42TGH1" target="blank" class="btn butn butn__new bg-"
                        style="border-radius: 10px; background-color: light-green !imortant;">BOOK NOW</a>
                    </div>
                  </div>
                </div>
              </div>
