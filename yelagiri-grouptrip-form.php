...
<head>
    ...
    <title>Roamers - Yelagiri Group Trip - Form</title>
    ...
    <meta property="og:description"
        content="Join our Yelagiri group trip for an unforgettable beach adventure, curated experiences, and new friendships." />
    ...
    .price-box {
      ...
      padding:3px 6px;
        ...
        .background-image {
            ...
            width: 100%;
            height: 100%;
            background: url('https://roamers.in/assets/img/varkala/varkala-bg1.jpg');
...
<body>
    ...
    <div class="text-center mb-4">
        <h1 class="booking-form-head" style="margin-bottom: 50px;">
             Yelagiri</h1>
    ...
    <section class="">
        <div class="container">
            <form action="yelagiri-group-tirp-mail-send.php" method="POST" autocomplete="off">
  ...
  if (e.target && e.target.id === "confirm-btn") {
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            fetch("./dynamic/database.json") // to change the price ... 
                ...
                .then(data => {
                    const locationKey = "yelagiri"; // Change to "ooty" if needed
                    const locationData = data[locationKey];
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            ...
            <div class="div"><i class="fa-solid fa-plane-departure"></i> <p><b>Trip :</b> Yelagiri   </p></div>
