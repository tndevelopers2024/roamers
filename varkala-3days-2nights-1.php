...
<body>
  ...
  <section class="trip-home">
    <div class="container" style="  position: relative;">
      <h1>VIBRANT VARKALA WITH MUNROE</h1>
    </div>
  </section>
              ...
              <div class="accordion-item ai1">
                ...
                <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                  ...
                  <div class="accordion-body">
                    <ul class="acc-inner">
                      <li>
                        Meet our representative for a smooth pickup and check-in at the resort & relax.
                      </li>
                      <li>
                        Kick start your day with an exhilarating cable car ride to the epic Jatayu Earth Center
                      </li>
                      <li>Reach the top to witness the giant Jatayu sculpture, a mythical bird from the Ramayana and
                        enjoy the panoramic views
                      </li>
                      <li>Freshen up and relax, then head to the iconic Varkala Cliff. Enjoy vibrant cliffside cafes,
                        activities, unique shops and stunning views.</li>
                      <li>Witness a magical sunset at Varkala Beach, the perfect start to your adventure.</li>
              ...
              <div class="accordion-item ai1">
                <h2 class="accordion-header" id="headingTwo">
                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                    ...
                    <div class="days"> Day 2</div>: Munroe island, Beaches & more
                  </button>
                </h2>
                <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                  ...
                  <div class="accordion-body">
                    <ul class="acc-inner">
                      ...
                      <li>Next up, time go on a most famous Canoe ride through tranquil backwaters of Munroe island</li>
                      <li>Take your time to admire and explore the nature beauty and local culture</li>
                      <li>We'll return to Varkala and have some leisure time with the team. Night full of games, music,
                        dance, and whatnot!</li>
                      <li>Overnight stay in Varkala.</li>
                    </ul>
                  </div>
                </div>
              ...
              <div class="accordion-item ai1">
                <h2 class="accordion-header" id="headingTwo">
                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                    ...
                    <div class="days"> Day 3 </div>: Forts, Beach & Shopping | Departure
                  </button>
                </h2>
                <div id="collapse3" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                  ...
                  <div class="accordion-body">
                    <ul class="acc-inner">
                      ...
                      <li>
                        Visit the historic Anjengo Fort and the iconic Varkala Lighthouse.
                      </li>
                      <li>
                        Visit the Famous Sri Padnabaswamy Temple & Papanasam Beach
                      </li>
                      <li>
                        Head to unique Black Sand Beach (Thiruvambadi Beach) and Edava beach for a scenic stroll
                      </li>
                      <li>If you have time, squeeze in some last-minute shopping at Varkala’s vibrant spots.
                      </li>
                      <li>Departure. Leave the city with unforgettable memories.</li>
                    </ul>
                  </div>
                </div>
              </div>
