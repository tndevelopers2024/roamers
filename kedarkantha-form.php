...
<head>
  ...
  <meta name="description"
    content="Book your Kedarkantha Trek with Roamers – an epic winter snow trek through the Himalayas with stunning summit views!">
  <title>Roamers - Kedarkantha Trek (Booking)</title> <!-- SEO Meta Description -->
  <!-- SEO Meta Description -->
  <meta name="description" content="Roamers - Kedarkantha Trek Booking" />
  <meta name="author" content="Themeland" />
  <meta property="og:image:width" content="700" />
  <meta property="og:image:height" content="500" />

  <!-- Basic Open Graph tags -->
  <meta property="og:title" content="Roamers - Kedarkantha Trek Booking" />
  <meta property="og:description"
    content="Book the Kedarkantha Snow Trek with Roamers – trek through snow-covered forests to a stunning Himalayan summit at 12,500 ft." />
  <meta property="og:image" content="https://roamers.in/assets/img/kedarkantha/Swargrohini_Oodari.jpg" />
  <meta property="og:url" content="https://roamers.in/kedarkantha-form" />
  <meta property="og:type" content="website" />
  <meta name="twitter:card" content="summary_large_image" />
  <meta name="twitter:title" content="Roamers - Kedarkantha Trek Booking" />
  <meta name="twitter:description"
    content="Book the Kedarkantha Snow Trek with Roamers – trek through snow-covered forests to a stunning Himalayan summit at 12,500 ft." />
  <meta name="twitter:image" content="https://roamers.in/assets/img/kedarkantha/Swargrohini_Oodari.jpg" />
  <!-- Title  -->
  ...
  <style>
    ...
    .background-image {
      ...
      width: 100%;
      height: 100%;
      background: url('assets/img/kedarkantha/Swargrohini_Oodari.jpg');
...
<body>
  ...
  <section class="">
    <div class="container">
      <form action="kedarkantha-mail-send.php" method="POST" autocomplete="off">
      ...
      fetch("./dynamic/database.json") // Check this path
        ...
        .then(data => {
          ...
          if (startingPriceElem) {
            startingPriceElem.textContent = `Starting Price: ₹8,999/- `;
          } else {
