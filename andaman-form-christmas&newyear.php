...
<head>
  ...
  <title>Roamers - Andaman(Form)</title> <!-- SEO Meta Description -->
  <!-- SEO Meta Description -->
  <meta name="description" content="Roamers - Andaman(Form)" />
  <meta name="author" content="Themeland" />
  <meta property="og:image:width" content="700" />
  <meta property="og:image:height" content="500" />

  <!-- Basic Open Graph tags -->
  <meta property="og:title" content="Roamers - Andaman(Form)" />
  ...
  <meta name="twitter:title" content="Roamers - Andaman(Form)" />
...
<body>
  ...
  <section class="">
    <div class="container">
      <form action="andaman-mail-send-christmas&newyear.php" method="POST" autocomplete="off">
  ...
  <script>
    document.addEventListener("DOMContentLoaded", function () {
      fetch("./dynamic/varkala-data.json") // Check this path
        ...
        .then(data => {
          const locationKey = "andaman-christmas-new-year";
  ...
  <script>
    document.addEventListener("DOMContentLoaded", function () {
      fetch("./dynamic/varkala-data.json") // to change the price ... 
        ...
        .then(data => {
          const locationKey = "andaman-christmas-new-year"; // Change to "ooty" if needed
          const locationData = data[locationKey];
