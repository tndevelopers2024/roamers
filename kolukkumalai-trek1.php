...
<head>
  ...
  <meta name="description" content="Kolukkumalai" />
  <meta name="author" content="Themeland" />
  <meta property="og:image" content="https://roamers.in/assets/img/kolukkumalai-img/2.jpg" />
      ...
      <div class="row">
        ...
        <div class="col-4 col-md-4">
          <div class="trip-inner">
            ...
            <h2 style="color: black;">Chennai / Direct
            </h2>
          </div>
        </div>
      </div>
              ...
              <div class="accordion-item ai1">
                ...
                <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                  ...
                  <div class="accordion-body">
                    ...
                    <ul class="acc-inner">
                      <li>
                        Rise and shine, team! We've arrived in Suryanelli, base point for the Kolukkumalai Trek.
                        After refreshments, let's hit our adventure spot. Gear up for the thrilling Zipline, Giant
                        swing.

                      </li>
                      <li>
                        Return and Check-in at our beautiful Campstay. Relax and fresh up, and get ready for the Sunset
                        Trek to Phantom Hills.

                      </li>
                      <li>
                        Enjoy the sunset with panoramic views and descend back. Enjoy a delish dinner by the bonfire,
                        play games, music and more with the team
                      </li>
                      <li>
              ...
              <div class="accordion-item ai1">
                ...
                <div id="collapse3" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                  ...
                  <div class="accordion-body">
                    ...
                    <ul class="acc-inner">
                      <li>
                        Wake Up at 4:00 am, savour black tea and get ready for an epic Sunrise Trek to Kolukkumalai
                        Peak, experience the wild jeep safari at untamed roads leading us to the peak.
                      </li>
                      <li>
                        Let's enjoy our time and return back to our campsite. Post a hearty breakfast, let's check out
                        and head to explore Munnar.
                      ...
                      <li>
                        We'll proceed to beautiful Mattupetty Dam, opt for a thrilling speedboat ride or take a leisure
                        stroll.
                      </li>
                      <li>
                        Visit Echo point for the stunning green valley views, take your time and get connected by
                        nature.

                      </li>
                      <li>Next, we'll visit serene Kundala Lake, surrounded by lush greenery, with options for kayaking
                        or paddle boating.

                      </li>
                      <li>
                        Finally, we'll hit the shopping spot. Time to buy souvenirs for your loved ones.

                      </li>
                      <li>
                        Time for Farewell to this beautiful Hill Station. Depart back to Chennai and reach by
                        next day morning
                      </li>
            ...
            <div class="wrapper">
              ...
              <section id="first-tab-group" class="tabgroup">
                <div id="tab1">
                  ...
                  <p>
                  Includes camps. Solo travelers can share with a person of the same gender.
                  </p>
                  <p>
                  3 meals: 2 Breakfasts & 1 Dinner. Snacks and tea will be provided (local foods).
                  </p>
                  <p>
                ...
                <div id="tab2">
                  ...
                  <p>Any other costs involved due to a natural calamity or any other forced circumstances that are out of our control.
          ...
          <div class="sticky-sidebar">
            ...
            <div class="trip-tab">
              ...
              <div class="tab-content tab-con" id="pills-tabContent">
                ...
                <div class="tab-pane fade active show" id="pills-oct" role="tabpanel" aria-labelledby="pills-oct">
                  <div class="upcoming-slot ">
                    <h3>Nov 29</h3>
                    <!-- <h4>(Sold Out)</h4> -->
                  </div>
