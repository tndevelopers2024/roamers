    ...
    try {
        ...
        '>
            ...
            <div style='background: #4ec0db; color: #fff; text-align: center; padding: 14px 0; font-size: 1.08rem; letter-spacing: 0.5px;'>
                Thank you for booking your Sri Lanka Escapade with Roamers! <span style='margin-left:8px;'><img src='https://img.icons8.com/ios-filled/20/ffffff/checked-checkbox.png' style='vertical-align:middle;'/></span>
            </div>
        </div>
        ";
        ...
        <body>
            <div class="thankyou-container">
                ...
                <div class="thankyou-msg">
                    Your Sri Lanka Escapade booking has been received.<br>
