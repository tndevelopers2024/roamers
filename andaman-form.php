...
======================================== -->
  ...
  <section class="form-home">
    ...
    <ul class="banner-nav">
      ...
      <li class="locate"><a href="andaman">Andaman Island Hopping</a></li>
      <li>Booking</li>
    </ul>
  </section>
  ...
  <section class=" form-content-holder">
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-8">
          <form enctype="multipart/form-data" class="form" id="booking-form" action="andaman-contact.php" method="POST">
            ...
            <div class="column">
              <div class="check-box">
                <label>
                  <input checked type="radio" name="traval-date" id="traval-date" value="FEB 08">FEB 08
                </label>
              </div>

              <div class="check-box">
                <label>
                  <input checked type="radio" name="traval-date" id="traval-date" value="FEB 22">FEB 22
                </label>
              </div>

              <div class="check-box">
                <label>
                  <input checked type="radio" name="traval-date" id="traval-date" value="MAR 14">MAR 14
                </label>
              </div>
              <div class="check-box">
                <label>
                  <input checked type="radio" name="traval-date" id="traval-date" value="MAR 29">MAR 29
                </label>
              </div>
            </div>
            <div class="column">
