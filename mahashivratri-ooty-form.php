...
======================================== -->
  ...
  <section class="form-home">
    ...
    <ul class="banner-nav">
      ...
      <li class="locate"><a href="mahashivratri-ooty">ISHA & OOTY</a></li>
      <li>Booking</li>
    </ul>
  </section>
  ...
  <section class=" form-content-holder">
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-8">
          <form enctype="multipart/form-data" class="form" id="booking-form" action="mahashivratri-ooty-contact.php" method="POST">
            <h2 class="form-heading">
           Maha Shivrathri Celebration & Ooty
            </h2>
            <div class="column">
    ...
    <label>
            <input type="radio" name="traval-date" id="traval-date" value=" NOV 03"> NOV 03
              ...
              <div class="check-box">
                <label>
                  <input type="radio" name="traval-date" id="traval-date" value="MAR">MAR 08
                </label>
              </div>
              <!-- <div class="check-box">
                <label>
                  <input type="radio" name="traval-date" id="traval-date" value="FEB 16">FEB 16
                </label>
              </div> -->
            </div>
            <div class="column">
            ...
            <!-- <div class="gender-box">
              ...
              <div class="gender-option">
                <div class="sharing">
                  <input type="radio" checked id="sharing1" value="Double Sharing" name="sharing" />
                  <label for="sharing1">Double Sharing</label>
                </div>
                <div class="sharing">
                  <input type="radio"  id="sharing2" value="Triple Sharing" name="sharing" />
