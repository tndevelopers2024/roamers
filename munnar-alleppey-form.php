...
======================================== -->
  ...
  <section class="form-home">
    ...
    <ul class="banner-nav">
      ...
      <li class="locate"><a href="kerala">MUNNAR & ALLEPPEY - ONAM SPECIAL</a></li>
      <li>Booking</li>
    </ul>
  </section>
  ...
  <section class=" form-content-holder">
    ...
    <label>
            <input type="radio" name="traval-date" id="traval-date" value=" OCT 21"> OCT 21
              ...
              <div class="check-box">
                <label>
                  <input type="radio" name="traval-date" id="traval-date" value="OCT 01">OCT 01
                </label>
              </div>
            </div>
            <div class="column">
