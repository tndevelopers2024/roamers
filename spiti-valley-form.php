...
======================================== -->
  ...
  <section class="form-home">
    ...
    <ul class="banner-nav">
      ...
      <li class="locate"><a href="spiti-valley">Spiti Wonderland – Explore the Heights of Wonders!</a></li>
      <li>Booking</li>
    </ul>
  </section>
  ...
  <section class=" form-content-holder">
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-8">
          <form enctype="multipart/form-data" class="form" id="booking-form" action="spiti-contact.php" method="POST">
            ...
            <div class="column">
              ...
              <!-- <div class="check-box">
                <label>
                  <input type="radio" checked name="traval-date" id="traval-date" value="JAN 25">JAN 25
                </label>
              </div>

              <div class="check-box">
                <label>
                  <input type="radio" name="traval-date" id="traval-date" value="FEB 15">FEB 15
                </label>
              </div>

              <div class="check-box">
                <label>
                  <input type="radio" name="traval-date" id="traval-date" value="FEB 22">FEB 22
                </label>
              </div> -->
              <div class="check-box">
                <label>
                  <input type="radio" name="traval-date" id="traval-date" value="MAR 08">MAR 08
                </label>
              </div>
              <div class="check-box">
                <label>
              ...
              <div class="check-box">
                <label>
                  <input type="radio" name="traval-date" id="traval-date" value="MAR 22">MAR 22
                </label>
              </div>
              <div class="check-box">
                <label>
                  <input type="radio" name="traval-date" id="traval-date" value="MAR 29">MAR 29
                </label>
              </div>
              <div class="check-box">
                <label>
                  <input type="radio" name="traval-date" id="traval-date" value="APR 12">APR 12
                </label>
              </div>
              <div class="check-box">
                <label>
              ...
              <div class="check-box">
                <label>
                  <input type="radio" name="traval-date" id="traval-date" value="APR 26">APR 26
                </label>
              </div>
            </div>
