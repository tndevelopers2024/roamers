...
<head>
  ...
  <meta name="keywords" content="Roamers - Spiti Valley Trip">
...
<body>
  ...
  <section class="">
    <div class="container">
      <form action="spiti-valley-mail-send.php" method="POST" autocomplete="off">
  ...
  <script>
    document.addEventListener("DOMContentLoaded", function () {
      fetch("./dynamic/varkala-data.json") // Check this path
        ...
        .then(data => {
          const locationKey = "spiti-valley";
  ...
  <script>
    document.addEventListener("DOMContentLoaded", function () {
      fetch("./dynamic/varkala-data.json") // to change the price ... 
        ...
        .then(data => {
          const locationKey = "spiti-valley"; // Change to "ooty" if needed
          const locationData = data[locationKey];
