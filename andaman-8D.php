...
<body>
  ...
  <section class="trip-home">
    <div class="container" style="  position: relative;">
      <h1>ANDAMAN ISLAND HOPPING ALL IN ONE</h1>
    </div>
  </section>
        ...
        <div class="col-md-7" style="display: grid; place-items: center;">
          <div class="travel-des">
            <h2 style="text-align:left !important;" class="head text-center text-md-left kerala-overview">
              Welcome to Andaman Island!
            </h2>
            <p>
              Step into the Andaman Islands, where adventure meets paradise. We’re covering all 6 islands, giving you an
              experience most travelers miss. From the lively Port Blair to the pristine beaches of Havelock, the
              peaceful Neil Island, the historic ruins of Ross Island, the untouched beauty of Baratang, and stunning
              sunsets at Chidiatapu, each island brings its own unforgettable magic.
            </p>
            <p>
              The adventure doesn’t stop here. Dive into vibrant waters with scuba, explore hidden limestone caves,
              kayak through lush mangroves, spot sea creatures, enjoy birdwatching, and capture golden sunsets. With
              local tribes, museums, and historical sites, the Andamans are a nature lover's dream—and this
              ...
              <div class="accordion-item ai1">
                <h2 class="accordion-header" id="headingOne">
                  <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne"
                    ...
                    <div class="days"> Day 1 </div>: Arrival & Cellular Jail Experience
                  </button>
                </h2>
                <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                  ...
                  <div class="accordion-body">
                    <ul class="acc-inner">
                      <li>
                        Arrive in Port Blair and get a warm welcome before being transferred to your hotel.
                      </li>
                      <li>
                        Explore the historic Cellular Jail (Kalapani), a significant relic from India’s freedom
                        struggle.
                      </li>
                      <li>Witness the mesmerizing Sound & Light Show, bringing history to life with an immersive
                        experience.
                      </li>
              ...
              <div class="accordion-item ai1">
                <h2 class="accordion-header" id="headingTwo">
                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                    ...
                    <div class="days"> Day 2</div>: Baratang Trip - Limestone Cave & Mangrove Adventure
                  </button>
                </h2>
                <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                  ...
                  <div class="accordion-body">
                    <ul class="acc-inner">
                      <li>
                        Begin your day early with a thrilling journey to Baratang Island (150 km scenic road trip).
                      </li>
                      <li>
                        Cross creeks and dense tropical rainforests, taking a short ferry ride en route.
                      </li>
                      <li>
                        Enjoy an enchanting mangrove boat ride leading to the mystical Limestone Caves.
                      </li>
                      <li>
                        Stroll through nature’s marvels with a 1km walk to the caves.
                      </li>
                      <li>Return to Port Blair in the evening for leisure and rest.</li>
                    </ul>
                  </div>
                </div>
              </div>
              ...
              <div class="accordion-item ai1">
                <h2 class="accordion-header" id="headingTwo">
                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                    ...
                    <div class="days"> Day 3 </div>: Ross Island & Chidiyatapu - Nature & History Exploration
                  </button>
                </h2>
                <div id="collapse3" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                  ...
                  <div class="accordion-body">
                    <ul class="acc-inner">
                      <li>
                        Set sail to Ross Island (Netaji Subhash Chandra Bose Island), home to colonial-era ruins and
                        rich wildlife.
                      </li>
                      <li>
                        After exploring, head back to the Water Sports Complex for some thrilling water activities.
                      </li>
                      <li>
                        In the afternoon, embark on a scenic drive to Chidiyatapu, a paradise for nature lovers.
                      </li>
                      <li>
                        Enjoy a relaxing swim, breathtaking sunset views, and capture the perfect memories.
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div class="accordion-item ai1">
                <h2 class="accordion-header" id="headingTwo">
                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                    ...
                    <div class="days">Day 4</div>: Port Blair to Havelock (Swaraj Dweep) & Radhanagar Beach Delight
                  </button>
                </h2>
                <div id="collapse4" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                  ...
                  <div class="accordion-body">
                    ...
                    <ul class="acc-inner">
                      <li>
                        Board a private ferry to Havelock, soaking in the stunning ocean views (1.5-2.5 hrs journey).
                      </li>
                      <li>
                        On arrival, check into your hotel and unwind.
                      </li>
                      <li>
                        Visit the world-famous Beach No. 7 (Radhanagar Beach), voted as Asia’s best beach.
                      </li>
                      <li>
                        Enjoy soft white sands, turquoise waters, and a picture-perfect sunset.
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div class="accordion-item ai1">
                <h2 class="accordion-header" id="headingTwo">
                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                    ...
                    <div class="days">Day 5</div>: Elephant Beach/Lighthouse & Beachside Café Experience
                  </button>
                </h2>
                <div id="collapse5" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                  ...
                  <div class="accordion-body">
                    ...
                    <ul class="acc-inner">
                      <li>
                        Take a thrilling boat ride to Elephant Beach/Lighthouse, known for its vibrant coral reefs.
                      </li>
                      <li>
                        Indulge in exciting water sports like snorkeling, jet skiing, parasailing, and more (on direct
                        payment).
                      </li>
                      <li>
                        Post-adventure, enjoy a complimentary beer/mocktail at the highly-rated Something Different - A
                        Beachside Café.
                      </li>
                      <li>
                        Relax and soak in the beach vibes before returning to your hotel.
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div class="accordion-item ai1">
                <h2 class="accordion-header" id="headingTwo">
                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                    ...
                    <div class="days">Day 6</div>: Havelock to Neil Island (Shaheed Dweep) - Island Hopping & Stunning
                    Beaches
                  </button>
                </h2>
                <div id="collapse6" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                  ...
                  <div class="accordion-body">
                    ...
                    <ul class="acc-inner">
                      <li>
                        Board a morning private ferry to the tranquil Neil Island (1.5-2.5 hrs journey).
                      </li>
                      <li>
                        Explore Bharatpur Beach, ideal for a refreshing dip or thrilling water sports.
                      </li>
                      <li>
                        Witness the magical Natural Bridge (Howrah Bridge), accessible only during low tide.
                      </li>
                      <li>
                        End the day with a relaxing walk along Laxmanpur Beach, famous for its breathtaking sunset.
                      </li>
                      <li>
              ...
              <div class="accordion-item ai1">
                <h2 class="accordion-header" id="headingTwo">
                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                    ...
                    <div class="days">Day 7</div>: Neil Island to Port Blair & Optional Adventures
                  </button>
                </h2>
                <div id="collapse7" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                  ...
                  <div class="accordion-body">
                    ...
                    <ul class="acc-inner">
                      <li>
                        Enjoy a laid-back morning before boarding the ferry back to Port Blair.
                      </li>
                      <li>
                        Spend the day at leisure or opt for exciting optional tours:
                      </li>
                      <li>Chidiyatapu Sunset Point – A dreamy spot to end your trip with a stunning sunset.</li>
                      <li>Wandoor Beach – A peaceful escape with clear blue waters.</li>
                      <li>Corbyn’s Cove Beach – A lively beach perfect for relaxation.</li>
                      <li>Ross Island Boat Tour – Explore more of Andaman’s rich history and scenic beauty.</li>
                    </ul>
                  </div>
                </div>
              </div>
              ...
              <div class="accordion-item ai1">
                <h2 class="accordion-header" id="headingTwo">
                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                    ...
                    <div class="days">Day 8</div>: Departure from Port Blair - Fond Farewells
                  </button>
                </h2>
                <div id="collapse8" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                  ...
                  <div class="accordion-body">
                    ...
                    <ul class="acc-inner">
                      <li>
                        Savor your final breakfast on the island before checking out.
                      </li>
                      <li>
                        Transfer to Port Blair Airport, carrying back unforgettable memories of the Andamans.
                      </li>
                      <li>Bid goodbye to paradise, with hopes to return for another adventure!</li>
                    </ul>
                  </div>
                </div>
              </div>
