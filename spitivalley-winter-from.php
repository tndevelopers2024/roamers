...
<head>
    ...
    <title>SpitiValley - Winter </title>

    <!-- SEO Meta Description -->
    <meta name="description" content="Roamers - SpitiValley - Winter " />
    <meta name="keywords" content="Roamers - SpitiValley - Winter ">
    ...
    .price-box {
      ...
      padding:3px 6px;
        ...
        .background-image {
            ...
            width: 100%;
            height: 100%;
            background: url('assets/img/spiti-valley/p5.jpg');
...
<body>
    ...
    <section class="">
        <div class="container">
            <form action="spitivalley-winter-mail-send.php" method="POST" autocomplete="off">
                        ...
                        <div class="row px-2 px-md-4">
                            ...
                            <div class="cost-col mt-3" style="border-radius: 20px;">
                                ...
                                <div class="justify-content-center starting-price-box px-3">
                                    <p id="starting-price" class="starting-price">₹21,990/-</p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            fetch("./dynamic/varkala-data.json") // Check this path
                ...
                .then(data => {
                    const locationKey = "spiti-valley-winter";
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            fetch("./dynamic/varkala-data.json") // to change the price ... 
                ...
                .then(data => {
                    const locationKey = "spiti-valley-winter"; // Change to "ooty" if needed
                    const locationData = data[locationKey];
