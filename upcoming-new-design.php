            ...
            <div class="swiper-slide">
              <a href="pondicherry">
                ...
                <div class="silder-inner silder-inner1">
                  ...
                  <div class="inner">
                    <h4 style="padding-right: 20px;"><i
                        class="fa-solid fa-calendar-days text-color-from-envoto me-1"></i>
              ...
              <a href="kodaikanal1">
                ...
                <div class="silder-inner silder-inner1">
                  <div class="inner inner2 inner-home">
                    <h3>3 DAYS / 2 NIGHTS</h3>
                    <h4><i class="fa-solid fa-location-dot text-color-from-envoto me-1"></i>EX: Chennai
                    </h4>
                  </div>
                  ...
                  <div class="inner">
                    <h4 style="padding-right: 20px;"><i
                        class="fa-solid fa-calendar-days text-color-from-envoto me-1"></i>
                      <span>July 05,06,12,13,18,19</span>
                    </h4>
            ...
            <div class="swiper-slide">
              <a href="ooty">
                ...
                <div class="silder-inner silder-inner1">
                  ...
                  <div class="inner">
                    <p><i class="fa-solid fa-location-dot text-color-from-envoto me-1"></i>Nilgiri, Coonoor,
                      Coimbatore
                    </p>
                    <h4 class="sta">Starts at </h4>
                  </div>
              ...
              <a href="valley-of-flowers">
                ...
                <div class="silder-inner silder-inner1">
                  <div class="inner inner2 inner-home">
                    ...
                    <h4><i class="fa-solid fa-location-dot text-color-from-envoto me-1"></i>EX: Rishikesh
                    </h4>
                  </div>
            ...
            <div class="swiper-slide">
              <a href="munnar-alleppey3">
                ...
                <div class="silder-inner silder-inner1">
                  <div class="inner inner2 inner-home">
                    <h3>3 DAYS / 2 NIGHTS</h3>
                    <h4><i class="fa-solid fa-location-dot text-color-from-envoto me-1"></i>EX: Kochi,
                      Chennai
                    </h4>
                  </div>
                  <h2>Munnar Alleppey</h2>
                  <div class="inner">
                    <p><i class="fa-solid fa-location-dot text-color-from-envoto me-1"></i> Munnar, Alappuzha
                    </p>
                  </div>
                  <div class="inner">
                    <h4 style="padding-right: 20px;"><i
            ...
            <div class="swiper-slide">
              <a href="kolukkumalai-trek">
                ...
                <div class="silder-inner silder-inner1">
                  <div class="inner inner2">
                    <h3>3 DAYS / 2 NIGHTS</h3>
                    <h4><i class="fa-solid fa-location-dot text-color-from-envoto me-1"></i>EX: Direct,
                      Chennai
                    </h4>
                  </div>
            ...
            <div class="swiper-slide">
              <a href="chikmagalur">
                ...
                <div class="silder-inner silder-inner1">
                  ...
                  <div class="inner">
                    <p><i class="fa-solid fa-location-dot text-color-from-envoto me-1"></i>Chikmagalur, Z point,
                      Hebbe Falls</p>
                    <h4 class="sta">Starts at </h4>
                  </div>
                  ...
                  <div class="inner">
                    <h4 style="padding-right: 20px;"><i
                        class="fa-solid fa-calendar-days text-color-from-envoto me-1"></i>
                      <span class="chik-dates">Aug 10, 17</span>
                    </h4>
              ...
              <a href="andaman">
                ...
                <div class="silder-inner silder-inner1">
                  <div class="inner inner2">
                    ...
                    <h4><i class="fa-solid fa-location-dot text-color-from-envoto me-1"></i>EX: Port Blair
                    </h4>
                  </div>
                  <h2>Andaman Island Hopping</h2>
                  <div class="inner">
                    <p><i class="fa-solid fa-location-dot text-color-from-envoto me-1"></i>Havelock Island, Neil
                      Island, Port
                      Blair
                    </p>
                    <h4 class="sta">Starts at </h4>
              ...
              <a href="chikmagalur">
                ...
                <div class="silder-inner silder-inner1">
                  ...
                  <div class="inner">
                    <h4 style="padding-right: 20px;"><i
                        class="fa-solid fa-calendar-days text-color-from-envoto me-1"></i>
                      <span class="chik-dates">Oct 05, 12</span>
                    </h4>
                    <h4><span class="chik-price">₹7,990</span> </h4>
                  </div>
                </div>
              ...
              <a href="chikmagalur">
                ...
                <div class="silder-inner silder-inner1">
                  ...
                  <div class="inner">
                    <h4 style="padding-right: 20px;"><i
                        class="fa-solid fa-calendar-days text-color-from-envoto me-1"></i>
                      <span class="chik-dates">Nov 08, 15</span>
                    </h4>
                    <h4><span class="chik-price">₹7,990</span> </h4>
                  </div>
                </div>
              ...
              <a href="chikmagalur">
                ...
                <div class="silder-inner silder-inner1">
                  ...
                  <div class="inner">
                    <h4 style="padding-right: 20px;"><i
                        class="fa-solid fa-calendar-days text-color-from-envoto me-1"></i>
                      <span class="chik-dates">Dec 07, 14</span>
                    </h4>
                    <h4><span class="chik-price">₹7,990</span> </h4>
                  </div>
                </div>
