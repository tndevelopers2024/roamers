...
<head>
  ...
  <meta property="og:image:secure_url" content="https://roamers.in/assets/img/chikmagalur/Media/10.jpg" width="600"
  ...
  <meta name="twitter:description"
    content="Discover the beauty of Chikmagalur with our detailed travel guide and tips." />
  <meta name="twitter:image" content="https://roamers.in/assets/img/chikmagalur/Media/10.jpg" />
...
<body>
            ...
            <div class="col">
              <div class="enhanced-box">
                ...
                <div>
                  ...
                  <div class="info-value">Chennai - Bangalore
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="row g-4 flex-column-reverse flex-md-row align-items-center">
          ...
          <div class="col-md-7">
            <div class="travel-des p-3 p-md-4">
              <h2 class="mb-3 pt-3">Adventure filled with thrills and unforgettable moments! 🌄🚙🏞️
              </h2>
              ...
              <p style="color: #555;" class="desk-desc d-none d-md-block">
                ...
                South India's Highest Peak where we battle mist as we ascend higher and higher.

                <br> <br>But that's just the start! Next up, get ready for an accelerating jeep safari and witness the
                majestic Jhari falls. Further we’ll venture to Baba Budagiri, a ‘Swiss-like paradise’. Next day, let’s
                wake up early and go on a thrilling trek to Z Point, where the stunning panoramic views awaits! And the
                grand finale? to jaw-dropping natural wonder; Hebbe Falls, a sight that will leave you in awe.
              ...
              <p style="color: #555;" class="mob-desc d-block d-md-none">
                Hey there, fellow travellers! Get ready for an exhilarating Chikmagalur trek that is sure to ignite your
                sense of adventure. Our Journey begins with an epic trek to the Mullayanagiri Peak, get ready to conquer
                South India's Highest Peak where we battle mist as we ascend higher and higher.<br>
                <span id="dots">...</span>
                <span id="moreText" style="display: none;"><br><br>
                  But that's just the start! Next up, get ready for an accelerating jeep safari and witness the
                  majestic Jhari falls. Further we’ll venture to Baba Budagiri, a ‘Swiss-like paradise’. Next day, let’s
                  wake up early and go on a thrilling trek to Z Point, where the stunning panoramic views awaits! And
                  the
                  grand finale? to jaw-dropping natural wonder; Hebbe Falls, a sight that will leave you in awe.
                </span>
              </p>
                  ...
                  <h2 class="accordion-header" id="headingOne">
                    <button class="accordion-button text-dark fw-bold d-flex justify-content-between align-items-center"
                      ...
                      <div class="d-flex align-items-center">
                        ...
                        <span> Sightseeing & Overnight Camping</span>
                      </div>
                    ...
                    <div class="accordion-body" style="background-color: #f5fdff;">
                      ...
                      <ul class="ps-lg-3 ps-0">
                        ...
                        <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>
                          On our way, we'll make a stop at the magnificent Chennakeshava Temple in Belur. Marvel at the
                          intricate architecture, detailed carvings. Also, it's great to capture stunning photos for
                          your Instagram gang!
                          </span>
                        </li>
                        <li><i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>
                          After, we'll make our way to Hirekolale Lake, a serene & picturesque lake located near
                          Chikmagalur. Witness the breathtaking sunset over the lake.
                        </li>
                        <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>
                          Finally, get ready for an unforgettable camping experience! as the sun sets, we'll arrive at
                          our spot. Enjoy the local style-dinner, play games, music, dance around the crackling campfire
                          under the stars.
                        </li>
                        <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>
                  ...
                  <h2 class="accordion-header" id="headingTwo">
                    <button
                      ...
                      <div class="d-flex align-items-center w-100">
                        ...
                        <span> Mullayanagiri Peak, Baba Budangiri & Jhari Falls</span>
                    ...
                    <div class="accordion-body" style="background-color: #f5fdff;">
                      ...
                      <ul class="ps-lg-3 ps-0">
                        ...
                        <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>
                          ...
                          hiking boots, battle the mist, and conquer the peak to be rewarded with an awe-inspiring
                          panoramic view.
                        </li>
                        <li><i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>
                          After, let's make our way to Jhari Falls. We'll go in a Jeep in the untamed terrains and reach
                          the enchanting waterfalls. if you're up for it, take a refreshing dip in the falls and feel
                          rejuvenated.

                        </li>
                        <li><i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>
                          Next, we'll go to Baba Budan giri - a place with magical landscapes. Enjoy the mesmerizing
                          views and let's take some time to sit here and appreciate the beauty of nature. Truly
                          captivating!
                        </li>
                        <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>
                        ...
                        <li><i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3"
                            style="font-size: 0.65rem;"></i>Rest well, team! Recharge for an exciting trek early
                          tomorrow morning.
                        </li>
                      </ul>
                    </div>
                  ...
                  <h2 class="accordion-header" id="headingThree">
                    <button
                      ...
                      <div class="d-flex align-items-center w-100">
                        ...
                        <span>Z Point Trek & Hebbe Falls</span>
                        <i class="bi bi-chevron-down ms-auto transition-arrow" style="color:#0c63e4;"></i>
                      </div>
                    </button>
                  </h2>
                  <div id="collapse3" class="accordion-collapse collapse" aria-labelledby="headingThree"
                    ...
                    <div class="accordion-body bg-white px-4 py-3">
                      <ul class="ps-lg-3 ps-0">
                        ...
                        <li><i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>
                          We'll navigate rugged terrain surrounded by Lush Green Mountains to reach the Z point. Enjoy
                          the breathtaking views, If you're a mountain lover this kemangundi trek is a real treat!
                        </li>
                        <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>
                          Go on a thrilling Jeep safari and mini trek to reach Hebbe Falls, one of Karnataka's
                          enchanting natural wonders. Swim in refreshing waters or relax and feel the mist on your face,
                          let the cascading sound wash away your worries.
                        </li>
                        <li><i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3"
                            style="font-size: 0.65rem;"></i>Reach
                          Finally, let's gather for a Heartfelt Farewell lunch, cherishing the memories we've created
                          and reflecting how a group of random people has turned into a tight-knit family.
                        </li>
                        <li><i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>
            ...
            <div class="important-notes shadow" style="border-radius: 10px; background-color: rgb(255, 244, 244);"
              ...
              <div>
                <p>
                  ...
                  Personal Expenses like shopping and for other optional activities.
                </p>
                <p>
                  <i class="fa-solid fa-circle-xmark me-2 pulse" style="color: red;"></i>
          ...
          <div class="col-md-4">
            ...
            <div class="price-sticky" style="position: sticky;">
              ...
              <div class="priceCard shadow" style="border-radius: 10px;">
                <img src="assets/img/chikmangalur/Media/7.jpg" alt="roamers-Gallery"" alt=" Ladakh Banner 3"
                  ...
                  <div class="inner-box" style="background-color: #f0f0f0; padding: 15px; border-radius: 10px;">
                    ...
                    <h5 class="special-offer">
                      <span class="old-price">
                        <strike>₹ 12,990/-</strike>
                      </span>
                      <span class=""></span><span class="new-price">₹9,499/-</span>
                    </h5>

                    <p>perfect for group adventures and shared <br> memories.</p>
                    <div class="trip-form p-0">
                      <a href="chikmagalur-form-christmas-new-year.php" class="btn butn butn__new bg-" style="border-radius: 10px;">Dates
                        & Costing</a>
                    </div>
                  </div>
                </div>
      ...
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <div class="slider-image">
            <img src="assets/img/chikmangalur/Media/1.jpg" alt="roamers-Gallery">
          </div>
        </div>
        <div class="swiper-slide">
          <div class="slider-image">
            <img src="assets/img/chikmangalur/Media/hills.jpg" alt="roamers-Gallery">
          </div>
        </div>
        <div class="swiper-slide">
          <div class="slider-image">
            <img src="assets/img/chikmangalur/Media/4.jpg" alt="roamers-Gallery">
          </div>
        </div>
        <div class="swiper-slide">
          <div class="slider-image">
            <img src="assets/img/chikmangalur/Media/7.jpg" alt="roamers-Gallery">
          </div>
        </div>
        <div class="swiper-slide">
          <div class="slider-image">
            <img src="assets/img/chikmangalur/Media/8.jpg" alt="roamers-Gallery">
          </div>
        </div>
        <div class="swiper-slide">
          <div class="slider-image">
            <img src="assets/img/chikmangalur/Media/10.png" alt="roamers-Gallery">
          </div>
        </div>
        <div class="swiper-slide">
          <div class="slider-image">
            <img src="assets/img/chikmangalur/Media/10.jpg" alt="roamers-Gallery">
          </div>
        </div>
        <div class="swiper-slide">
          <div class="slider-image">
            <img src="assets/img/chikmangalur/Media/2.jpg" alt="roamers-Gallery">
          </div>
        </div>
      </div>
    ...
    <div class="bottom-bar-content">
      <div class="price-box ">
        ...
        <div class="price-info">
          <span class="price-amount ">₹9,499/-</span>
          <span class="per-person">(Per Person)</span>
        </div>
      </div>
      <a href="chikmagalur-form-christmas-new-year.php" class="btn-book">Dates & Costing</a>
    </div>
  </div>
  ...
  <script>
    ...
    const images = [
      "assets/img/chikmangalur/Media/6.jpg",
    ];
