...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        $mail->isHTML(true);
        $mail->Subject = 'NEW Ultimate Ladakh Circuit - 7 Days BOOKING RECEIVED';
        ...
        '>
            <div style='background: linear-gradient(90deg, #4ec0db 0%, #1e90ff 100%); padding: 32px 0 18px 0; text-align: center;'>
                ...
                <h2 style='color: #fff; font-size: 2.1rem; margin: 0 0 6px 0; letter-spacing: 1px; font-weight: 700;'>
                   ...
                   Ultimate Ladakh Circuit - 7 Days
                </h2>
            ...
            <div style='background: #4ec0db; color: #fff; text-align: center; padding: 14px 0; font-size: 1.08rem; letter-spacing: 0.5px;'>
                Thank you for booking your Ultimate Ladakh Circuit - 7 Days adventure with Roamers! <span style='margin-left:8px;'><img src='https://img.icons8.com/ios-filled/20/ffffff/checked-checkbox.png' style='vertical-align:middle;'/></span>
            </div>
        </div>
        ";
