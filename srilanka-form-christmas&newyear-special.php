...
<body>
  ...
  <section class="">
    <div class="container">
      <form action="srilanka-mail-send-christmas&newyear-special.php" method="POST" autocomplete="off">
  ...
  <script>
    document.addEventListener("DOMContentLoaded", function () {
      fetch("./dynamic/database.json") // Check this path
        ...
        .then(data => {
          const locationKey = "srilanka-christmas-new-year";
  ...
  <script>
    document.addEventListener("DOMContentLoaded", function () {
      fetch("./dynamic/database.json") // to change the price ... 
        ...
        .then(data => {
          const locationKey = "srilanka-christmas-new-year"; // Change to "ooty" if needed
          const locationData = data[locationKey];
