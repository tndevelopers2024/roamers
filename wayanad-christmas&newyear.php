...
<head>
    ...
    <meta property="og:title" content="Roamers - Wayanad Trip" />
    <meta property="og:description"
        content="Join our Wayanad trip for an unforgettable adventure, curated experiences, and new friendships." />
    ...
    <meta name="twitter:title" content="Roamers - Wayanad Trip" />
...
<body>
                            ...
                            <div class="col">
                                <div class="enhanced-box">
                                    ...
                                    <div>
                                        ...
                                        <div class="info-value">Bangalore / Chennai</div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row text-center">
                            ...
                            <div class="col-7 px-0" style="border-left:1px solid #cbc9c9;">
                                <div class="enhanced-box">
                                    ...
                                    <div>
                                        <div class="info-label">Pickup & Drop</div>
                                        <div class="info-value">Direct Wayanad / Chennai
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-7">
                            <div class="travel-des p-3 p-md-4">
                                ...
                                <p style="color: #555;" class="desk-desc d-none d-md-block">
                                    Get ready for an exciting Wayanad adventure, Roamers! Picture trekking to Chembra
                                    Peak, where the heart-shaped lake unfolds its magic. The trip loaded with
                                    adrenaline-pumping Jeep safari, Zipline adventures, nature & wildlife spotting,
                                    Waterfall chasing, and surprises at every turn.
                                    <br><br>
                                    Days are filled with immersive local experiences, scenic exploration, team sessions,
                                    exhilarating adventures, and, of course, feasting on Kerala cuisine. Wayanad isn’t
                                    just a destination; it's a nature retreat ready to be unlocked. Ready for the ride,
                                    Roamers?
                                </p>
                                ...
                                <p style="color: #555;" class="mob-desc d-block d-md-none">
                                    ...
                                    <span id="moreText" style="display: none;"><br><br>
                                        Days are filled with immersive local experiences, scenic exploration, team
                                        sessions, exhilarating adventures, and, of course, feasting on Kerala cuisine.
                                        Wayanad isn’t just a destination; it's a nature retreat ready to be unlocked.
                                        Ready for the ride, Roamers?
                                    </span>
                                </p>
     ...
     margin-top: 5px;">
                                            ...
                                            <button
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <span class="badge bg-primary rounded-pill me-3 px-3 py-2">Day
                                                        1</span>
                                                    <span>Overnight journey to Wayanad</span>
                                                </div>
                                            ...
                                            <div class="accordion-body" style="background-color: #f5fdff;">
                                                <ul class="ps-lg-3 ps-0">
                                                    <li>
                                                        ...
                                                        Hey Roamers! Meet your team and trip leader at the given point,
                                                        and let’s kick-start our Wayanad journey.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        Overnight journey: We’ll travel from Chennai to Bangalore
                                                        (Sleeper A/C Bus)
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        We’ll reach Bangalore early in the morning, grab a quick tea,
                                                        and continue our journey to this amazing hill station.
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                            ...
                                            <button
                                                ...
                                                <div class="d-flex align-items-center w-100">
                                                    <span
                                                        ...
                                                        2</span>
                                                    <span>Wayanad Arrival, Karapuzha Adventures & more</span>
                                            ...
                                            <div class="accordion-body" style="background-color: #f5fdff;">
                                                ...
                                                <ul class="ps-lg-3 ps-0">
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        We’ll reach Wayanad by morning. On the way, let’s stop at the
                                                        Jain Temple, famous for its ancient architecture and historical
                                                        charm.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        Next, we’ll visit the peaceful Karapuzha Dam & adventure park.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        Explore the serene Dam and try the longest zipline, a giant
                                                        swing, and other thrilling activities or just relax in the
                                                        scenic surroundings.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        Later, we’ll stop at Manjappara Viewpoint to soak in stunning
                                                        views and capture some beautiful pictures.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        Let’s return to the resort, where it’s time for some fun and
                                                        bonding. Campfire, music, games, and dance.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        Relish a delicious dinner with the team and overnight stay at
                                                        Resort.
                                                    </li>
                                                </ul>
                                            </div>
                                            ...
                                            <button
                                                ...
                                                <div class="d-flex align-items-center w-100">
                                                    <span
                                                        class="badge bg-primary rounded-pill me-3 px-3 py-2 animated-badge">Day
                                                        3</span>
                                                    <span>Edakkal Caves, Glass Bridge Adventures | Camping</span>
                                                    <i class="bi bi-chevron-down ms-auto transition-arrow"
                                                        style="color:#0c63e4;"></i>
                                                </div>
                                            </button>
                                            ...
                                            <div class="accordion-body bg-white px-4 py-3">
                                                <ul class="ps-lg-3 ps-0">
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        After a quick freshen-up and breakfast, we’ll begin our day with
                                                        a hike to the Edakkal Caves.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        Let’s explore this ancient wonder and take in the epic views
                                                        from the top.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        After lunch, we’ll jump into a jeep safari and head to the
                                                        stunning 900 Kandi Glass Bridge. Opt for optional activities
                                                        nearby for extra fun.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        From here, we’ll drive to the campsite in a jeep. If time
                                                        permits, we can go on a short hike to a hidden waterfall nearby.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        Let’s gather for a team dinner around the campfire, enjoy music
                                                        and dance, and camp under the stars.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        We’ll relish a scrumptious dinner before settling into our tents
                                                        for the night.
                                                    </li>
                                                </ul>
                                            </div>
                                            ...
                                            <button
                                                ...
                                                <div class="d-flex align-items-center w-100">
                                                    <span
                                                        class="badge bg-primary rounded-pill me-3 px-3 py-2 animated-badge">Day
                                                        4</span>
                                                    <span>Tea Estate Zipline, Banasura Boating, and Farewell</span>
                                                    <i class="bi bi-chevron-down ms-auto transition-arrow"
                                                        style="color:#0c63e4;"></i>
                                                </div>
                                            </button>
                                            ...
                                            <div class="accordion-body bg-white px-4 py-3">
                                                <ul class="ps-lg-3 ps-0">
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        We’ll wake up to stunning views at the campsite and enjoy a
                                                        hearty breakfast.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        Our next stop is the zipline spot, where we can try the
                                                        thrilling cycle zipline over lush tea estates or simply relax in
                                                        the peaceful surroundings.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        Then, we’ll head to Banasura Sagar Dam, one of the largest
                                                        earthen dams in the world.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        Let’s hop on a speedboat ride for an exhilarating experience and
                                                        sneak some time for souvenir shopping.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        Finally, we’ll visit the magical Meenmutty Waterfalls,
                                                        surrounded by rocky green mountains like a paradise setting.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        After quick refreshments, we’ll wrap up this unforgettable
                                                        Wayanad trip and depart with incredible memories.
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                          ...
                          <li>
                            ...
                            <section id="inclusion">
                                <div class="important-notes shadow"
                                    ...
                                    <div>
                                        ...
                                        <p>
                                            <i class="fa-solid fa-circle-check me-2 pulse" style="color: #1fa463;"></i>
                                            Includes Hotels or Camps. Solo travellers can share with a person of same
                                            gender travellers.
                                        </p>
                                        <p>
                                            <i class="fa-solid fa-circle-check me-2 pulse" style="color: #1fa463;"></i>
                            ...
                            <div class="important-notes shadow"
                                ...
                                <div>
                                    ...
                                    <p>
                                        <i class="fa-solid fa-circle-xmark me-2 pulse" style="color: #ff6b6b;"></i>
                                        Personal Expenses like shopping and for other optional activities like Kayaking
                                        or zipline.
                                    </p>
                                    <p>
                                        <i class="fa-solid fa-circle-xmark me-2 pulse" style="color: #ff6b6b;"></i>
                                ...
                                <div class="price-card shadow p-1" style="border-radius: 10px;">
                                    <div class="p-2">
                                        ...
                                        <div class="inner-box"
                                            ...
                                            <p>For Travellers Joining from Chennai or other Locations the pricing
                                                differs</p>
                                            <div class="trip-form p-0">
                                                <a href="wayanad-from-christmas-newyear..php"
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="slider-image">
                            <img src="assets\optimized-images\wayand-trip\wayand-img-by-roamers (1).avif"
                                alt="Sri Lanka 1">
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="slider-image">
                            <img src="assets\optimized-images\wayand-trip\wayand-img-by-roamers (2).avif"
                                alt="Sri Lanka 3">
                        </div>
                    </div>
                    <div class="swiper-slide">
                    ...
                    <div class="swiper-slide">
                        <div class="slider-image">
                            <img src="assets\optimized-images\wayand-trip\wayand-img-by-roamers (5).avif"
                                alt="Sri Lanka 3">
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="slider-image">
                            <img src="assets\optimized-images\wayand-trip\wayand-img-by-roamers (6).avif"
                                alt="Sri Lanka 3">
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="slider-image">
                            <img src="assets\optimized-images\wayand-trip\wayand-img-by-roamers (7).avif"
                                alt="Sri Lanka 3">
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="slider-image">
                            <img src="assets\optimized-images\wayand-trip\wayand-img-by-roamers (8).avif"
                                alt="Sri Lanka 4">
                        </div>
                    </div>
                </div>
        ...
        <div class="rewind-header" style="margin-bottom: 50px;">
            <div class="rewind-title-area">
                <h3 class="head" style="text-align: center; margin-bottom: 20px;"> <img
                        src="assets/img/valley-of-flowers/fast-backward.png" alt="rewind icon" style="width: 25px;"
                        class="align-start me-2">Roamers Rewind <img
                        src="assets/img/valley-of-flowers/fast-backward.png" alt="rewind icon" style="width: 25px;"
                        class="align-start">
                </h3>
            </div>
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="rewind-card">
                            <img src="assets\optimized-images\wayand-trip\wayand-img-by-roamers (1).avif" alt="Sri Lanka 1">
                        </div>
                    </div>
                    ...
                    <div class="swiper-slide">
                        <div class="rewind-card">
                            <img src="assets\optimized-images\wayand-trip\wayand-img-by-roamers (2).avif" alt="Sri Lanka 2">
                        </div>
                    </div>
                    ...
                    <div class="swiper-slide">
                        <div class="rewind-card">
                            <img src="assets\optimized-images\wayand-trip\wayand-img-by-roamers (4).avif" alt="Sri Lanka 3">
                        </div>
                    </div>
                    ...
                    <div class="swiper-slide">
                        <div class="rewind-card">
                            <img src="assets\optimized-images\wayand-trip\wayand-img-by-roamers (5).avif" alt="Sri Lanka 4">
                        </div>
                    </div>
                    ...
                    <div class="swiper-slide">
                        <div class="rewind-card">
                            <img src="assets\optimized-images\wayand-trip\wayand-img-by-roamers (6).avif" alt="Sri Lanka 5">
                        </div>
                    </div>
                    ...
                    <div class="swiper-slide">
                        <div class="rewind-card">
                            <img src="assets\optimized-images\wayand-trip\wayand-img-by-roamers (7).avif" alt="Sri Lanka 6">
                        </div>
                    </div>
                    ...
                    <div class="swiper-slide">
                        <div class="rewind-card">
                            <img src="assets\optimized-images\wayand-trip\wayand-img-by-roamers (8).avif" alt="Sri Lanka 7">
                        </div>
                    </div>
        ...
        <div class="mobile-bottom-bar">
            <div class="bottom-bar-content">
                ...
                <a href="wayanad-from-christmas-newyear..php" class="btn-book">Dates & Costing</a>
            </div>
        </div>
    ...
    <script>
        ...
        const images = [
            "assets/img/wayanad/Chembra-Peak-Wayanad.jpg",
        ];
