...
<head>
    ...
    <title>Roamers - Events (Nov 26)</title>
                        ...
                        <div class="card-body">
                            <h3 class="text-white py-2 px-2 event-title-responsive"
                                ...
                                <span style="display:inline-block;">
                                    Strangers Meetup: Pottery Workshop Edition
                                </span>
                            </h3>
                        </div>
                    </div>
                    ...
                    <div class="card mb-4 p-2"
                        ...
                        <div class="card-body">
                            ...
                            <p class="pulse mb-4" style="line-height: 2.4;">
                                ...
                                Whether you are curious, an introvert, or full of energy, it doesn’t matter!
                                Come join us for an evening of art, fun, mindfulness, and make new friends with people
                                who are open, playful, and just as curious as you are.
                                ...
                                <div class="card-body" style="padding: 1.2rem 1.5rem;">
                                    ...
                                    <ul style="list-style: none; padding-left: 0; margin-bottom: 0; margin-top: 12px;">
                                        <li style="margin-bottom: 10px;">
                                            ...
                                            A guided pottery-making session (no experience needed!)
                                        </li>
                                        <li style="margin-bottom: 10px;">
                                            <i class="fa-solid fa-star me-1" style="color: #f7b731;"></i>
                                            Fun icebreakers to keep the energy light and creative
                                        </li>
                                        <li style="margin-bottom: 10px;">
                                            <i class="fa-solid fa-users me-1" style="color: #0984e3;"></i>
                                            A cozy space where conversations flow as freely as clay
                                        </li>
                                        <li style="margin-bottom: 10px;">
                                            <i class="fa-solid fa-user-friends me-1" style="color: #00b894;"></i>
                                            A chance to meet like-minded strangers who love trying new things
                                        </li>
                                        <li style="margin-bottom: 10px;">
                                            <i class="fa-regular fa-face-laugh-beam me-1 " style="color: #e17055;"></i>
                                            Connect for Future Roamers Trips with Strangers

                                        </li>
                                        <li>
                                            <i class="fa-regular fa-face-laugh-beam me-1" style="color: #e17055;"></i>
                                            An evening filled with chill vibes, laughter, and memories to take home with
                                            the art you made 🏺!
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <p class="pulse mb-2" style="line-height: 2.4;">
                                Love experiences that are both creative and social?

                                Imagine a warm evening with soothing music, shared laughs, spinning clay, and strangers
                                who might just become your next set of friends (or travel buddies).

                            </p>

                            <strong>👉 Spots are limited. Save yours now and let’s create something beautiful together!
                            </strong>
                            </p>
                        </div>
                    </div>
                            ...
                            <section id="terms">
                                <div class="important-notes">
                                    ...
                                    <div>
                                        ...
                                        <p>
                                            <i class="fa-solid fa-circle-check me-2 pulse" style="color: green;"></i>
                                            Photos and videos may be taken during the event and used for promotional
                                            purposes.
                                        </p>
                                        <p>
                                            <i class="fa-solid fa-circle-check me-2 pulse" style="color: green;"></i>
                                            Tickets are strictly non-transferable. Any resale will result in
                                            cancellation
                                            without refund or compensation.
                                        </p>
                                        <p>
                                            <i class="fa-solid fa-circle-check me-2 pulse" style="color: green;"></i>
                                            An internet/processing fee may apply per ticket. Please review the total
                                            before
                                            completing payment.
                                        </p>
                                        <p>
                                            <i class="fa-solid fa-circle-check me-2 pulse" style="color: green;"></i>
                                            If you’re feeling unwell, please avoid purchasing tickets or attending the
                                            event.
                                        </p>
                                        <p>
                                            <i class="fa-solid fa-circle-check me-2 pulse" style="color: green;"></i>
                    ...
                    <div class="card animated-card-pop"
                        ...
                        <div class="card-body" style="text-align: center;">
                            <span style="font-size: 1.1rem; color: #e17055; font-weight: 600;">
                                ...
                                Join us for an evening of art, laughter, and soulful connections!
                            </span>
                        </div>
                    </div>
                </div>
                ...
                <div class="booking-card">
                    ...
                    <div class="pulse"
                        ...
                        <div style="display: flex; align-items: flex-start; gap: 14px;">
                            ...
                            <span>
                                <span style="font-weight: 500;">Nov 26 , 2025</span>
                    ...
                    <div class="amount-section">
                        ...
                        <div class="amount-row">
                            ...
                            <span class="amount-value pulse" id="price" aria-live="polite" role="status">990 ₹</span>
                        </div>
                    </div>
                    ...
                    <form method="POST" action="events-send-mail.php">
                        ...
                        <input type="hidden" name="calculated_base_price" id="calculated_base_price" value="990">
