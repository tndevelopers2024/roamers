...
<head>
  ...
  <style>
    ...
    .background-image {
      ...
      width: 100%;
      height: 100%;
      background: url('https://www.roamers.in/assets/img/kolukkumalai-img/Kolukkumalai-tea-estate.jpeg');
...
<body>
  ...
  <section class="">
    <div class="container">
      <form action="kolukkumalai-mail-send.php" method="POST" autocomplete="off">
      ...
      fetch("./dynamic/database.json") // Check this path
        ...
        .then(data => {
          ...
          if (startingPriceElem) {
            startingPriceElem.textContent = `Starting Price: ₹8,499/- `;
          } else {
  ...
  <script>
    document.addEventListener("DOMContentLoaded", function () {
      fetch("./dynamic/database.json") // to change the price ... 
        ...
        .then(data => {
          const locationKey = "munnar"; // Change to "ooty" if needed
          const locationData = data[locationKey];
      ...
      if (nextBtn2) {
        nextBtn2.addEventListener("click", (e) => {
          ...
          const confirmationHTML = `
            ...
            <div class="div"><i class="fa-solid fa-plane-departure"></i> <p><b>Trip :</b> Munnar</p></div>
