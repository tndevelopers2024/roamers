...
<body>
  ...
  <section class="trip-home">
    <div class="container" style="  position: relative;">
      <h1>CLASSIC VARKALA WITH TRIVANDRUM</h1>
    </div>
  </section>
              ...
              <div class="accordion-item ai1">
                <h2 class="accordion-header" id="headingTwo">
                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                    ...
                    <div class="days"> Day 2</div>: Beach, Forts, Kayaks & Nightlife
                  </button>
                </h2>
                <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                  ...
                  <div class="accordion-body">
                    <ul class="acc-inner">
                      <li>
                        Relish your breakfast and get ready for the day!
                      </li>
                      <li>
                        Step back in time at the historic Anjengo Fort and the iconic Varkala Lighthouse.
                      </li>
                      <li>
                        Head to unique Black Sand Beach (Thiruvambadi Beach) or Edava beach for a scenic stroll
                      </li>
                      <li>
                        Stop by the postcard-perfect Kappil Beach for some serene vibes.
                      </li>
                      <li>Turn up the adventure with kayaking through the lush Varkala mangroves.</li>
                      <li>Relax back at your resort or head out to enjoy Varkala’s exciting nightlife with its cafes,
                        night clubs and more</li>
                    </ul>
                  </div>
                </div>
              </div>
              ...
              <div class="accordion-item ai1">
                <h2 class="accordion-header" id="headingTwo">
                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                    ...
                    <div class="days"> Day 3 </div>: Farewell, Trivandrum sightseeing & Departure
                  </button>
                </h2>
                <div id="collapse3" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                  ...
                  <div class="accordion-body">
                    <ul class="acc-inner">
                      ...
                      <li>Departure. Leave the city with unforgettable memories.
                      </li>
                    </ul>
                  </div>
                </div>
