...
======================================== -->
  ...
  <section class="form-home">
    ...
    <ul class="banner-nav">
      ...
      <li class="locate"><a href="kerala">Kerala: To God's Own Place</a></li>
      <li>Booking</li>
    </ul>
  </section>
  ...
  <section class=" form-content-holder">
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-8">
          <form enctype="multipart/form-data" class="form" id="booking-form" action="kerala-contact.php" method="POST">
            ...
            <div class="column">
              ...
              <!-- <div class="check-box">
    <label>
            <input type="radio" name="traval-date" id="traval-date" value=" OCT 21"> OCT 21
        </label>
            </div> -->
              ...
              <div class="check-box">
                <label>
                  <input type="radio" name="traval-date" id="traval-date" value="DEC 28">DEC 28
                </label>
              </div>

              <div class="check-box">
                <label>
                  <input type="radio" name="traval-date" id="traval-date" value="JAN 14">JAN 14
                </label>
              </div>
            </div>
            <div class="column">
            ...
            <div class="gender-box">
              ...
              <div class="gender-option">
                ...
                <div class="sharing">
                  <input type="radio" checked id="covai1" value="Direct Kochi" name="pickdrop" />
                  <label for="covai1">Direct Kochi</label>
                </div>
              </div>
            </div>
            <div class="column">
