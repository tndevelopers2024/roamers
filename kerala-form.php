...
<head>
    ...
    <meta property="og:description"
        content="Discover the beauty of Kerala with our detailed travel guide and tips." />
...
<body>
    ...
    <section class="">
        <div class="container">
            <form action="kerala-mail-send.php" method="POST" autocomplete="off">
            ...
            fetch("./dynamic/varkala-data.json") // Check this path
                ...
                .then(data => {
                    ...
                    if (startingPriceElem) {
                        startingPriceElem.textContent = `Starting Price: ₹14,490 /- `;
                    } else {
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            fetch("./dynamic/varkala-data.json") // to change the price ... 
                ...
                .then(data => {
                    const locationKey = "kerala"; // Change to "ooty" if needed
                    const locationData = data[locationKey];
            ...
            if (nextBtn2) {
                nextBtn2.addEventListener("click", (e) => {
                    ...
                    if (sharing === "Triple Sharing") {
                        perPersonAmount = 14490;
                    } else if (sharing === "Double Sharing") {
                        perPersonAmount = 15490 ;
                    }
