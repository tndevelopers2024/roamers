...
<head>
    ...
    <meta property="og:image:secure_url"
        content="https://images.unsplash.com/photo-1578662996442-48f60103fc96?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80"
        width="600" height="600" alt="Netravati River Adventure" />
    <title>Roamers - Netravati River Adventure</title>

    <!-- SEO Meta Description -->
    <meta name="description"
        content="Netravati River Adventure - Experience the thrill of river rafting and camping in the Western Ghats" />
    <meta name="author" content="Themeland" />
    <meta property="og:image:width" content="700" />
    <meta property="og:image:height" content="500" />

    <!-- Basic Open Graph tags -->
    <meta property="og:title" content="Roamers - Netravati River Adventure" />
    <meta property="og:description"
        content="Experience the thrill of river rafting and camping along the beautiful Netravati River in the Western Ghats." />
    ...
    <meta name="twitter:title" content="Roamers - Netravati River Adventure" />
...
<body>
        ...
        <div class="container-lg" style="position: relative; text-align: center;">
            ...
            <ul class="banner-hight-bottom p-0"
                ...
                <li class="mobile-small-text me-2" style="display: flex; align-items: center; font-weight: 800;">
                    NETRAVATI <span class="ms-2"> <span><img src="assets\img\Sirlanka\arrow-icon-by-roamers.png" alt=""
                                style="width:13px; margin-bottom: 3px;"></span>
                </li>
            </ul>
                        ...
                        <div class="col">
                            <div class="enhanced-box">
                                ...
                                <div>
                                    ...
                                    <div class="info-value">2D / 2N</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col">
                            <div class="enhanced-box">
                                ...
                                <div>
                                    ...
                                    <div class="info-value"> Chennai/ Bangalore </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row g-4 flex-column-reverse flex-md-row align-items-center">
                    ...
                    <div class="col-md-7">
                        <div class="travel-des p-3 p-md-4">
                            <h2 class="mb-3 pt-3">Netravati River Adventure: Where Rapids Meet Serenity</h2>

                            <!-- Desktop description (full text) -->
                            <p style="color: #555;" class="desk-desc d-none d-md-block">
                                This isn't your basic river trip - we're diving deep into the heart of the Western
                                Ghats! From navigating
                                the thrilling rapids of the Netravati River to camping under starlit skies, watching
                                sunsets from pristine
                                riverbanks, this adventure is a perfect blend of adrenaline and tranquility through
                                nature's best!

                                <br> <br>We're talking about pristine river waters, the misty Western Ghats, entering
                                the realm of
                                untouched wilderness, serene river camping, thrilling white water rafting & peaceful
                                moments by the
                                flowing waters, ending with memories that last a lifetime. </br><br>

                                Packed with adventure, nature, and incredible squad vibes, Don't think much, this unique
                                river experience
                                crafted by the best for our Roamers awaits you, see you there!
                            </p>
                            ...
                            <p style="color: #555;" class="mob-desc d-block d-md-none">
                                ...
                                <span id="moreText" style="display: none;"><br><br>
                                    this adventure is a perfect blend of adrenaline and tranquility through nature's
                                    best! We're talking
                                    about pristine river waters, the misty Western Ghats, entering the realm of
                                    untouched wilderness,
                                    serene river camping, thrilling white water rafting & peaceful moments by the
                                    flowing waters, ending
                                    with memories that last a lifetime.

                                    <br><br>Packed with adventure, nature, and incredible squad vibes, Don't think much,
                                    this unique river
                                    experience crafted by the best for our Roamers awaits you, see you there!
                        ...
                        <div class="swiper miniSlider px-px-md-0 py-3">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <img src="https://www.bangaloreorbit.com/assets/images/FM6Ib7aaAAAJZ4w.jpg"
                                        class="img-fluid w-100" alt="Netravati River Adventure"
                                        style="border-radius: 10px; height: 350px; object-fit: cover;">
                                </div>
                                <div class="swiper-slide">
                                    <img src="https://www.bangaloreorbit.com/assets/images/FM6Ib7aaAAAJZ4w.jpg"
                                        class="img-fluid w-100" alt="River Camping"
                                        style="border-radius: 10px; height: 350px; object-fit: cover;">
                                </div>
                                <div class="swiper-slide">
                                    <img src="https://www.bangaloreorbit.com/assets/images/FM6Ib7aaAAAJZ4w.jpg"
                                        class="img-fluid w-100" alt="Western Ghats"
                                        style="border-radius: 10px; height: 350px; object-fit: cover;">
                                </div>
                                <div class="swiper-slide">
                                    <img src="https://www.bangaloreorbit.com/assets/images/FM6Ib7aaAAAJZ4w.jpg"
                                        class="img-fluid w-100" alt="Mountain River"
                                        style="border-radius: 10px; height: 350px; object-fit: cover;">
                                </div>
                            </div>
                        </div>
                                    ...
                                    <h2 class="accordion-header" id="headingOne">
                                        <button
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <span> Overnight Journey (For travellers from Chennai )</span>
                                            </div>
                                        ...
                                        <div class="accordion-body" style="background-color: #f5fdff;">
                                            ...
                                            <ul class="ps-lg-3 ps-0">
                                                <li class=""><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>Hello Roamers!! Meet your fellow
                                                    trekkers and Trip Lead and get ready for peaceful overnight Journey

                                                </li>
                                                <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>Chennai - Bangalore journey in
                                                    AC semi sleeper Bus
                                                ...
                                                <li><i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>Pickup points from Koyambedu
                                                    will be provided by team
                                                </li>
                                ...
                                <div class="accordion-item mb-4 border  overflow-hidden"
                                        ...
                                        <button
                                            ...
                                            <div class="d-flex align-items-center w-100">
                                                <span
                                                    ...
                                                    1</span>
                                                <span>Belur Temple, Reach Base Camp & Settle </span>
                                    ...
                                    <div id="collapseTwo" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body" style="background-color: #f5fdff;">
                                            ...
                                            <ul class="ps-lg-3 ps-0">
                                                <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>Reach Bangalore by morning,
                                                    Quick freshen up, welcome Roamers joining from Bangalore!

                                                </li>
                                                <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>
                                                    Let's hit the road in a private traveller, expect good music, games,
                                                    bonding, misty highways, and a hearty local breakfast on the way

                                                </li>
                                                <li><i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>Arrive at our cozy basecamp in
                                                    Kudremukh late afternoon, check-in and enjoy a Local Lunch


                                                </li>
                                                <li><i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>Unwind or explore nearby, take a
                                                    relaxed walk through a dreamy coffee estate or drive to a nearby
                                                    sunset viewpoint.
                                                ...
                                                <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>Let the fun begin! Campfire,
                                                    local snacks, story-swapping, stargazing, and music. Get to know
                                                ...
                                                <li><i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>A warm dinner and rest early for
                                ...
                                <div class="accordion-item mb-4 border  overflow-hidden" style="border-radius: 10px;">
                                        ...
                                        <button
                                            ...
                                            <div class="d-flex align-items-center w-100">
                                                <span
                                                    class="badge bg-primary rounded-pill me-3 px-3 py-2 animated-badge">Day
                                                    2</span>
                                                <span>The Big Day- Netravati Trek Summit! & Return</span>
                                                <i class="bi bi-chevron-down ms-auto transition-arrow"
                                                    style="color:#0c63e4;"></i>
                                            </div>
                                        </button>
                                    ...
                                    <div id="collapse3" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body bg-white px-4 py-3">
                                            <ul class="ps-lg-3 ps-0">
                                                <li><i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>Rise and shine early morning by
                                                    4:00 am, a quick brief session from Trip lead to kickstart the trek.

                                                </li>
                                                <li><i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>Let's begin our Trek begins into
                                                    the forest trails, through open meadows, and up misty ridges to the
                                                    stunning summit of Netravati Peak

                                                </li>
                                                <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>Spend your quality time with the
                                                    team, the views will leave you speechless for sure!



                                                </li>
                                                <li><i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>After that we'll descend with
                                                    fulfilment and return to our base point.



                                                </li>
                                                <li><i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>Late Lunch let's pack up and
                                                    head back towards Bangalore with a heart full of memories


                                                </li>
                                                <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>By 9:00 PM its a Drop for
                                                    trekkers joined from Bangalore


                                                </li>
                                                <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>Post Dinner, Overnight journey
                                ...
                                <div class="accordion-item mb-4 border overflow-hidden" style="border-radius: 10px;">
                                        ...
                                        <button
                                            ...
                                            <div class="d-flex align-items-center w-100">
                                                <span
                                                    class="badge bg-primary rounded-pill me-3 px-3 py-2 animated-badge">Day
                                                    3</span>
                                                <span>Early morning Arrival – For Chennai Travellers</span>
                                                <i class="bi bi-chevron-down ms-auto transition-arrow"
                                                    style="color:#0c63e4;"></i>
                                            </div>
                                        </button>
                                    ...
                                    <div id="collapse4" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body bg-white px-4 py-3">
                                            <ul class="ps-lg-3 ps-0">
                                                <li><i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>Around 7: 00 AM: Arrive in
                                                    Chennai, a little tired but a weekend you could never forget!</li>
                                                <li><i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>Bye Roamers, Until Next Time!
                                                </li>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="price-sticky" style="position: sticky;">
                            ...
                            <div class="priceCard shadow" style="border-radius: 10px;">
                                <img src="https://www.bangaloreorbit.com/assets/images/FM6Ib7aaAAAJZ4w.jpg"
                                    alt="Netravati River Adventure" style=" object-fit:cover; border-radius: 10px;">
                            </div>
                            ...
                            <div id="form" class="shadow"
                                ...
                                <form>
                                    <h3
                                        style="text-align: center; margin-bottom: 30px; font-family: 'Arial', sans-serif; color: #333;">
    ...
    <section class="scroll-section">
        ...
        <div class="swiper-container two">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <div class="slider-image">
                        <img src="https://www.bangaloreorbit.com/assets/images/FM6Ib7aaAAAJZ4w.jpg" alt="River Camping">
                    </div>
                </div>
                <div class="swiper-slide">
                    <div class="slider-image">
                        <img src="https://www.bangaloreorbit.com/assets/images/FM6Ib7aaAAAJZ4w.jpg" alt="Western Ghats">
                    </div>
                </div>
                <div class="swiper-slide">
                    <div class="slider-image">
                ...
                <div class="swiper-slide">
                    <div class="slider-image">
                        <img src="https://www.bangaloreorbit.com/assets/images/FM6Ib7aaAAAJZ4w.jpg" alt="River Rapids">
                    </div>
                </div>
                <div class="swiper-slide">
                    <div class="slider-image">
                        <img src="https://www.bangaloreorbit.com/assets/images/FM6Ib7aaAAAJZ4w.jpg"
                            alt="Adventure Rafting">
                    </div>
                </div>
                <div class="swiper-slide">
                    <div class="slider-image">
                ...
                <div class="swiper-slide">
                    <div class="slider-image">
                        <img src="https://www.bangaloreorbit.com/assets/images/FM6Ib7aaAAAJZ4w.jpg" alt="River Valley">
                    </div>
                </div>
                <div class="swiper-slide">
                    <div class="slider-image">
                ...
                <div class="swiper-slide">
                    <div class="slider-image">
                        <img src="https://www.bangaloreorbit.com/assets/images/FM6Ib7aaAAAJZ4w.jpg" alt="River Scenery">
                    </div>
                </div>
                <div class="swiper-slide">
                    <div class="slider-image">
                ...
                <div class="swiper-slide">
                    <div class="slider-image">
                        <img src="https://www.bangaloreorbit.com/assets/images/FM6Ib7aaAAAJZ4w.jpg" alt="River Thrills">
                    </div>
                </div>
                <div class="swiper-slide">
                    <div class="slider-image">
    ...
    <div class="mobile-bottom-bar">
        <div class="bottom-bar-content">
            ...
            <a href="netravati-form.php" class="btn-book">Dates & Costing</a>
        </div>
    </div>
  ...
  <i class="fa-solid fa-circle-chevron-down shadow" 
    ...
    <script>
        ...
        const images = [
            "https://www.bangaloreorbit.com/assets/images/FM6Ib7aaAAAJZ4w.jpg",
        ];
