...
<body>
  ...
  <h1 class=" text-center booking-form-head">Leh Ladakh with Umling la</h1>
                        ...
                        <div class="col">
                          <div class="input-field">
                            <input type="number" class="phone" id="phone" name="phone" placeholder="Phone Number"
                              required oninput="this.value = this.value.slice(0, 12).replace(/[^0-9]/g, '');">
                          </div>
                        </div>
  ...
  <script>
    document.addEventListener("DOMContentLoaded", () => {
      ...
      <div><i class="fa-solid fa-plane-departure"></i> <p><b>Trip :</b>Leh Ladakh with Umling la</p></div>
      ...
      <div><i class="fa-solid fa-truck-pickup"></i> <p><b>Mode of Travel :</b> ${formData.vehicle}</p></div>
