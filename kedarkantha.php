...
<head>
  ...
  <meta name="description" content="Kedarkantha" />
...
<body>
  ...
  <section class="trip-home" style="background-image: url('assets/img/kedarkantha/Swargrohini_Oodari.jpg');">
      ...
      <div class="row desktop-inform">
        <div class="col-md-4 col-4">
          <div class="trip-inner">
            ...
            <h2> <span class="kedar-price"></span> /-</h2>
          </div>
        </div>
        <div class="col-md-4 col-4">
          <div class="trip-inner">
      ...
      <div class="slider-container">
        <div class="slider-item2 ">
          <div class="silder-pad">
            <div class="slid-img">
              <img class="cus-img" src="assets/img/kedarkantha/sankri-village.jpg " alt="roamers-Gallery" />
            </div>
            <div class="cust-inner">
              <h3> </h3>
              <h2>Sankri Village</h2>
            </div>
          </div>
        </div>
        <div class="slider-item2">
          <div class="silder-pad">
            <div class="slid-img">
              <img class="cus-img" src="assets/img/kedarkantha/lake.jpg " alt="roamers-Gallery" />
            </div>
            <div class="cust-inner">
              <h3> </h3>
              <h2> Juda ka Taal</h2>
        ...
        <div class="slider-item2">
          <div class="silder-pad">
            <div class="slid-img">
              <img class="cus-img" src="assets/img/kedarkantha/camp.jpg" alt="roamers-Gallery" />
            </div>
            <div class="cust-inner">
              <h3> </h3>
              <h2>Juda Ka Taal Campsite</h2>
            </div>
          </div>
        </div>
        <div class="slider-item2">
          <div class="silder-pad">
            <div class="slid-img">
              <img class="cus-img" src="assets/img/kedarkantha/peak-k.jpg" alt="roamers-Gallery" />
            </div>
            <div class="cust-inner">
              <h3> </h3>
              <h2> Kedarkantha Peak</h2>
            </div>
          </div>
        </div>
        <div class="slider-item2">
          <div class="silder-pad">
            <div class="slid-img">
              <img class="cus-img" src="assets/img/kedarkantha/Swargrohini_Oodari.jpg" alt="roamers-Gallery" />
            </div>
            <div class="cust-inner">
              <h3> </h3>
              <h2>Swargrohini Massif</h2>
            </div>
          </div>
        </div>
        <div class="slider-item2">
          <div class="silder-pad">
            <div class="slid-img">
              <img class="cus-img" src="assets/img/kedarkantha/kedar-camp.jpeg " alt="roamers-Gallery" />
            </div>
            <div class="cust-inner">
              <h3> </h3>
              <h2> Kedarkantha Base Camp</h2>
            </div>
          </div>
        </div>
      </div>
            ...
            <a href="wayanad">
              ...
              <div class="silder-inner silder-inner1">
                ...
                <div class="inner">
                  ...
                  <h4><span class="wayanad-price">₹7,999</span> </h4>
                </div>
              </div>
            </a>
          </div>
