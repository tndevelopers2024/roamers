...
<head>
  ...
  <meta property="og:image:secure_url" content="assets/img/pondicherry/Media/Pondy-cover2.jpg" width="600" height="600"
    alt="image for ooty" />
...
<body>
          ...
          <div class="col-md-7">
            <div class="travel-des p-3 p-md-4">
              ...
              <p style="color: #555;" class="desk-desc d-none d-md-block">
                ...
                <br> <br> Get set to explore the treasures of Pondicherry! Paradise beach a secluded oasis, Sandunes
                beach for
                ...
                blends cultures, tranquility, and a dash of adventure! Pondicherry beckons – are you ready?
              </p>
              ...
              <p style="color: #555;" class="mob-desc d-block d-md-none">
                ...
                <span id="moreText" style="display: none;"><br><br>
                  Get set to explore the treasures of Pondicherry! Paradise beach a secluded oasis, Sandunes
                  beach for
                  adventure and iimmerse yourself in the spiritual aura of Auroville, unique Churches & more.
                  Pondicherry
                  exudes a laid-back atmosphere. So, grab a croissant and let's embark on a journey that beautifully
                  blends cultures, tranquility, and a dash of adventure! Pondicherry beckons – are you ready?
            ...
            <div class="swiper miniSlider px-px-md-0 py-3">
              <div class="swiper-wrapper">
                <div class="swiper-slide">
                  <img src="assets/img/pondicherry/Media/Lead-Auroville.jpg" , class="img-fluid w-100" alt="Ladakh 3"
                    style="border-radius: 10px; height: 350px; object-fit: cover;">
                </div>
                <div class="swiper-slide">
                  <img src="assets/img/pondicherry/Media/Pondi-cover-min.jpg" , class="img-fluid w-100" alt="Ladakh 3"
                    style="border-radius: 10px; height: 350px; object-fit: cover;">
                </div>
              </div>
            </div>
                    ...
                    <div class="accordion-body" style="background-color: #f5fdff;">
                      ...
                      <ul class="ps-lg-3 ps-0">
                        <li class=""><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                            style="font-size: 0.65rem;"></i> Hello Roamers! Let's assemble by 8 AM at the designated
                        ...
                        <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>
                          Let’s explore <span class="fw-bold">'White Town'</span>—quaint streets, Rock beach, French
                          churches, cool
                          boutiques,
                        ...
                        <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>
                          Enjoy the <span class="fw-bold">water activities</span> like Banana ride, Jet Ski, Donut ride,
                          Paramotoring or just relax
                          beside the Beach
                        </li>
                        <li> <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                            style="font-size: 0.65rem;"></i>Settle in for a comfy overnight stay in Pondicherry
                        </li>
                      </ul>
                    </div>
                  </div>
                ...
                <div class="accordion-item mb-4 border  overflow-hidden" style="border-radius: 10px !important;">
                  ...
                  <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                    ...
                    <div class="accordion-body" style="background-color: #f5fdff;">
                      ...
                      <ul class="ps-lg-3 ps-0">
                        <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>
                          Sunrise at <span class="fw-bold">Serenity Beach </span> Sawaits!</li>
                        <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>
                          Early morning <span class="fw-bold">hike</span> to the iconic <span class="fw-bold"> Let's
                        ...
                        <li><i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i> Up
                          next, we'll go on a short trail to witness the Golden Matrimandir Auroville, an architectural
                        ...
                        <li><i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>Our
                          journey next brings us to the famous Let’s indulge in a <span class="fw-bold"> Farewell lunch
                          </span>
                          with Roamers at a popular local cafe

                        </li>
                        <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>Go
                          to a <span class="fw-bold"> Sound Garden </span>, play with unique musical instruments and
                        ...
                        <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>
                          We’ll drive back to Chennai, carrying with us great memories and newfound friendships from
            ...
            <section id="inclusion">
              <div class="important-notes shadow " style="border-radius: 10px; background-color:rgb(245, 255, 246) ;">
                ...
                <div id="">
                  ...
                  <p> <i class="fa-solid fa-circle-check me-2 pulse" style="color: green;"></i>3 Meals: 1 Breakfast, 1
                    Farewell Lunch, 1 Dinner
                  </p>

                  <p> <i class="fa-solid fa-circle-check me-2 pulse" style="color: green;"></i>Entries for Sightseeing
                  </p>
                  ...
                  <p> <i class="fa-solid fa-circle-check me-2 pulse" style="color: green;"></i>Entry fees for the
            ...
            <div class="important-notes shadow" style="border-radius: 10px; background-color: rgb(255, 244, 244);"
              ...
              <div>
                <p> <i class="fa-solid fa-circle-xmark me-2 pulse" style="color: red;"></i> Personal expenses like
                  shopping and for optional activities such as Paragliding, Jet skiing, Kayaking etc. </p><span
                  class="mobile-br"><br></span>

                <p><i class="fa-solid fa-circle-xmark me-2 pulse" style="color: red;"></i> Any other costing involved
                  due to natural calamity or any other forced circumstances which are out of our control. </a>)
                </p>

                <p><i class="fa-solid fa-circle-xmark me-2 pulse" style="color: red;"></i> GST(5%) is applicable extra.
                </p>
                ...
                <div class="p-2">
                  ...
                  <div class="inner-box" style="background-color: #f0f0f0; padding: 15px; border-radius: 10px;">
                    ...
                    <div class="trip-form p-0">
                      <a href="pondicherry-form.php" class="btn butn butn__new bg-" style="border-radius: 10px;">Dates
                        & Costing</a>
                    </div>
                  </div>
                </div>
  ...
  <div class="mobile-bottom-bar">
    <div class="bottom-bar-content">
      ...
      <a href="pondicherry-form.php" class="btn-book">Dates & Costing</a>
    </div>
  </div>
