...
======================================== -->
  ...
  <section class="form-home">
    ...
    <ul class="banner-nav">
      ...
      <li class="locate"><a href="meghalaya">Mejestic Meghalaya</a></li>
      <li>Booking</li>
    </ul>
  </section>
  ...
  <section class=" form-content-holder">
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-8">
          <form class="form" id="booking-form" action="meghalaya-contact.php" method="POST">
            ...
            <div class="column">
              ...
              <!-- <div class="check-box">
                ...
                <label>
                  <input type="radio" name="traval-date" id="traval-date" value="NOV 10">NOV 10
                </label>
              </div> -->
              <div class="check-box">
                <label>
                  <input type="radio" name="traval-date" id="traval-date" value=" NOV 24"> NOV 24
                </label>
              </div>
              <div class="check-box">
                <label>
                  <input type="radio" name="traval-date" id="traval-date" value="DEC 08">DEC 08
                </label>
              </div>
              <div class="check-box">
                <label>
