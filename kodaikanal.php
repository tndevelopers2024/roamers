...
<head>
  ...
  <meta property="og:image:secure_url" content="https://roamers.in/assets/img/kodaikanal/Pine%20forest.jpg" width="600"
    height="600" alt="image for ooty" />
  <title>Roamers - Kodaikanal Trek with Poombarai Trip</title>

  <!-- SEO Meta Description -->
  <meta name="description" content="Roamers -  Kodaikanal Trek with Poombarai Trip" />
  <meta name="author" content="Themeland" />
  <meta property="og:image:width" content="700" />
  <meta property="og:image:height" content="500" />

  <!-- Basic Open Graph tags -->
  <meta property="og:title" content="Roamers -  Kodaikanal Trek with Poombarai Trip" />
  <meta property="og:description"
    content="Join our  Kodaikanal Trek with Poombarai Trip for an unforgettable adventure, curated experiences, and new friendships." />
  <meta property="og:image" content="https://roamers.in/assets/img/kodaikanal/Pine%20forest.jpg" />
  <meta property="og:url" content="https://roamers.in/assets/img/kodaikanal/Pine%20forest.jpg" />
  <meta property="og:type" content="website" />
  <meta name="twitter:card" content="summary_large_image" />
  <meta name="twitter:title" content="Roamers -  Kodaikanal Trek with Poombarai Trip" />
  <meta name="twitter:description"
    content="Join our Kodaikanal Trek with Poombarai Trip for an unforgettable adventure, curated experiences, and new friendships." />
  <meta name="twitter:image" content="https://roamers.in/assets/img/kodaikanal/Pine%20forest.jpg" />
...
<body>
    ...
    <section class="trip-home" class="banner-marigin-section" id="tripSection"
      ...
      <div class="container-lg" style="position: relative; text-align: center;">
        ...
        <h2 class="banner-hight-top ms-2"
          ...
          KODAIKANAL TREK WITH POOMBARAI
                    ...
                    <h2 class="accordion-header" id="headingTwo">
                      <button
                        ...
                        <div class="d-flex align-items-center w-100">
                          ...
                          <span>TREK PERUMAL PEAK, WATERFALLS & CAMPING
                          </span>
                    ...
                    <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                      ...
                      <div class="accordion-body" style="background-color: #f5fdff;">
                        ...
                        <ul class="ps-lg-3 ps-0">
                          ...
                          <li>
                            <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>
                            Let's relish breakfast and get fueled for the trek!
                          </li>
                          <li>
                            <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>
                            Begin our trek to The Perumal Peak (2440 metres). Trek up and down 8 km.
                          </li>
                          <li>
                            <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>
                    ...
                    <h2 class="accordion-header" id="headingThree">
                      <button
                        ...
                        <div class="d-flex align-items-center w-100">
                          ...
                          <span>DOLPHIN NOSE & ECHO ROCK TREK, WATERFALLS</span>
                          <i class="bi bi-chevron-down ms-auto transition-arrow" style="color:#0c63e4;"></i>
                        </div>
                      </button>
                    </h2>
                    <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree"
                      ...
                      <div class="accordion-body bg-white px-4 py-3">
                        <ul class="ps-lg-3 ps-0">
                          <li>
                            <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>
                            Rise and shine, team! After breakfast, let's check out the camps and continue our journey.
                          </li>
                          <li>
                            <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>
                    ...
                    <h2 class="accordion-header" id="headingFour">
                      <button
                        ...
                        <div class="d-flex align-items-center w-100">
                          ...
                          <span>POOMBARAI SIGHTSEEING AND MORE | FAREWELL</span>
                          <i class="bi bi-chevron-down ms-auto transition-arrow" style="color:#0c63e4;"></i>
                        </div>
                      </button>
                    </h2>
                ...
                <div class="important-notes shadow" style="border-radius: 10px; background-color:rgb(245, 255, 246);">
                  ...
                  <div>
                    <p>
                      ...
                      Covers all Transportations as mentioned in itinerary.
                    </p>
                    <p>
                      <i class="fa-solid fa-circle-check me-2 pulse" style="color: #1fa463;"></i>
                      Accommodations in tents or tree house on multiple sharing basis.
                    </p>
                    <p>
                      <i class="fa-solid fa-circle-check me-2 pulse" style="color: #1fa463;"></i>
            ...
            <div class="col-md-4">
              ...
              <div class="price-sticky" style="position: sticky;">
                ...
                <div class="priceCard shadow" style="border-radius: 10px;">
                  <img src="assets/img/kodaikanal/Pine%20forest.jpg" alt=" Kodaikanal Trek with Poombarai Trip"
        ...
        <div class="swiper-wrapper">
          <div class="swiper-slide">
            <div class="slider-image">
              <img src="assets/img/kodaikanal/poombarai.jpg" alt="Sri Lanka 1">
            </div>
          </div>
          <div class="swiper-slide">
            <div class="slider-image">
              <img src="assets/img/kodaikanal/Dolphin%20nose.jpg" alt="Sri Lanka 3">
            </div>
          </div>
          <div class="swiper-slide">
            <div class="slider-image">
              <img src="assets/img/kodaikanal/camp%20site.jpg" alt="Sri Lanka 3">
            </div>
          </div>
          <div class="swiper-slide">
            <div class="slider-image">
              <img src="assets/img/kodaikanal/Perumal%20Peak.jpg" alt="Sri Lanka 3">
            </div>
          </div>
          <div class="swiper-slide">
            <div class="slider-image">
              <img src="assets/img/kodaikanal/Vattakanal%20Falls.jpg" alt="Sri Lanka 3">
            </div>
          </div>
          <div class="swiper-slide">
            <div class="slider-image">
              <img src="assets/img/kodaikanal/Echo%20rock.jpg" alt="Sri Lanka 3">
            </div>
          </div>
          <div class="swiper-slide">
            <div class="slider-image">
              <img src="assets/img/kodaikanal/Pine%20forest.jpg" alt="Sri Lanka 4">
            </div>
          </div>
        </div>
  ...
  <script>
    ...
    const images = [
      "assets/img/kodaikanal/kodaikanal-Cover.jpg",
    ];
