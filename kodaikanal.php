...
<head>
  ...
  <meta property="og:image:secure_url" content="https://roamers.in/assets/img/kodaikanal/perumal-peak.jpg" width="600" height="600"
    alt="image for ooty" />
  <title>Roamers</title>
  ...
  <meta property="og:image" content="https://roamers.in/assets/img/kodaikanal/perumal-peak.jpg" />
  <meta property="og:image:secure_url" content="https://roamers.in/assets/img/kodaikanal/perumal-peak.jpg" />
      ...
      <div class="row desktop-inform">
        <div class="col-md-4 col-4">
          <div class="trip-inner">
            ...
            <h2><span class="kodai-price"></span> /-</h2>
          </div>
        </div>
        <div class="col-md-4 col-4">
          <div class="trip-inner">
          ...
          <div class="sticky-sidebar">
            ...
            <div class="trip-tab">
              <ul class="nav nav-pills trip-nav mb-3" id="pills-tab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                  <button class="nav-link" id="pills-nov-tab" data-bs-toggle="pill" data-bs-target="#pills-nov"
                    type="button" role="tab" aria-controls="pills-nov" aria-selected="false">Nov</button>
                </li>
              </ul>
              <div class="tab-content tab-con" id="pills-tabContent">

                <div class="tab-pane fade show active" id="pills-oct" role="tabpanel" aria-labelledby="pills-oct-tab">
            ...
            <a href="ooty">
              ...
              <div class="silder-inner silder-inner1">
                ...
                <div class="inner">
                  ...
                  <h4><span class="ooty-price">₹6,990</span> </h4>
                </div>
              </div>
            </a>
          </div>
            ...
            <a href="wayanad">
              ...
              <div class="silder-inner silder-inner1">
                ...
                <div class="inner">
                  ...
                  <h4><span class="wayanad-price">₹8,990</span> </h4>
                </div>
              </div>
            </a>
          </div>
