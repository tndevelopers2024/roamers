...
<head>
    ...
    <meta property="og:url" content="https://roamers.in/meghalaya-enquiry-form.php">
    <meta property="og:title" content="Roamers - Meghalaya: Backpacking Adventure into the Abode of Clouds">
...
<body>
    ...
    <section>
        ...
        <!-- Desktop View -->
        <div>
            <img src="https://images.unsplash.com/photo-1628734960090-2b4b0ec7448f?q=80&w=2670&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Spiti Chandratal Banner"
                class="banner-img d-none d-md-block"
                style="width: 100%; height: 60vh; object-fit: cover; object-position: top; z-index: 0; opacity: 1; margin-top: 68px;">
        </div>

        <!-- Mobile View -->
        <div>
            <img src="https://images.unsplash.com/photo-1628734960090-2b4b0ec7448f?q=80&w=2670&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Spiti Chandratal Banner Mobile"
        ...
        <div class="enquiry-container reveal">
            <div class="form-section">
                <div class="section-header reveal">
                    <h1> Majestic Meghalaya </h1>
                    <p class="text-center"> Plan Your Trip</p>
                </div>

                <form action="megalaya-enquiry-mail.send.php" method="POST">
