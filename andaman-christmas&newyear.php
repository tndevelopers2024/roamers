...
<body>
          ...
          <div class="col-md-7">
            <div class="travel-des p-3 p-md-4">
              ...
              <p style="color: #555;" class="desk-desc d-none d-md-block">
                ...
                that laid-back island life. Grab your swim suits and let's dive into paradise, one beach at a time! haha
                ...
                <div class="p-2">
                  ...
                  <div class="inner-box" style="background-color: #f0f0f0; padding: 15px; border-radius: 10px;">
                    ...
                    <div class="trip-form p-0">
                      <a href="andaman-form-christmas&newyear.php" class="btn butn butn__new bg-" style="border-radius: 10px;">Dates
                        & Costing</a>
                    </div>
                  </div>
                </div>
  ...
  <div class="mobile-bottom-bar">
    <div class="bottom-bar-content">
      ...
      <a href="andaman-form-christmas&newyear.php" class="btn-book">Dates & Costing</a>
    </div>
  </div>
