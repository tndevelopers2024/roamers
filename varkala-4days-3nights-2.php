...
<body>
  ...
  <section class="trip-home">
    <div class="container" style="  position: relative;">
      <h1>MAGICAL VARKALA WITH MUNROE ISLAND</h1>
    </div>
  </section>
                ...
                <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                  ...
                  <div class="accordion-body">
                    <ul class="acc-inner">
                      ...
                      <li>
                        Unwind at Papanasam Beach, Edawa Beach and the serene Black Beach (Thiruvambadi Beach) .
                      </li>
                      <li>Overnight stay in Varkala.</li>
                    </ul>
                  </div>
              ...
              <div class="accordion-item ai1">
                <h2 class="accordion-header" id="headingTwo">
                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                    ...
                    <div class="days"> Day 3 </div>: Munroe island, Canoe ride, Beaches & more
                  </button>
                </h2>
                <div id="collapse3" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                  ...
                  <div class="accordion-body">
                    <ul class="acc-inner">
                      ...
                      <li>
                        Enroute stop by the postcard-perfect Kappil Beach for some serene vibes.
                      </li>
                      <li>
                      ...
                      <li>Return to Varkala Overnight stay in Varkala.</li>
                    </ul>
                  </div>
                </div>
              </div>
              ...
              <div class="accordion-item ai1">
                <h2 class="accordion-header" id="headingTwo">
                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                    ...
                    <div class="days">Day 4</div>: Farewell, visit Trivandrum | Departure
                  </button>
                </h2>
