    ...
    <section class="trip-home" class="banner-marigin-section" id="tripSection"
        ...
        <div class="container-lg" style="position: relative; text-align: center;">
            ...
            <h2 class="banner-hight-top ms-2"
                ...
                MAGICAL VARKALA WITH MUNROE ISLAND
            </h2>
                                            ...
                                            <ul class="ps-lg-3 ps-0">
                                             ...
                                             Meet our representative for a smooth pickup and check-in at the resort.
                                                ...
                                                <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>Freshen up and relax, then head to the iconic Varkala Cliff. Enjoy vibrant cliffside cafes, unique shops and stunning views.

                                                </li>
                                                <li><i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>Witness a magical sunset at Varkala Beach, the perfect start to your adventure.
                                    ...
                                    <div id="collapse3" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body bg-white px-4 py-3">
                                            <ul class="ps-lg-3 ps-0">
                                                ...
                                                <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>Take your time to admire and
                                                    explore the nature beauty and local culture
                                                </li>
                                                <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>
                                                    Return to Varkala Overnight stay in Varkala.
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
