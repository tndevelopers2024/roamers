...
<main>
  ...
  <div class=container>
    ...
    <ul class="nav-pills upper-nav mt-5 ">
      ...
      <li><a class="trip-4 active rounded-pill me-3 shadow" href="#section4">Events</a></li>
    </ul>
    ...
    <!-- Events -->
    <div id="section4" class="section active mb-5">
      <div class="container">
        <div class="row">
                      ...
                      <div style="position: absolute; top: 0; left: 0; width: 100%; z-index: 2; margin-top: 229px; ">
                        ...
                        <h1 class="event-title event-title-responsive-on-event"
                          ...
                          DINE WITH Strangers <p
                            style="font-size: 10px; font-weight: bold; margin-bottom: 0px; color: #FFFFFF;">Share a
                            meal,
