...
======================================== -->
  ...
  <section class="form-home">
    ...
    <ul class="banner-nav">
      ...
      <li class="locate"><a href="pondicherry">Pondi Dive-in</a></li>
      <li>Booking</li>
    </ul>
  </section>
  ...
  <section class=" form-content-holder">
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-8">
          <form enctype="multipart/form-data" class="form" id="booking-form" action="pondicherry-contact.php"
            method="POST">
            ...
            <div class="column">
              ...
              <!-- <div class="check-box">
                ...
                <label>
                  <input type="radio" checked name="traval-date" id="traval-date" value="Dec 21">Dec 21
                </label>
              </div>
              ...
              <div class="check-box">
                ...
                <label>
                  <input type="radio" disabled name="traval-date" id="traval-date" value="Dec 29">Dec 29
                </label>
              </div> -->
              ...
              <!-- <div class="check-box">
                ...
                <label>
                  <input checked type="radio" name="traval-date" id="traval-date" value="Jan 10">Jan 10
                </label>
              </div>
              ...
              <div class="check-box">
                ...
                <label>
                  <input type="radio" name="traval-date" id="traval-date" value="Jan 24">Jan 24
                </label>
              </div>
              ...
              <div class="check-box">
                ...
                <label>
                  <input type="radio" name="traval-date" id="traval-date" value="Jan 31">Jan 31
                </label>
              </div> -->
              ...
              <!-- <div class="check-box">
                ...
                <label>
                  <input type="radio" name="traval-date" id="traval-date" value="Feb 07">Feb 07
                </label>
              </div>
              ...
              <div class="check-box">
                ...
                <label>
                  <input type="radio" name="traval-date" id="traval-date" value="Feb 14">Feb 14
                </label>
              </div> -->
              ...
              <div class="check-box">
                ...
                <label>
                  <input type="radio" name="traval-date" id="traval-date" value="Mar 07">Mar 07
                </label>
              </div>
              ...
              <div class="check-box">
                ...
                <label>
                  <input type="radio" name="traval-date" id="traval-date" value="Mar 14">Mar 14
                </label>
              </div>
              ...
              <div class="check-box">
                ...
                <label>
                  <input type="radio" name="traval-date" id="traval-date" value="Mar 28">Mar 28
                </label>
              </div>
              ...
              <div class="check-box">
                ...
                <label>
                  <input type="radio" name="traval-date" id="traval-date" value="Mar 14">Apr 11
                </label>
              </div>
              ...
              <div class="check-box">
                ...
                <label>
                  <input type="radio" name="traval-date" id="traval-date" value="Apr 18">Apr 18
                </label>
              </div>
            ...
            <div class="gender-box">
              ...
              <div class="gender-option">
                ...
                <div class="gender">
                  <input type="radio" id="check-other" value="Others" name="gender" />
            ...
            <div class="gender-box">
              ...
              <div class="gender-option">
                ...
                <div class="sharing">
                  <input type="radio" checked id="sharing2" value="Triple Sharing" name="sharing" />
            ...
            <div class="column">
              <div class="input-box">
                <label for="count">Travel Count</label>
                <input type="number" name="count" value="1" id="count" placeholder=" Traveller count " required /><i
                  onclick="incrementCount()" class="fa-solid fa-plus"></i>
              </div>
