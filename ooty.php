...
<body>
  ...
  <!-- Banner -->
  <section class="trip-home" id="tripSection" style="  padding: 350px 0; color: white; position: relative;  ">



    <div class="container-lg" style="position: relative; text-align: center;">

      <h2 class="banner-hight-top ms-2" style="font-size:49px; font-weight: 900; color: #fff; text-shadow: 2px 2px 8px rgba(0,0,0,0.7); letter-spacing: 1px;">
          OOTY THE QUEEN OF HILLS
        </h2>

      <ul class="banner-hight-bottom p-0" style="list-style: none; ; display: flex; flex-wrap: wrap; justify-content: center;">
  ...
  <div class="container">
    ...
    <br><br>
    <section class="destination mt-0 mt-lg-5" style="background-color: white; box-shadow: 0 6px 20px rgba(0, 0, 0, 0.1); border-radius: 30px;" id="overview">
        ...
        <div class="row g-4 flex-column-reverse flex-md-row align-items-center">
          ...
          <div class="col-md-7">
            <div class="travel-des p-3 p-md-4">
                ...
                <div onclick="toggleReadMore()" class="position-absolute bottom-1 start-50 translate-middle-x d-block d-md-none">
          ...
          <div class="col-md-5 mt-0">
            <div class="swiper miniSlider px-px-md-0 py-3">
                <div class="swiper-wrapper">
                  ...
                  <div class="swiper-slide">
                    <img src="assets/img/Ooty/2.JPG" class="img-fluid w-100" alt="Wayanad" style="border-radius: 30px; height: 350px; object-fit: cover;">
                  </div>
                </div>
              </div>
          </div>
              ...
              <div class="accordion" id="accordionExample">
                    ...
                    <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                      <div class="accordion-body" style="background-color: #f5fdff;">
                        ...
                        <ul class="ps-lg-3 ps-0">
                          ...
                          <li>
                            <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>
                            Indulge in nearby shopping and buy souvenirs for your loved ones.
                          </li>
                          <li>
                            <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>
                  ...
                  <div class="accordion-item mb-4 border overflow-hidden" style="border-radius: 30px;">
                    <h2 class="accordion-header" id="headingThree">
                      <button class="accordion-button collapsed d-flex justify-content-between align-items-center text-dark fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                        <div class="d-flex align-items-center w-100">
                  ...
                  <div class="accordion-item mb-4 border overflow-hidden" style="border-radius: 30px;">
                    <h2 class="accordion-header" id="headingFour">
                      <button class="accordion-button collapsed d-flex justify-content-between align-items-center text-dark fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
                        <div class="d-flex align-items-center w-100">
            ...
            <section id="inclusion">
                <div class="important-notes shadow" style="border-radius: 30px; background-color:rgb(245, 255, 246);">
                  ...
                  <div>
                    ...
                    <p>
                      <i class="fa-solid fa-circle-check me-2 pulse" style="color: #1fa463;"></i>
                      Includes Hotels / Camps. Solo travellers can share with a persons of same gender travellers.
                    </p>
                    <p>
                      <i class="fa-solid fa-circle-check me-2 pulse" style="color: #1fa463;"></i>
          ...
          <div class="col-md-4">
            ...
            <div class="price-sticky" style="position: sticky; top: 120px;">
              ...
              <div class="priceCard shadow " style="border-radius: 30px;">
                <img src="assets/img/Ooty/Ooty%20pic%201.jpg" alt="Valley of Flowers Banner 3" style="border-radius: 30px; object-fit:cover;">
              </div>
                ...
                <div class="p-2">
                  ...
                  <div class="inner-box" style="background-color: #f0f0f0; padding: 15px; border-radius: 30px;">
                      ...
                      <div class="trip-form p-0">
                        <a href="ooty-form.php" class="btn butn butn__new bg-" style="border-radius: 30px;">Dates
                          &amp; Costing</a>
                      </div>
                    </div>
                </div>
              ...
              <div class="shadow" id="map-trip" style="border: 1px solid #00aaff; border-radius: 30px; padding: 20px; margin: auto; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); max-width: 450px; background-color: #fff;">
                <form>
                  ...
                  <div class="input-field mb-3" style="margin-bottom: 20px;">
                    ...
                    <input placeholder="Your Name" type="text" id="name" name="name" required="" style="width: 100%; padding: 12px; margin-bottom: 10px; border-radius: 8px; border: 1px solid #ccc; font-size: 14px; transition: border 0.3s ease;">
                  </div>

                  <div class="input-field mb-3" style="margin-bottom: 20px;">
                    <label for="email" style="font-size: 16px; color: #333;">Email</label>
                    <input placeholder="Your Email" type="email" id="email" name="email" required="" style="width: 100%; padding: 12px; margin-bottom: 10px; border-radius: 8px; border: 1px solid #ccc; font-size: 14px; transition: border 0.3s ease;">
                  </div>

                  <div class="input-field mb-3" style="margin-bottom: 20px;">
                    <label for="phone" style="font-size: 16px; color: #333;">Phone Number</label>
                    <input placeholder="Your Phone Number" type="tel" id="phone" name="phone" required="" style="width: 100%; padding: 12px; margin-bottom: 20px; border-radius: 8px; border: 1px solid #ccc; font-size: 14px; transition: border 0.3s ease;">
                  </div>
      ...
      <div class="row">
        <div class="accordion" id="accordionFlushExample">
            ...
            <div class="accordion-item mb-4 border overflow-hidden" style="border-radius: 10px;">
              <h2 class="accordion-header" id="headingOne">
                <button class="accordion-button collapsed text-dark fw-bold d-flex justify-content-between align-items-center" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
            ...
            <div class="accordion-item mb-4 border overflow-hidden" style="border-radius: 10px;">
              <h2 class="accordion-header" id="headingFive">
                <button class="accordion-button collapsed d-flex justify-content-between align-items-center text-dark fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFive" aria-expanded="false" aria-controls="collapseFive">
