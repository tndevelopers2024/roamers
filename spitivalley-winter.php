                    ...
                    <div class="row g-4 flex-column-reverse flex-md-row align-items-center">
                        ...
                        <div class="col-md-7">
                            <div class="travel-des p-3 p-md-4">
                                ...
                                <div style="cursor:pointer;" id="readMoreToggleWrapper" class="position-absolute bottom-1 start-50 translate-middle-x d-block d-md-none">
                        ...
                        <div class="col-md-8">
                                            ...
                                            <div class="accordion-body" style="background-color: #f5fdff;">
                                                <ul class="ps-lg-3 ps-0">
                                                    <li>
                                                        ...
                                                        Hey Roamers! Assemble at the designated point by <b>7:00 PM (tentative) </b>to kickstart our adventure.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>
                                                        Meet the team & trip captains and let’s set off on an overnight journey to Shimla.
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                        ...
                                        <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                                            ...
                                            <div class="accordion-body" style="background-color: #f5fdff;">
                                                <ul class="ps-lg-3 ps-0">
                                                    ...
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>
                                                        After breakfast, begin our scenic drive through Kufri, Narkanda, and Rampur on the Indo-Tibetan Highway.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>
                                                        Stop by the famous <b>Kinnaur Gate </b> for pictures as we enter the Kinnaur Valley.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>
                                                        Reach <b>Kalpa</b> by evening, catch stunning views over Kinner Kailash peaks.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>
                                                        Visit the <b>Roghi Village & Suicide Point</b> viewpoint for sunset before heading back.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>
                                        ...
                                        <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree"
                                            ...
                                            <div class="accordion-body bg-white px-4 py-3">
                                                <ul class="ps-lg-3 ps-0">
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>
                                                        Post breakfast, we’ll head toward Tabo through dramatic high-mountain roads.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>
                                                        Stop at <b> Khab Sangam</b>, the confluence of the mighty Spiti River meets the Sutlej River, marking the gateway into Spiti Valley.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>
                                                        Next up, halt in <b>Nako Lake</b>, a serene frozen gem in winter, and explore the <b>Nako Monastery</b>.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>
                                                        Continue through <b>Sumdo</b> as we officially enter Spiti Valley.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>
                                                        Arrive in <b>Tabo</b> by evening and visit the ancient <b>Tabo Monastery</b>, one of the oldest in the Himalayas.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>
                                        ...
                                        <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour"
                                            ...
                                            <div class="accordion-body bg-white px-4 py-3">
                                                <ul class="ps-lg-3 ps-0">
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>
                                                        Wake up early, enjoy breakfast, and get ready for a beautiful day.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>
                                                        We’ll Visit <b>Dhankar Village</b> and explore the incredible <b>Dhankar Monastery.</b>
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>
                                                        Arrive kaza, let’s head to <b>Langza Village</b>, iconic <b>Buddha</b> Statue & Fossil Valley views.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>
                                        ...
                                        <div id="collapseFive" class="accordion-collapse collapse" aria-labelledby="headingFive"
                                            ...
                                            <div class="accordion-body bg-white px-4 py-3">
                                                <ul class="ps-lg-3 ps-0">
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>
                                                        Let’s start the day with breakfast before we explore the best of Spiti.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>
                                                        Visit the majestic <b>Key Monastery</b>, one of the most picturesque in the valley.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>
                                                        Then we’ll explore <b>Kibber Village</b> & cross the <b>Chicham Bridge</b> (Asia’s highest suspension bridge).
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>
                                                        Continuing to <b>Hikkim</b>, the world’s highest post office, send postcards to your loved ones from the highest!
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>
                                                        Finally let’s head to Asia’s highest Village, <b>Komic Village</b>.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>
                                                        After exploring the Land of Highest, let's return to Kaza for a hearty dinner and overnight stay.
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                        ...
                                        <div id="collapseSix" class="accordion-collapse collapse" aria-labelledby="headingSix"
                                            ...
                                            <div class="accordion-body bg-white px-4 py-3">
                                                <ul class="ps-lg-3 ps-0">
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>
                                                        After breakfast, we’ll begin our journey back through the winter wonderland.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>
                                                        Let’s drive toward the frozen <b>Sangla Valley</b>, one of the most picturesque regions of Kinnaur.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>
                                                    ...
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>
                                                        We’ll continue to <b>Chitkul</b>, the last inhabited village of India, a true snow paradise.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>
                                        ...
                                        <h2 class="accordion-header" id="headingSeven">
                                            <button
                                                ...
                                                <div class="d-flex align-items-center w-100">
                                                    ...
                                                    <span>Sangla / Chitkul Exploration & Leisure Day | Farewell Dinner</span>
                                                    <i class="bi bi-chevron-down ms-auto transition-arrow" style="color:#0c63e4;"></i>
                                                </div>
                                            </button>
                                        </h2>
                                        <div id="collapseSeven" class="accordion-collapse collapse" aria-labelledby="headingSeven"
                                            ...
                                            <div class="accordion-body bg-white px-4 py-3">
                                                <ul class="ps-lg-3 ps-0">
                                                    ...
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>
                                                        Optional short walk to <b>Batseri Village </b>or along the riverside pine trail.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>
                                                        Explore the quiet villages, enjoy the mountain landscapes filled with snow just like paradise.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>
                                                        Farewell Dinner by Roamers, last night let’s make the best memories out of it!
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>
                                        ...
                                        <div id="collapseEight" class="accordion-collapse collapse" aria-labelledby="headingEight"
                                            ...
                                            <div class="accordion-body bg-white px-4 py-3">
                                                <ul class="ps-lg-3 ps-0">
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>
                                                        Wake up early and enjoy breakfast before the long, scenic drive back to <b>Shimla</b>.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>
                                                        Reach by evening, explore <b>Mall Road</b> for shopping and warm snacks (only if time permits)
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>
                                                        Later, board your Volvo/tempo traveler for the overnight journey to Delhi.
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                        ...
                                        <div id="collapseNinen" class="accordion-collapse collapse" aria-labelledby="headingNinen"
                                            ...
                                            <div class="accordion-body bg-white px-4 py-3">
                                                <ul class="ps-lg-3 ps-0">
                                                    ...
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>
                                                        In just a few days, we’ve shared snow trails, laughter, and stories for a lifetime.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>
                                                        Goodbyes are never easy, but hey what a ride it has been, Bye Roamers!
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                            ...
                            <section id="inclusion">
                                <div class="important-notes shadow" style="border-radius: 10px; background-color:rgb(245, 255, 246);">
                                    ...
                                    <div>
                                        ...
                                        <p><i class="fa-solid fa-circle-check me-2 pulse" style="color: #1fa463;"></i>
                                            Accommodation for nights: 1N Kalpa &bull; 1N Tabo &bull; 2N Kaza &bull; 2N Sangla / Chitkul
                                        </p>
                                        <p><i class="fa-solid fa-circle-check me-2 pulse" style="color: #1fa463;"></i>
                                            12 meals: 1 dinner on Day 1, Breakfast &amp; Dinner on Days 2&ndash;7, breakfast on Day 8
                                        </p>
                                        <p><i class="fa-solid fa-circle-check me-2 pulse" style="color: #1fa463;"></i>
                                            Inner line permits
                                        </p>
                            ...
                            <div class="important-notes shadow" style="border-radius: 10px; background-color: rgb(255, 244, 244);"
                                ...
                                <div>
                                    ...
                                    <p>
                                        <i class="fa-solid fa-circle-xmark me-2 pulse" style="color: #ff6b6b;"></i>
                                        Any meals or beverages not listed in the inclusions (such as alcohol, mineral water, or lunches on the highway)
                                    </p>
                                    <p>
                                        <i class="fa-solid fa-circle-xmark me-2 pulse" style="color: #ff6b6b;"></i>
                            ...
                            <div class="important-notes shadow" style="border-radius: 10px;" id="notes">
                                ...
                                <div>
                                    ...
                                    <p>
                                        <i class="fa-solid fa-circle-exclamation me-2" style="color: #00aaff;"></i>
                                        Stays are local homestays/guesthouses with basic heating. Embrace the authentic winter Spiti vibe.
                                    </p>
                                    <p>
                                        <i class="fa-solid fa-circle-exclamation me-2" style="color: #00aaff;"></i>
                                        Pre-inform any medical conditions. Carry personal medications and a small medical kit (O<sub>2</sub> available for emergency use).
                                    </p>
                                </div>
                            </div>
                                    ...
                                    <div class="p-2">
                                        ...
                                        <div class="inner-box" style="background-color: #f0f0f0; padding: 15px; border-radius: 10px;">
                                            ...
                                            <div class="trip-form p-0">
                                                <a href="spitivalley-winter-from.php" class="btn butn butn__new bg-" style="border-radius: 10px;">Dates
                                                    & Costing</a>
                                            </div>
                                        </div>
                                    </div>
