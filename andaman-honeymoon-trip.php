...
<head>
  ...
  <title>Andaman Islands ~ Dreamy Honeymoon</title>

  <!-- SEO Meta Description -->
  <meta name="description" content="Andaman Islands ~ Dreamy Honeymoon" />
  <meta name="author" content="Themeland" />
  <meta property="og:image:width" content="700" />
  <meta property="og:image:height" content="500" />

  <!-- Basic Open Graph tags -->
  <meta property="og:title" content="Andaman Islands ~ Dreamy Honeymoon" />
  ...
  <meta name="twitter:title" content="Andaman Islands ~ Dreamy Honeymoon" />
          ...
          <div class="">
            <div class="row text-center">
              ...
              <div class="enhanced-box">
                ...
                <div>
                <div class="info-label">Starting Price</div>
                <div class="info-value andaman-honeymoon-price"><span>/-</span></div>
                </div>
              </div>
            </div> -->
                ...
                <div class="accordion" id="accordionExample">
                    ...
                    <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                      <div class="accordion-body" style="background-color: #f5fdff;">
                        <ul class="ps-lg-3 ps-0">
                          <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>Meet our representative at Port Blair Airport for a warm welcome and comfortable transfer to your hotel.</li>
                          <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>Check in to your Premium Resort, relax & Leisure time</li>
                          <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>Enjoy your beautifully decorated honeymoon room with a complimentary cake</li>
                          <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>At evening, visit the Andaman Jail for Light & Sound Show</li>
                          <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>Enjoy your overnight stay in Port Blair.</li>
                        </ul>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="accordion-item mb-4 border overflow-hidden" style="border-radius: 30px;">
                    <h2 class="accordion-header" id="headingTwo">
                      <button class="accordion-button collapsed d-flex justify-content-between align-items-center text-dark fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                        <div class="d-flex align-items-center w-100">
                          ...
                          <span>OFF TO HAVELOCK ISLANDS | BEACH & SUNSETS</span>
                    ...
                    <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                      <div class="accordion-body" style="background-color: #f5fdff;">
                        <ul class="ps-lg-3 ps-0">
                          <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>After Tropical breakfast, board your Ferry to the best, Havelock Island.</li>
                          <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>Check into your beachside resort & Chill for a while!</li>
                          <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>Ready for India's most beautiful Beach & sunsets? Radhanagar Beach we go!</li>
                          <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>Optional couple photoshoot to capture memories you'll cherish forever.</li>
                          <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>Cafe hopping, seafood or nightlife? If you two are upto!</li>
                          <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>Overnight stay in Havelock Islands.</li>
                        </ul>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="accordion-item mb-4 border overflow-hidden" style="border-radius: 30px;">
                    <h2 class="accordion-header" id="headingThree">
                      <button class="accordion-button collapsed d-flex justify-content-between align-items-center text-dark fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#collapse3" aria-expanded="false" aria-controls="collapse3">
                        <div class="d-flex align-items-center w-100">
                          ...
                          <span>ELEPHANT BEACH | PRETTY ADVENTURES</span>
                          <i class="bi bi-chevron-down ms-auto transition-arrow" style="color:#0c63e4;"></i>
                        </div>
                      </button>
                    </h2>
                    <div id="collapse3" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                      <div class="accordion-body bg-white px-4 py-3">
                        <ul class="ps-lg-3 ps-0">
                          <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>Start your day with a Delish Breakfast</li>
                          <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>Ready for stunning Elephant Beach? Transfer via Speed Boat</li>
                          <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>Enjoy a complimentary Glass-Bottom Boat Ride & witness the marine life</li>
                          <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>Add activities like Scuba Diving, Sea Walk, Snorkelling, Kayaking or Jet Ski.</li>
                          <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>Wind down the day with a complimentary candlelight dinner curated for two.</li>
                  ...
                  <div class="accordion-item mb-4 border overflow-hidden" style="border-radius: 30px;">
                    <h2 class="accordion-header" id="headingFour">
                      <button class="accordion-button collapsed d-flex justify-content-between align-items-center text-dark fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#collapse4" aria-expanded="false" aria-controls="collapse4">
                        <div class="d-flex align-items-center w-100">
                          ...
                          <span>SLOW DOWN AT NEIL ISLANDS</span>
                          <i class="bi bi-chevron-down ms-auto transition-arrow" style="color:#0c63e4;"></i>
                        </div>
                      </button>
                    </h2>
                    <div id="collapse4" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#accordionExample">
                      <div class="accordion-body bg-white px-4 py-3">
                        <ul class="ps-lg-3 ps-0">
                          <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>Cruise across to the charming Neil Island after breakfast.</li>
                          <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>Explore Bharatpur Beach & the iconic Natural Bridge.</li>
                          <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>Spend a relaxed evening watching the sunset at Laxmanpur Beach.</li>
                          <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>Enjoy quality time together amidst the serene island vibes.</li>
                          <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>Overnight stay in Peaceful Neil Island.</li>
                        </ul>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="accordion-item mb-4 border overflow-hidden" style="border-radius: 30px;">
                    ...
                    <div id="collapse5" class="accordion-collapse collapse" aria-labelledby="headingFive" data-bs-parent="#accordionExample">
                      <div class="accordion-body bg-white px-4 py-3">
                        <p class="fst-italic text-muted mb-3" style="font-size: 14px;">One last island sunset before heading home.</p>
                        <ul class="ps-lg-3 ps-0">
                          <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>Neil's Breakfast & Return to Port Blair by ferry</li>
                          <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>Check in to your hotel and unwind.</li>
                          <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>Visit the picturesque Chidiyatapu for a beautiful sunset and birdwatching experience.</li>
                          <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>Time for shopping to buy Souvenirs to your loved ones</li>
                          <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>Farewell night stay in Port Blair.</li>
                        </ul>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="accordion-item mb-4 border overflow-hidden" style="border-radius: 30px;">
                    ...
                    <div id="collapse6" class="accordion-collapse collapse" aria-labelledby="headingSix" data-bs-parent="#accordionExample">
                      <div class="accordion-body bg-white px-4 py-3">
                        <ul class="ps-lg-3 ps-0">
                          <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>Enjoy a leisurely breakfast before checking out.</li>
                          <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>Meet our representative for your airport transfer.</li>
                          <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>Leave Andaman with unforgettable memories!</li>
                        </ul>
                        <p class="fst-italic text-muted mt-3 mb-0" style="font-size: 14px;">Remember 'Andaman' can never go wrong :)</p>
                      </div>
                    </div>
                  </div>
                </div>
