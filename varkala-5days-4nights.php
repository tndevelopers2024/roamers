...
<head>
  ...
  <title>Roamers - Varkala Trip 5 Days 4 Nights</title>

  <!-- SEO Meta Description -->
  <meta name="description" content="Roamers - Varkala Trip" />
  <meta name="author" content="Themeland" />
  <meta property="og:image:width" content="700" />
  <meta property="og:image:height" content="500" />

  <!-- Basic Open Graph tags -->
  <meta property="og:title" content="Roamers - Varkala Trip" />
  <meta property="og:description"
    content="Join our Varkala trip for an unforgettable beach adventure, curated experiences, and new friendships." />
  ...
  <meta name="twitter:title" content="Roamers - Varkala Trip" />
          ...
          <div class="col-md-7">
            <div class="travel-des p-3 p-md-4">
              ...
              <p style="color: #555;" class="desk-desc d-none d-md-block">
                Varkala is all about breathtaking cliffs, golden beaches, and epic sunsets. With
                laid-back vibes and
                beachside cafes, it’s the perfect place to relax and unwind – and that’s exactly what
                our itinerary has
                in store for you! <br /><br />

                But adventure is never far behind! From thrilling cable car ride to Epic Jatayu,
                enjoying a serene canoe
                ride on Mangroves, Beach Hopping, to savouring local seafood, our Varkala itinerary
                offers the best
              ...
              <p style="color: #555;" class="mob-desc d-block d-md-none">
                ...
                <span id="moreText" style="display: none;"><br><br>
                  But adventure is never far behind! From thrilling cable car ride to Epic Jatayu,
                  enjoying a serene
                  canoe ride on Mangroves, Beach Hopping, to savouring local seafood, our Varkala
                  itinerary offers
        ...
        <div class="row">
          ...
          <div class="col-md-8">
                  ...
                  <h2 class="accordion-header" id="headingOne">
                    <button class="accordion-button text-dark fw-bold d-flex justify-content-between align-items-center"
                      ...
                      <div class="d-flex align-items-center">
                        ...
                        <span>Varkala Arrival, Jatayu & Cliffside Charms</span>
                      </div>
                    ...
                    <div class="accordion-body" style="background-color: #f5fdff;">
                      ...
                      <ul class="ps-lg-3 ps-0">
                        <li class=""><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                          ...
                          Meet our representative for a smooth pickup and check-in at the resort.

                        </li>
                        <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                            style="font-size: 0.65rem;"></i>Freshen up and relax, then head to the iconic Varkala Cliff.
                          Enjoy vibrant cliffside cafes, unique shops and stunning views.

                        </li>
                        <li><i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3"
                            style="font-size: 0.65rem;"></i>Witness a magical sunset at Varkala Beach, the perfect start
                          to your adventure.

                        </li>
                        <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                            style="font-size: 0.65rem;"></i>Overnight stay in Varkala.
                  ...
                  <h2 class="accordion-header" id="headingTwo">
                    <button
                      ...
                      <div class="d-flex align-items-center w-100">
                        <span class="badge bg-primary rounded-pill me-3 px-3 py-2 animated-badge">Day
                          2</span>
                        <span> Jatayu Earth Centre, Beaches & more
                        </span>
                    ...
                    <div class="accordion-body" style="background-color: #f5fdff;">
                      ...
                      <ul class="ps-lg-3 ps-0">
                        <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>
                          Savour Delicious breakfast & kick start your day with an
                          exhilarating cable car ride to the epic Jatayu Earth Center
                        </li>
                        <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>
                          Reach the top to witness the giant Jatayu sculpture, a mythical bird
                          from the Ramayana and enjoy the panoramic views

                        <li><i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3"
                            style="font-size: 0.65rem;"></i>Visit the most famous ancient
                          Janardanaswamy Temple.
                        </li>
                        <li><i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>
                          Unwind at Papanasam Beach, Edawa Beach and the serene Black Beach
                          (Thiruvambadi Beach) .
                        </li>
                        <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                            style="font-size: 0.65rem;"></i>Overnight stay in Varkala.
                ...
                <div class="accordion-item mb-4 border  overflow-hidden" style="border-radius: 10px;">
                  <h2 class="accordion-header" id="headingThree">
                    <button
                      ...
                      <div class="d-flex align-items-center w-100">
                        <span class="badge bg-primary rounded-pill me-3 px-3 py-2 animated-badge">Day
                          3</span>
                        <span>Munroe island, Canoe ride, Beaches & more</span>
                        <i class="bi bi-chevron-down ms-auto transition-arrow" style="color:#0c63e4;"></i>
                      </div>
                    </button>
                  </h2>
                  <div id="collapse3" class="accordion-collapse collapse" aria-labelledby="headingThree"
                    ...
                    <div class="accordion-body bg-white px-4 py-3">
                      <ul class="ps-lg-3 ps-0">
                        <li><i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>
                          Morning depart for Munroe island
                        </li>
                        <li>
                          <i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>
                          Enroute stop by the postcard-perfect Kappil Beach for some serene
                          vibes.
                        </li>
                        <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>
                          Next pause at Lake view point, a true show stealer!

                        </li>
                        <li><i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>
                          After reaching Muroe Island and indulge in much needed authentic
                          kerala Traditional food

                        <li><i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>
                          Next up, time go on a most famous Canoe ride through tranquil
                          backwaters of Munroe island

                        </li>
                        <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>Take
                          your time to admire and
                          explore the nature beauty and local culture
                        </li>
                        <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>
                ...
                <div class="accordion-item mb-4 border  overflow-hidden" style="border-radius: 10px;">
                  <h2 class="accordion-header" id="headingFour">
                    <button
                      ...
                      <div class="d-flex align-items-center w-100">
                        <span class="badge bg-primary rounded-pill me-3 px-3 py-2 animated-badge">Day
                          4</span>
                        <span>Forts, Kayaks & Nightlife</span>
                        <i class="bi bi-chevron-down ms-auto transition-arrow" style="color:#0c63e4;"></i>
                      </div>
                    </button>
                  </h2>
                  <div id="collapse4" class="accordion-collapse collapse" aria-labelledby="headingFour"
                    ...
                    <div class="accordion-body bg-white px-4 py-3">
                      <ul class="ps-lg-3 ps-0">
                        <li><i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>
                          Relish your breakfast and Leisure Time
                        </li>
                        <li>
                          <i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>
                          Drive Back to Varkala & Up your adventure with kayaking through the lush Varkala mangroves.
                        </li>
                        <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>
                          visit historic Anjengo Fort and the iconic Varkala Lighthouse.
                        </li>
                        <li><i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>
                          Visit your Favourite Beaches again.
                        </li>
                        <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>
                          Relax back at your resort or head out to enjoy Varkala’s exciting nightlife with its cafes,
                  ...
                  <h2 class="accordion-header" id="headingFive">
                    <button
                      ...
                      <div class="d-flex align-items-center w-100">
                        <span class="badge bg-primary rounded-pill me-3 px-3 py-2 animated-badge">Day
                          5</span>
                        <span>Farewell, Trivandrum sightseeing & Departure</span>
                        <i class="bi bi-chevron-down ms-auto transition-arrow" style="color:#0c63e4;"></i>
                      </div>
                    </button>
                  </h2>
                  <div id="collapse5" class="accordion-collapse collapse" aria-labelledby="headingFive"
                    ...
                    <div class="accordion-body bg-white px-4 py-3">
                      <ul class="ps-lg-3 ps-0">
                        ...
                        <li>
                          <i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>
                          Say goodbye to this slice of paradise and drive to Trivandrum
                        </li>
                        <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>
                          Visit the Famous Sri Padnabaswamy Temple, Napier Museum, & end your
                          day in Kovalam Beach
                        </li>
                        <li><i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>
                          If you have time, squeeze in some last-minute shopping at Varkala’s
                          vibrant spots.
                        <li><i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>
                          Departure. Leave the city with unforgettable memories.
                        </li>
                      </ul>
                    </div>
                  </div>
                ...
                <div class="accordion-item mb-4 border  overflow-hidden" style="border-radius: 10px;">
                  ...
                  <div id="collapse6" class="accordion-collapse collapse" aria-labelledby="headingSix"
                    ...
                    <div class="accordion-body bg-white px-4 py-3">
                      <ul class="ps-lg-3 ps-0">
                        <li><i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>
                          We'll aim to arrive in Chennai by 8 am in the morning. Bye for now
                          Roamers. Reunion plans for next year? You bet!
                        </li>
                        <li>
                          <i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>
                          Goodbyes are never easy, but what ride it has been! See you guys,
                          more Hugs!
                        </li>
                      </ul>
                    </div>
            ...
            <section id="inclusion" class="">
              <div class="important-notes" style="border-radius: 10px; background-color:rgb(245, 255, 246) ;">
              ...
              <div class="important-notes" style="border-radius: 10px; background-color: rgb(255, 244, 244);"
                id="exclusion">
                <h3 class="head" style="text-align: center; margin-bottom: 20px; margin-left: 10px;">
                  Exclusion</h3>
                <div>
                  ...
                  <p><i class="fa-solid fa-circle-xmark me-2 pulse" style="color: red;"></i>
                    Any other costs involved due to a natural calamity or any other forced
                    circumstances
              ...
              <div class="price-card shadow p-1" style="border-radius: 10px;">
                <div class="p-2">
                  <div class="inner-box" style="background-color: #f0f0f0; padding: 15px; border-radius: 10px;">
                    <h3 style="text-align: center; margin-bottom: 0px;">VARKALA TRIP</h3>
                    ...
                    <div class="trip-form p-0">
                      <a href="https://wa.me/message/QYDBK5TO42TGH1" target="blank" class="btn butn butn__new bg-"
