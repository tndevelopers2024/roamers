...
<head>
  ...
  <meta property="og:image" content="https://roamers.in/assets/img/varkala/cliffs.jpg" />
  <meta property="og:image:secure_url" content="https://roamers.in/assets/img/varkala/cliffs.jpg" />
  ...
  <style>
    ...
    .trip-home {
      background: url(assets/img/varkala/varkala-bg1.jpg);
              ...
              <div class="accordion-item ai1">
                <h2 class="accordion-header" id="headingOne">
                  <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne"
                    ...
                    <div class="days"> Day 1 </div>: Varkala Arrival & Cliffside Charms
                  </button>
                </h2>
                <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                  ...
                  <div class="accordion-body">
                    <ul class="acc-inner">
                      ...
                      <li>
                        Freshen up and relax, then head to the iconic Varkala Cliff. Enjoy vibrant cliffside cafes,
                        unique shops and stunning views.
                      </li>
                      <li>Witness a magical sunset at Varkala Beach, the perfect start to your adventure.
                      </li>
              ...
              <div class="accordion-item ai1">
                <h2 class="accordion-header" id="headingTwo">
                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                    ...
                    <div class="days"> Day 2</div>: Jatayu Earth Centre, Beaches & more
                  </button>
                </h2>
                <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                  ...
                  <div class="accordion-body">
                    <ul class="acc-inner">
                      <li>
                        Savour Delicious breakfast & kick start your day with an exhilarating cable car ride to the epic
                        Jatayu Earth Center
                      </li>
                      <li>
                      ...
                      <li>
                        Visit the most famous ancient Janardanaswamy Temple.
                      </li>
                      <li>
                        Unwind at Papanasam Beach, Edawa Beach and the serene Black Beach (Thiruvambadi Beach) & more.
                      </li>
                      <li>Overnight stay in Varkala.</li>
                    </ul>
                  </div>
              ...
              <div class="accordion-item ai1">
                <h2 class="accordion-header" id="headingTwo">
                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                    ...
                    <div class="days"> Day 3 </div>: Munroe island, Beaches & more
                  </button>
                </h2>
                <div id="collapse3" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                  ...
                  <div class="accordion-body">
                    <ul class="acc-inner">
                      ...
                      <li>
                        After reaching Muroe Island and indulge in much needed authentic kerala Traditional food
                      </li>
                      <li>Next up, time go on a most famous Canoe ride through tranquil backwaters of Munroe island
                      </li>
                      <li>Take your time to admire and explore the nature beauty and local culture</li>
                      <li>Overnight stay in Munroe Island</li>
                    </ul>
                  </div>
                </div>
              </div>
              ...
              <div class="accordion-item ai1">
                <h2 class="accordion-header" id="headingTwo">
                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                    ...
                    <div class="days">Day 4</div>: Forts, Kayaks & Nightlife
                  </button>
                </h2>
              ...
              <div class="accordion-item ai1">
                <h2 class="accordion-header" id="headingSix">
                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                    ...
                    <div class="days">Day 5</div>: Farewell, Trivandrum sightseeing & Departure
                  </button>
                </h2>
                <div id="collapse6" class="accordion-collapse collapse" aria-labelledby="headingSix"
                  ...
                  <div class="accordion-body">
                    ...
                    <ul class="acc-inner">
                      ...
                      <li>
                        Visit the Famous Sri Padnabaswamy Temple, Napier Museum, & end your day in Kovalam Beach
                      </li>
                      <li>
          ...
          <div class="sticky-sidebar">
            ...
            <div class="trip-tab">
              <ul class="nav nav-pills trip-nav mb-3" id="pills-tab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                  <button class="nav-link active" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home"
                    type="button" role="tab" aria-controls="pills-home" aria-selected="true">Dec</button>
                </li>

                <li class="nav-item" role="presentation">
                  <button class="nav-link" id="pills-aug-tab" data-bs-toggle="pill" data-bs-target="#pills-aug"
                    type="button" role="tab" aria-controls="pills-aug" aria-selected="true">Jan</button>
                </li>
              ...
              <div class="tab-content tab-con" id="pills-tabContent">
                ...
                <div class="tab-pane fade " id="pills-oct" role="tabpanel" aria-labelledby="pills-oct">
                  <div class="upcoming-slot ">
                    <h3>Nov 29</h3>
                  </div>
                </div>
