        ...
        <div class="event-slider" id="event-slider-august">
            ...
            <div class="event-card">
                <div class="event-content" style="position: relative;">
                    ...
                    <div class="event-card-content" style="position: absolute; top: 0; left: 0; width: 100%; z-index: 2; ">
                        ...
                        <div>
                            <h1 class="event-title event-title-responsive-on-event"
                                ...
                                DINE WITH Strangers
                                <p class="mt-1" style="font-size: 10px;  margin-bottom: 0px; color: #FFFFFF; text-transform: none;  word-spacing: 1px;">Share a meal, swap stories, make new friends</p>
                            </h1>
                        </div>
                    ...
                    <a href="#" class="event-view">Sold Out</a>
                </div>
            </div>
            <!-- Event Card 2 -->
            <div class="event-card">
                <div class="event-content" style="position: relative;">
                    ...
                    <div style="position: absolute; top: 0; left: 0; width: 100%; z-index: 2; margin-top: 210px; ">
                        ...
                        <h1 class="event-title event-title-responsive-on-event"
                            style="padding: 0px 10px 0px 10px; font-size: 15px; font-weight: bold; word-spacing: 1px;">
                            Pottery WORK SHOP
                            <p class="mt-1" style="font-size: 10px; margin-bottom: 0px; color: #FFFFFF; text-transform: none;  word-spacing: 1px;">Shape, mold, Heal, create, laugh together</p>

                        </h1>
                        <div class="event-price-section " style=" margin: 0;  padding: 10px 20px 10px 20px;">
                            <div class="event-dates">
                                <span class="event-dates-text" style="font-weight:700"><i
                                        class="fa-solid fa-calendar me-1" style="color: #4ec0db;"></i> 25th Oct
                                    2025</span>
                            </div>
                            <div class="event-dates">
                                <i class="fa fa-map-marker-alt me-1" style="color: #4ec0db;"></i>
                ...
                <div class="event-content" style="position: relative;">
                    ...
                    <div style="position: absolute; top: 0; left: 0; width: 100%; z-index: 2; margin-top: 210px; ">
                        ...
                        <h1 class="event-title event-title-responsive-on-event"
                            ...
                            <p class="mt-1" style="font-size: 10px; margin-bottom: 0px; color: #FFFFFF; text-transform: none;  word-spacing: 1px;">Games, icebreakers, laughs, future buddies</p>
                    ...
                    <a href="components\events\event-pages\events-nov-1.php" class="event-view">Comming Soon !</a>
                </div>
            </div>
            <!-- Event Card 4 -->
            <div class="event-card">
                <div class="event-content" style="position: relative;">
                    ...
                    <div style="position: absolute; top: 0; left: 0; width: 100%; z-index: 2; margin-top: 210px; ">
                        ...
                        <h1 class="event-title event-title-responsive-on-event"
                            style="padding: 0px 10px 0px 10px; font-size: 15px; font-weight: bold; color: #fff; word-spacing: 1px;">
                            Mystery Movie Night
                            <p class="mt-1" style="font-size: 10px; margin-bottom: 0px;color: #FFFFFF; text-transform: none;  word-spacing: 1px;">Watch a surprise film, popcorn, laughs, discussions</p>
                ...
                <div class="event-content" style="position: relative;">
                    ...
                    <div style="position: absolute; top: 0; left: 0; width: 100%; z-index: 2; margin-top: 210px; ">
                        ...
                        <h1 class="event-title event-title-responsive-on-event mt-1"
                            ...
                            <p class="mt-1" style="font-size: 11px; margin-bottom: 0px; color: #FFFFFF; text-transform: none; word-spacing: 1px; ">Sip, chat, share stories, meet like-minded people</p>
