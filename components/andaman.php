        ...
        <div class="row">
          ...
          <div class="col-md-2">
            ...
            <div class="price-sticky" style="position: sticky;">
              <!-- >> Side Slider Section << -->
              <div class="priceCard shadow" style="border:none;">
                <video src="assets/assets/video/videos.mp4" autoplay muted loop playsinline
                  style="width: 100%; object-fit: cover; border-radius: 10px;"></video>
              </div>
