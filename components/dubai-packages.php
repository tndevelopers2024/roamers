...
">
  <title>Roamers - Dubai Packages</title>
...
<body>
  ...
  <section style="margin-top:50px;">
    <h2 class="head">DUBAI TOUR PACKAGES</h2>
    <div class="container">
          ...
          <div class="swiper-container2">
            <div class="swiper-slide">
              <a href="dubai-4D">
                ...
                <img class="img" src="assets/img/dubai/image1.jpg" alt="Image 1">
                <div class="slide-bg">
                  <div class="slide-text">
                    ...
                    <h5 class="fw-bold">Dubai Family Odyssey</h5>
                  </div>
                </div>
              </a>
            </div>
          ...
          <div class="swiper-container2">
            <div class="swiper-slide">
              <a href="dubai-5D">
                ...
                <img class="img" src="assets/img/dubai/image2.avif" alt="Image 1">
                <div class="slide-bg">
                  <div class="slide-text">
                    <div class="inner">
                    ...
                    <h5 class="fw-bold"> Dazzling Dubai with Ferrari World</h5>
                  </div>
                </div>
              </a>
            </div>
          ...
          <div class="swiper-container2">
            <div class="swiper-slide">
              <a href="dubai-7D">
                ...
                <img class="img" src="assets/img/dubai/image3.avif" alt="Image 3">
                <div class="slide-bg">
                  <div class="slide-text">
                    <div class="inner">
                      <h3><i class="fa-solid fa-calendar-days"> </i>7D / 6N</h3>
                      <h4><i class="fa-solid fa-location-dot"></i>
                        EX: Dubai
                      </h4>
                    </div>
                    <h5 class="fw-bold">Dreamy Dubai with Abu Dhabi</h5>
                  </div>
                </div>
              </a>
            </div>
