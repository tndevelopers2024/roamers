...
<head>
    ...
    <meta property="og:image:secure_url" content="assets/img/kerala-onam/kerala-onam (10).avif" width="600" height="600"
        alt="image for ooty" />
    <title>Roamers - Kerala </title>

    <!-- SEO Meta Description -->
    <meta name="description" content="Roamers - Kerala" />
    <meta name="author" content="Themeland" />
    <meta property="og:image:width" content="700" />
    <meta property="og:image:height" content="500" />

    <!-- Basic Open Graph tags -->
    <meta property="og:title" content="Roamers - Kerala" />
    <meta property="og:description" content="Discover the beauty of Kerala with our detailed travel guide and tips." />
    <meta property="og:image" content="assets/img/kerala-onam/kerala-onam (10).avif" />
    <meta property="og:url" content="assets/img/kerala-onam/kerala-onam (10).avif" />
    <meta property="og:type" content="website" />
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:title" content="Roamers - Kerala" />
    <meta name="twitter:description" content="Discover the beauty of Kerala with our detailed travel guide and tips." />
    <meta name="twitter:image" content="assets/img/kerala-onam/kerala-onam (10).avif" />
    ...
    .price-box {
      ...
      padding:3px 6px;
        ...
        .background-image {
            ...
            width: 100%;
            height: 100%;
            background: url('assets/img/kerala-onam/kerala-onam (10).avif');
...
<body>
    ...
    <section class="">
        <div class="container">
            <form action="kerala-mail-send-chritsmas-newyear.php" method="POST" autocomplete="off">
                                            ...
                                            <div class="input-field mt-4">
                                                ...
                                                <div class="input-field mt-4">
                                                    <select id="pickup" name="pickup" class="form-select mt-4" required>
                                                        ...
                                                        <option value="Kochi / Chennai">Kochi / Chennai</option>
                                                    </select>
                                                </div>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            fetch("./dynamic/varkala-data.json") // Check this path
                ...
                .then(data => {
                    const locationKey = "kerala-christmas-new-year";
                    ...
                    if (startingPriceElem) {
                        startingPriceElem.textContent = `Starting Price: ₹16,990 /- `;
                    } else {
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            fetch("./dynamic/varkala-data.json") // to change the price ... 
                ...
                .then(data => {
                    const locationKey = "kerala-christmas-new-year"; // Change to "ooty" if needed
                    const locationData = data[locationKey];
            ...
            if (nextBtn2) {
                nextBtn2.addEventListener("click", (e) => {
                    ...
                    if (sharing === "Triple Sharing") {
                        perPersonAmount = 16990;
                    } else if (sharing === "Double Sharing") {
                        perPersonAmount = 18990;
                    }
