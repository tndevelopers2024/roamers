...
">
  <title>Roamers - Andaman Packages</title>
  <meta name="title" content="Roamers - Andaman Packages" />
          ...
          <div class="swiper-container2">
            <div class="swiper-slide">
              <a href="andaman-8D">
                ...
                <img class="img" src="assets/img/andaman/Media/nabil-naidu.jpg" alt="Image 1">
                <div class="slide-bg">
                  <div class="slide-text">
                    ...
                    <h5 class="fw-bold">Andaman Island Hopping<br> All-in-one</h5>
                  </div>
                </div>
              </a>
            </div>
