...
">
  <title>Roamers - Dubai 4Days 3Nights</title>
      ...
      <div class="row">
        ...
        <div class="col-md-7" style="display: grid; place-items: center;">
          <div class="travel-des">
            ...
            <p>
              Step into the dazzling city of Dubai, where modern wonders meet unforgettable experiences. We’re covering
              the best of the city, from the iconic Burj Khalifa to the stunning Palm Jumeirah, the lively Dubai Marina,
              and the breathtaking desert. Each spot offers something exciting and unique.
            </p>
            <p>
              The adventure continues with dune bashing, skydiving over the Palm, and exploring the Dubai Frame.
              Enjoy a relaxing dinner on a Dubai Marina cruise, unwind on beautiful beaches, and take in panoramic views
              from the Burj Al Arab. With thrilling desert safaris, incredible shopping, and amazing views. Dubai the
              place you dont want to say bye!
            </p>
              ...
              <div class="accordion-item ai1">
                <h2 class="accordion-header" id="headingTwo">
                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                    ...
                    <div class="days">Day 4</div>: Dubai Frame & Farewell
                  </button>
                </h2>
    ...
    <div class="slider">
      <div class="slider-container">
        ...
        <div class="slider-item2">
          <div class="silder-pad">
            <div class="slid-img">
              <img class="cus-img" src="assets/img/dubai/image1.jpg" alt="roamers-Gallery">
            </div>
            <div class="cust-inner">
              <h3> </h3>
              <!-- <h2>Black Beach</h2> -->
