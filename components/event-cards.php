...
<div class="upcoming-container" style="margin-top: 100px; max-width: 1500px; margin-left: auto; margin-right: auto;">
    <section class="upcoming-intro" style="margin-bottom: 48px;">
        <div class="upcoming-container" style="max-width: 1700px; margin: 0 auto;">
            <div class="upcoming-intro-flex" style="display: flex; flex-wrap: wrap; gap: 32px;">
                <div class="upcoming-intro-left"
                    style="flex: 1 1 60%; min-width: 280px; background: #fff; border-radius: 18px; box-shadow: 0 2px 16px rgba(76,185,211,0.08); padding: 36px 32px 32px 32px;">
                    <h3 style="margin-top:0; color: #222; font-size: 2rem; font-weight: 800;">Welcome to Our Upcoming
                        Events!</h3>
                    <p style="color: #444; font-size: 1.1rem; margin-bottom: 18px;">
                        Discover a curated selection of exciting trips and adventures. Whether you're looking for a
                        weekend getaway or a week-long exploration, we've got something for everyone.
                    </p>
                    <ul style="padding-left: 20px; color: #333; font-size: 1rem; margin-bottom: 0;">
                        <li>Handpicked destinations</li>
                        <li>Expert guides</li>
                        <li>Flexible packages</li>
                    </ul>
                </div>
                <div class="upcoming-intro-right"
                    style="flex: 1 1 32%; min-width: 520px; background: #fff; border-radius: 18px; box-shadow: 0 2px 16px rgba(76,185,211,0.08); padding: 6px 2px 2px 2px; display: flex; flex-direction: column; align-items: center;">
                    <h4 style="margin-top:0; color: #4CB9D3; font-size: 1.3rem; font-weight: 700;">Why Choose Us?</h4>
                    <ul style="list-style: none; padding: 0; margin: 0 0 18px 0; color: #444; font-size: 1rem;">
                        <li><strong>Trusted by 10,000+ travelers</strong></li>
                        <li style="color:#4CB9D3;">24/7 support</li>
                        <li>Best price guarantee</li>
                    </ul>
                    <img src="assets/img/featured-events.jpg" alt="Featured Events"
                        style="width:100%;max-width:260px;border-radius:12px;margin-top:10px;box-shadow:0 2px 8px rgba(76,185,211,0.10);">
                    <form
                        style="width:100%;max-width:260px;margin-top:18px;display:flex;flex-direction:column;gap:12px;"
                        method="post" action="#">
                        <label for="upcoming-name" style="font-size:1rem;color:#333;font-weight:500;">Name</label>
                        <input type="text" id="upcoming-name" name="upcoming-name" required placeholder="Your Name"
                            style="padding:8px 10px;border-radius:6px;border:1px solid #ddd;font-size:1rem;">
                        <label for="upcoming-number" style="font-size:1rem;color:#333;font-weight:500;">Phone
                            Number</label>
                        <input type="tel" id="upcoming-number" name="upcoming-number" required placeholder="Your Number"
                            style="padding:8px 10px;border-radius:6px;border:1px solid #ddd;font-size:1rem;">
                        <label for="upcoming-pass-type" style="font-size:1rem;color:#333;font-weight:500;">Pass
                            Type</label>
                        <select id="upcoming-pass-type" name="upcoming-pass-type" required
                            style="padding:8px 10px;border-radius:6px;border:1px solid #ddd;font-size:1rem;">
                        ...
                        <button type="submit"
                            style="background:#4CB9D3;color:#fff;border:none;border-radius:6px;padding:10px 0;font-size:1rem;font-weight:600;cursor:pointer;">Enquire
                            Now</button>
                    </form>
                </div>
            </div>
