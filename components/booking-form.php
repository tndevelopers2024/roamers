...
<body>
  ...
  <section class="py-5 payment-banner">
    <div class="container">
       <form action="booking-form1.php" method="POST">
                          ...
                          <div class="row">
                            <div class="col">
                              <div class="row row-cols-1 g-3">
                                ...
                                <div class="col">
                                  <div class="input-field">
                                    <input type="text" name="dob" placeholder="D.O.B" required>
                                  </div>
                                </div>
                              </div>
                              <div class="row">
                              ...
                              <div class="row">
                                <div class="col">
                                  ...
                                  <label for="double">
                                    <input type="radio" name="sharing" id="double" value="Double Sharing" required> Double Sharing
                                  </label>
                                  <label for="triple">
                                    <input type="radio" name="sharing" id="triple" value="Triple Sharing" required> Triple Sharing
                                  </label>
                                </div>
                              </div>
                              <div class="row">
...
<script>
  ...
  nextBtn2.addEventListener("click", (e) => {
    ...
    if (
      ...
      !address1 || !address2 || !city || !postCode || !gender || !sharing
    ) {
    ...
    const tableHTML = `
        ...
        <p><i class="fa-regular fa-user"></i>  ${formData.fullName}</p>
        <p><i class="fa-regular fa-envelope"></i>  ${formData.email}</p>
        <p><i class="fa-solid fa-phone"></i>  ${formData.phone}</p>
        <p><i class="fa-solid fa-calendar-days"></i>  ${formData.dob}</p>
        <p><i class="fa-solid fa-person-hiking"></i>  ${formData.travellerCount}</p>
        <p><i class="fa-solid fa-calendar-check"></i>  ${formData.travelDate}</p>
        <p><i class="fa-solid fa-venus-mars"></i>  ${formData.gender}</p>
        <p><i class="fa-solid fa-handshake"></i>  ${formData.sharing}</p>
        <p><i class="fa-solid fa-location-dot"></i>  ${formData.address1}, ${formData.address2}, ${formData.city}, ${formData.postCode}</p>
      <div class="button-div d-flex justify-content-end mt-4">        
        <button class="book-btn prev-step me-2" id="pre-btn2">Cancel</button>
