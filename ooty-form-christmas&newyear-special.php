...
<head>
  ...
  <style>
    ...
    .background-image {
      ...
      width: 100%;
      height: 100%;
      background: url('assets/optimized-images/ooty-trip/ooty-img-by-roamers (1).avif');
...
<body>
  ...
  <section class="">
    <div class="container">
      <form action="ooty-mail-send-christmas&newyear-special.php" method="POST" autocomplete="off">
  ...
  <script>
    document.addEventListener("DOMContentLoaded", function () {
      fetch("./dynamic/database.json") // Check this path
        ...
        .then(data => {
          const locationKey = "ooty-christmas-new-year";
  ...
  <script>
    document.addEventListener("DOMContentLoaded", function () {
      fetch("./dynamic/database.json") // to change the price ... 
        ...
        .then(data => {
          const locationKey = "ooty-christmas-new-year"; // Change to "ooty" if needed
          const locationData = data[locationKey];
      ...
      if (nextBtn2) {
        nextBtn2.addEventListener("click", (e) => {
          ...
          const confirmationHTML = `
            ...
            <div class="div"><i class="fa-solid fa-plane-departure"></i> <p><b>Trip :</b> Ooty</p></div>
