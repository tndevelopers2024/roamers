...
<style>
    ...
    .card:hover {
        ...
        border-color: rgba(78, 192, 219, 0.3);
...
<body>
    <section id="upcoming">
        <div class="container-fluid">
            <h2 class="head">Upcoming Trips (Version-1)</h2>
                            ...
                            <div class="silder-inner silder-inner1">
                                <div class="card__text">
                                    ...
                                    <div
                                        ...
                                        <h2 class="card__title mb-1 mb-md-0">Valley Of Flowers</h2>
                                        <h4 class="card__description text-muted">
                            ...
                            <div class="silder-inner silder-inner1">
                                <div class="card__text">
                                    ...
                                    <p class="card__description"><i class="fas fa-route me-1"></i>Varkala, Munroe
                                        Island,
                                        Trivandrum</p>
                                    <span class="varkala-dates card__description">Jan 12, Feb 16</span>
                                </div>
                                <div class="card__footer mt-2">
