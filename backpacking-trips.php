...
<head>
  ...
  <meta name="description" content="Embark on unforgettable backpacking trips in chennai with Roamers. Get budget-friendly group
adventures to stunning destinations in India and abroad. Book now!" />
  <meta name="keywords" content="Backpacking trips in chennai, Backpacking trips">
  ...
  <!-- title -->
  <title>Backpacking Trips in Chennai | Explore Group Adventures with Roamers</title>
  <meta name="title" content="Backpacking Trips in Chennai | Explore Group Adventures with Roamers" />
  <link rel="stylesheet" href="https://unpkg.com/swiper/swiper-bundle.min.css" />

   <!-- Canonical URL -->
   <link rel="canonical" href="https://www.roamers.in/backpacking-trips" />
...
======================================== -->
  ...
  <div class=container>
    <ul style="margin-bottom:6rem;" class="nav-pills upper-nav mt-5 ">
      <li><a href="#section1" class=" trip-1 ">ALL</a></li>
      <li><a class="trip-2 active" href="#section2">Backpacking Trips</a></li>
...
<div class="col-12 mt-5 col-lg-4 col-md-6">
 ...
 <div class="col-12 mt-5 col-lg-4 col-md-6">
   <div class="swiper-slide">
     <a href="ladakh-umlingla.php">
       <img src="assets/img/ladakh/ladakh-mail.jpeg" alt="roamers-Gallery">
       <div class="silder-inner silder-inner1">
         <div class="inner inner2">
 ...
 <!-- <div class="col-12 col-lg-4 col-md-6">
   <div class="swiper-slide">
    ...
    <div id="section2 " class="section active mb-5">
      <div class="container mt-5">
        <div class="row">
              ...
              <a href="kodaikanal1">
                ...
                <div class="silder-inner silder-inner1">
                  ...
                  <div class="inner">
                    ...
                    <h4><span id="kodai-back-price">₹8,490</span> </h4>
                  </div>
                </div>
              </a>
            </div>
