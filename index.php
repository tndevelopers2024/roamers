        ...
        <div style="margin-top: 50px; ">
            ...
            $trips_db = [
                ...
                'ooty' => [
                    ...
                    'image' => 'assets/img/Ooty/1-min.jpg',
                    'duration' => '3D/2N',
         ...
         <!-- Desktop Christmas -->
         <div class="d-none d-md-block" style="padding-top: 40px; padding-bottom: 40px;">
          <style>
    .backpacking-img {
...
<div
    ...
    <a href="christmas&newyear.php" class="text-decoration-none" style="text-decoration: none;"><button class="btn btn-primary" style="
        padding: 10px 32px;
        border-radius: 30px;
        font-size: 1.1rem;
        font-weight: 700;
