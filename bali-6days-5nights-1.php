...
<head>
    ...
    <title>Roamers - Bali Trip 6 Days 5 Nights</title>

    <!-- SEO Meta Description -->
    <meta name="description"
        content="Join our Bali trip for an unforgettable adventure. Discover Ubud, Seminyak, Nusa Penida and more with Roamers." />
    ...
    <meta property="og:image"
        content="https://hanhhuonghoasen.com.vn/thumbs/748x706x1/upload/product/du-lich-bali-indonesia-9184.jpg" />
    <meta property="og:url" content="https://roamers.in/bali-6days-5nights-1.php" />
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <img src="https://images.unsplash.com/photo-1518548419970-58e3b4079ab2?auto=format&fit=crop&q=80&w=800"
                                        class="img-fluid w-100" alt="Bali Black Beach"
                                        style="border-radius: 10px; height: 350px; object-fit: cover;">
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="accordion-body" style="background-color: #f5fdff;">
                                            ...
                                            <ul class="ps-lg-3 ps-0">
                                                <li class=""><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                    ...
                                                    Arrival & Comfortable Transfers to Ubud
                                                </li>
                                                <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>Arrive Ubud & Villa check-in
                                                    (leisure)
                                                </li>
                                                <li><i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>Pirachi Art market optional
                                                    visit
                                                </li>
                                                <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>Overnight stay in Ubud
                                                </li>
                                                <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>
                                                    Witness a magical sunset at Bali Beach, the perfect start to your
                                                    adventure.
                                                </li>
                                                <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>
                                ...
                                <div class="accordion-item mb-4 border  overflow-hidden">
                                        ...
                                        <button
                                            ...
                                            <div class="d-flex align-items-center w-100">
                                                <span
                                                    ...
                                                    2</span>
                                                <span>ATV adventures, Coffee & Cretya Club
                                                </span>
                                    ...
                                    <div id="collapseTwo" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body" style="background-color: #f5fdff;">
                                            ...
                                            <ul class="ps-lg-3 ps-0">
                                                <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>Have Delicious breakfast & get
                                                    ready for adventure
                                                </li>
                                                <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>
                                                    ATV ride at Kuber Bali Adventure
                                                <li><i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>Visit coffee plantation (Luwak
                                                    tasting)
                                                </li>
                                                <li><i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>Head to Cretya Ubud: Infinity
                                                    Pools, food, drinks & Music
                                                </li>
                                                <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>Overnight stay in Ubud
                                                </li>
                                        ...
                                        <button
                                            ...
                                            <div class="d-flex align-items-center w-100">
                                                <span
                                                    class="badge bg-primary rounded-pill me-3 px-3 py-2 animated-badge">Day
                                                    3</span>
                                                <span>Transfer to Nusa Penida (Island Stay)</span>
                                                <i class="bi bi-chevron-down ms-auto transition-arrow"
                                                    style="color:#0c63e4;"></i>
                                            </div>
                                        </button>
                                    ...
                                    <div id="collapse3" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body bg-white px-4 py-3">
                                            <ul class="ps-lg-3 ps-0">
                                                <li><i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>
                                                    Morning transfer to port for Island trip
                                                </li>
                                                <li>
                                                    <i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>
                                                    Speedboat trip to Nusa Penida
                                                </li>
                                                <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>
                                                ...
                                                <li><i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>Dinner & Overnight stay in Nusa
                                                    Penida
                                                </li>
                                            </ul>
                                        </div>
                                        ...
                                        <button
                                            ...
                                            <div class="d-flex align-items-center w-100">
                                                <span
                                                    class="badge bg-primary rounded-pill me-3 px-3 py-2 animated-badge">Day
                                                    4</span>
                                                <span> Nusa to Seminyak & Beach life</span>
                                                <i class="bi bi-chevron-down ms-auto transition-arrow"
                                                    style="color:#0c63e4;"></i>
                                            </div>
                                        </button>
                                    ...
                                    <div id="collapse5" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body bg-white px-4 py-3">
                                            <ul class="ps-lg-3 ps-0">
                                                <li><i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>
                                                    Savour Island Breakfast from Nusa
                                                </li>
                                                <li>
                                                    <i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>
                                                    Return to Bali by speedboat
                                                </li>
                                                <li>
                                                    <i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>
                                                    Arrive in Seminyak & Check-in
                                                </li>
                                                <li>
                                                    <i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>
                                                    Leisure day, visit Seminyak Flea market, Seminyak Beach & Sunset
                                                    (Optional Club visit to Potato Head Club, Sauvya, Finns)
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                        ...
                                        <button
                                            ...
                                            <div class="d-flex align-items-center w-100">
                                                <span
                                                    class="badge bg-primary rounded-pill me-3 px-3 py-2 animated-badge">Day
                                                    5</span>
                                                <span> Water Adventures | Beach & chill</span>
                                                <i class="bi bi-chevron-down ms-auto transition-arrow"
                                                    style="color:#0c63e4;"></i>
                                            </div>
                                        </button>
                                    ...
                                    <div id="collapse6" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body bg-white px-4 py-3">
                                            <ul class="ps-lg-3 ps-0">
                                                <li><i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>
                                                    Have Relaxing breakfast
                                                </li>
                                                <li>
                                                    <i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>
                                                    Visit Tanjung Benoa Beach for Water Adventures
                                                </li>
                                                <li>
                                                    <i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>
                                                    Jet Ski, Banana Boat, Parasailing etc.
                                                </li>
                                                <li>
                                                    <i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>
                                                    Enjoy Spa evenings, cafe hopping & leisure
                                                </li>
                                                <li>
                                                    <i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>
                                        ...
                                        <button
                                            ...
                                            <div class="d-flex align-items-center w-100">
                                                <span
                                                    class="badge bg-primary rounded-pill me-3 px-3 py-2 animated-badge">Day
                                                    6</span>
                                                <span> Departure & Happy Memories</span>
                                                <i class="bi bi-chevron-down ms-auto transition-arrow"
                                                    style="color:#0c63e4;"></i>
                                            </div>
                                        </button>
                                        ...
                                        <div class="accordion-body bg-white px-4 py-3">
                                            <ul class="ps-lg-3 ps-0">
                                                ...
                                                <li>
                                                    <i class="fa-regular fa-circle-dot  me-2 icon-blue mb-3"
                                                        style="font-size: 0.65rem;"></i>
                                                    Bid Farewell and leave with Beautiful memories
                                                </li>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="price-sticky" style="position: sticky;">
                            <div class="priceCard shadow" style="border-radius: 10px;">
                                <img src="https://images.unsplash.com/photo-1537996194471-e657df975ab4?auto=format&fit=crop&q=80&w=600"
                                    alt="Bali Banner" style=" object-fit:cover; border-radius: 10px;">
                            </div>
