...
======================================== -->
  ...
  <section class="form-home">
    ...
    <ul class="banner-nav">
      ...
      <li class="locate"><a href="ooty">Ooty The Queen of Hills</a></li>
      <li>Booking</li>
    </ul>
  </section>
  ...
  <section class=" form-content-holder">
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-8">
          <form enctype="multipart/form-data" class="form" id="booking-form" action="varkala-contact.php" method="POST">
            ...
            <div class="column">
              ...
              <!-- <div class="check-box">
                <label>
                  <input type="radio" name="traval-date" checked id="traval-date" value="JAN 11">JAN 11
                </label>
              </div>
              ...
              <div class="check-box">
                <label>
                  <input type="radio" name="traval-date" id="traval-date" value="FEB 21">FEB 21
                </label>
              </div> -->

              <div class="check-box">
                <label>
                  <input type="radio" name="traval-date" id="traval-date" value="MAR">MAR 07
                </label>
              </div>
              <!-- <div class="check-box">
                <label>
                  <input type="radio" name="traval-date" id="traval-date" value="MAR 13">MAR 13
                </label>
              </div> -->
            ...
            <div class="gender-box">
              ...
              <div class="gender-option">
                <div class="sharing">
                  <input type="radio" id="chennai1" value="Chennai" name="pickdrop" />
                  <label for="chennai1">Chennai</label>
                </div>
                <div class="sharing">
                  <input type="radio" checked id="covai1" value="Direct Trivandrum" name="pickdrop" />
                  <label for="covai1">Direct Trivandrum</label>
                </div>
              </div>
            </div>
