...
<head>
  ...
  <title>Roamers - Kenya(Form)</title> <!-- SEO Meta Description -->
  <!-- SEO Meta Description -->
  <meta name="description" content="Roamers - Kenya(Form)" />
  <meta name="author" content="Themeland" />
  <meta property="og:image:width" content="700" />
  <meta property="og:image:height" content="500" />

  <!-- Basic Open Graph tags -->
  <meta property="og:title" content="Roamers - Kenya(Form)" />
  <meta property="og:description"
    content="Explore the Kenya Islands with Roamers – your ultimate guide to pristine beaches, adventure activities, and unforgettable group travel experiences." />
  <meta property="og:image" content="https://roamers.in/assets/img/Kenya/Media/overview-2.jpg" />
  <meta property="og:url" content="https://roamers.in/assets/img/Kenya/Media/overview-2.jpg" />
  <meta property="og:type" content="website" />
  <meta name="twitter:card" content="summary_large_image" />
  <meta name="twitter:title" content="Roamers - Kenya(Form)" />
  <meta name="twitter:description"
    content="Explore the Kenya Islands with Roamers – your ultimate guide to pristine beaches, adventure activities, and unforgettable group travel experiences." />
  <meta name="twitter:image" content="https://roamers.in/assets/img/Kenya/Media/overview-2.jpg" />
  <!-- Title  -->
  ...
  <style>
    ...
    .background-image {
      ...
      width: 100%;
      height: 100%;
      background: url('assets/img/Kenya/Media/overview-2.jpg');
...
<body>
  ...
  <section class="">
    <div class="container">
      <form action="kenya-mail-send.php" method="POST" autocomplete="off">
  ...
  <script>
    document.addEventListener("DOMContentLoaded", function () {
      fetch("./dynamic/database.json") // to change the price ... 
        ...
        .then(data => {
          const locationKey = "Kenya"; // Change to "ooty" if needed
          const locationData = data[locationKey];
  ...
  <script>
    fetch('./dynamic/database.json')
      ...
      .then(data => {
        ...
        populateDates('Kenya'); // or populateDates('ooty');
      })
      .catch(error => console.error('Error fetching data:', error));
  </script>
      ...
      if (nextBtn2) {
        nextBtn2.addEventListener("click", (e) => {
          ...
          fetch('./dynamic/database.json')
            .then(response => response.json())
            .then(data => {
              const KenyaPrices = data.Kenya.costing.prices;
              const priceObj = KenyaPrices.find(p => p.sharing === sharing);
              if (priceObj) {
              ...
              const confirmationHTML = `
                ...
                <div class="div"><i class="fa-solid fa-plane-departure"></i> <p><b>Trip :</b> Kenya</p></div>
