...
<body>
            ...
            <div class="col">
              <div class="enhanced-box">
                ...
                <div>
                  ...
                  <div class="info-value spiti-price"><span>/-</span></div>
                </div>
              </div>
            </div>
            ...
            <div class="col">
              <div class="enhanced-box">
                ...
                <div>
                  ...
                  <div class="info-value">Delhi / Manali</div>
                </div>
              </div>
            </div>
        ...
        <div class="row g-4 flex-column-reverse flex-md-row align-items-center">
          ...
          <div class="col-md-7">
            <div class="travel-des p-3 p-md-4">
              <h2 class="mb-3 pt-3">Welcome to the world of Spiti Chandratal!</h2>

              <!-- Desktop description -->
              <p style="color: #555;" class="desk-desc d-none d-md-block">
                This isn't just a trek — it's a journey through the roof of the world! Spiti Valley and Chandratal Lake
                offer some of the most breathtaking landscapes on Earth. Raw, rugged, and remote — Spiti is where
                adventure-seekers and soul-searchers unite. Ride through high-altitude passes, explore ancient Buddhist
                monasteries, and camp beside the magical Chandratal Lake under a billion stars.
              </p>
              ...
              <p style="color: #555;" class="mob-desc d-block d-md-none">
                ...
                <span id="moreText" style="display: none;"><br><br>
                  From crossing the mighty Rohtang Pass to camping at the surreal Chandratal Lake, every moment of this
                  trek is etched in memory. Explore Key Monastery, Kaza town, and the stunning Pin Valley along the way.
                </span>
              </p>
              ...
              <div onclick="toggleReadMore()"
                ...
                <span id="readMoreBtn" class="read-more-icon" style="cursor: pointer;">
                  <i class="fa-solid fa-circle-chevron-down shadow"
                    style="color: #4ec0db; background-color:rgb(255, 255, 255); font-size: 16px; width: 30px; height: 30px; display: flex; align-items: center; justify-content: center; border-radius: 50%; margin-top: 5px;">
                  </i>
                </span>
              </div>
            </div>
              ...
              <div class="accordion" id="accordionExample">
                ...
                <div class="accordion-item mb-4 border-0 overflow-hidden rounded-4">
                  <h2 class="accordion-header" id="headingDay1">
                    <button class="accordion-button text-dark fw-bold d-flex justify-content-between align-items-center"
                      type="button" data-bs-toggle="collapse" data-bs-target="#collapseDay1" aria-expanded="true"
          ...
          <div class="col-md-4">
            <div class="price-sticky" style="position: sticky; margin-top:55px">
              ...
              <div id="form" class="shadow"
                ...
                <form>
                  <h3 style="text-align: center; margin-bottom: 30px; color: #333;">Let's Map Your Dream Trek</h3>
                  <div class="input-field mb-3">
                    ...
                    <input placeholder="Your Name" type="text" id="name" name="name" required
                      style="width: 100%; padding: 12px; margin-bottom: 10px; border-radius: 30px; border: 1px solid #ccc; font-size: 14px;">
                  </div>
                  <div class="input-field mb-3">
                  ...
                  <div class="input-field mb-3">
                    ...
                    <input placeholder="Your Phone Number" type="tel" id="phone" name="phone" required
                      style="width: 100%; padding: 12px; margin-bottom: 20px; border-radius: 30px; border: 1px solid #ccc; font-size: 14px;">
                  </div>
                  <div class="trip-form p-0">
  ...
  <!-- <section class="scroll-section">
    ...
    <div class="swiper-container two">
      <div class="swiper-wrapper">
        <div class="swiper-slide"><div class="slider-image"><img src="assets/img/spiti/spiti1.jpg" alt="Spiti 1"></div></div>
        <div class="swiper-slide"><div class="slider-image"><img src="assets/img/spiti/spiti2.jpg" alt="Spiti 2"></div></div>
        <div class="swiper-slide"><div class="slider-image"><img src="assets/img/spiti/spiti3.jpg" alt="Spiti 3"></div></div>
        <div class="swiper-slide"><div class="slider-image"><img src="assets/img/spiti/spiti4.jpg" alt="Spiti 4"></div></div>
        <div class="swiper-slide"><div class="slider-image"><img src="assets/img/spiti/spiti5.jpg" alt="Spiti 5"></div></div>
        <div class="swiper-slide"><div class="slider-image"><img src="assets/img/spiti/spiti6.jpg" alt="Spiti 6"></div></div>
      </div>
        ...
        <div class="accordion" id="accordionFlushExample">
          ...
          <div class="accordion-item mb-4 border overflow-hidden" style="border-radius: 10px;">
            <h2 class="accordion-header" id="faqOne">
              <button class="accordion-button collapsed text-dark fw-bold d-flex justify-content-between align-items-center"
                type="button" data-bs-toggle="collapse" data-bs-target="#faqCollapseOne" aria-expanded="false">
            ...
            <div id="faqCollapseOne" class="accordion-collapse collapse show" aria-labelledby="faqOne"
              ...
              <div class="accordion-body bg-white px-4 py-3">
                <p style="font-size: 0.875rem; margin-bottom: 0;">Absolutely! Whether you're joining solo, with friends,
                  or as a couple, these group trips are designed to accommodate all types of travelers. Join us for budget-friendly adventures and check off more items from your bucket list!</p>
              </div>
            </div>
          </div>
          ...
          <div class="accordion-item mb-4 border overflow-hidden" style="border-radius: 10px;">
            <h2 class="accordion-header" id="faqTwo">
              <button class="accordion-button collapsed d-flex justify-content-between align-items-center text-dark fw-bold"
                type="button" data-bs-toggle="collapse" data-bs-target="#faqCollapseTwo" aria-expanded="false">
                <span class="ms-3" style="font-size: 1rem;">Is this trek suitable for beginners?</span>
                <i class="fa-solid fa-chevron-down d-block"></i>
              </button>
            </h2>
          ...
          <div class="accordion-item mb-4 border overflow-hidden" style="border-radius: 10px;">
            <h2 class="accordion-header" id="faqThree">
              <button class="accordion-button collapsed d-flex justify-content-between align-items-center text-dark fw-bold"
                type="button" data-bs-toggle="collapse" data-bs-target="#faqCollapseThree" aria-expanded="false">
                <span class="ms-3" style="font-size: 1rem;">What is the best time to visit Spiti & Chandratal?</span>
                <i class="fa-solid fa-chevron-down d-block"></i>
              </button>
            </h2>
            <div id="faqCollapseThree" class="accordion-collapse collapse" aria-labelledby="faqThree"
              data-bs-parent="#accordionFlushExample">
              <div class="accordion-body bg-white px-4 py-3">
                <p style="font-size: 0.875rem; margin-bottom: 0;">The best time to visit is from June to September, when the roads are open and the weather is pleasant. Chandratal Lake is accessible only during this window, making it the ideal season for this trek.</p>
              </div>
            </div>
          </div>
          ...
          <div class="accordion-item mb-4 border overflow-hidden" style="border-radius: 20px;">
            <h2 class="accordion-header" id="faqFour">
              <button class="accordion-button collapsed d-flex justify-content-between align-items-center text-dark fw-bold"
                type="button" data-bs-toggle="collapse" data-bs-target="#faqCollapseFour" aria-expanded="false">
                <span class="ms-3" style="font-size: 1rem;">How do I confirm my booking?</span>
                <i class="fa-solid fa-chevron-down d-block"></i>
              </button>
            </h2>
          ...
          <div class="accordion-item mb-4 border overflow-hidden" style="border-radius: 10px;">
            <h2 class="accordion-header" id="faqFive">
              <button class="accordion-button collapsed d-flex justify-content-between align-items-center text-dark fw-bold"
                type="button" data-bs-toggle="collapse" data-bs-target="#faqCollapseFive" aria-expanded="false">
            ...
            <div id="faqCollapseFive" class="accordion-collapse collapse" aria-labelledby="faqFive"
              data-bs-parent="#accordionFlushExample">
              <div class="accordion-body bg-white px-4 py-3">
                <p style="font-size: 0.875rem; margin-bottom: 0;">Yes, female solo travelers can confidently join our group trips. We prioritize safety with trusted trek captains, verified hosts, and reliable transport vendors. Your safety is our top priority.</p>
              </div>
            </div>
          </div>
  ...
  <script>
    ...
    function toggleReadMore() {
      ...
      if (moreText.style.display === 'none' || moreText.style.display === '') {
        ...
        readMoreBtn.innerHTML = `<i class="fa-solid fa-circle-chevron-up shadow" style="color: #4ec0db; background-color:rgb(255, 255, 255); font-size: 16px; width: 30px; height: 30px; display: flex; align-items: center; justify-content: center; border-radius: 50%; margin-top: 0px;"></i>`;
      } else {
        moreText.style.display = 'none';
        readMoreBtn.innerHTML = `<i class="fa-solid fa-circle-chevron-down shadow" style="color: #4ec0db; background-color:rgb(255, 255, 255); font-size: 16px; width: 30px; height: 30px; display: flex; align-items: center; justify-content: center; border-radius: 50%; margin-top: 0px;"></i>`;
      }
    }
  </script>
  ...
  <script>
    ...
    images.forEach((_, i) => {
      ...
      dot.style.opacity = "0";
      dot.addEventListener("click", () => { changeImage(i); resetInterval(); });
      dotContainer.appendChild(dot);
      setTimeout(() => { dot.style.transition = "opacity 0.3s ease"; dot.style.opacity = "1"; }, i * 100);
    });
    ...
    function nextImage() { const nextIndex = (index + 1) % images.length; changeImage(nextIndex); }
    function startInterval() { interval = setInterval(nextImage, 5000); }
