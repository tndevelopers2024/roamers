...
<head>
  ...
  <title>Roamers - Spiti Chandratal Trek: High-Altitude Adventure to Chandratal Lake</title>
...
<body>
            ...
            <section id="inclusion">
              <div class="important-notes shadow" style="border-radius: 30px; background-color:rgb(245, 255, 246);">
                ...
                <div>
                  ...
                  <p><i class="fa-solid fa-circle-check me-2 pulse" style="color: green;"></i>Meals:</p> <br>
                  <p><i class="fa-solid fa-circle-check me-2 pulse" style="color: green;"></i>– Breakfast from Day 2 to Day 7</p>
                  <p><i class="fa-solid fa-circle-check me-2 pulse" style="color: green;"></i>– Dinner from Day 1 to Day 6</p>
  ...
  <script>
    ...
    const images = ["https://images.unsplash.com/photo-1691735214703-310c6594c6a8?q=80&w=2673&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"];
