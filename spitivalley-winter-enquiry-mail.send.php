...
<body>
    <div class="thankyou-card">
        <div class="icon">&#10003;</div>
        <h1>All Set!</h1>
        <p>Thanks <strong><?php echo htmlspecialchars($post_data['name']); ?></strong>! Your enquiry has been received. Our team will contact you shortly.</p>
    ...
    header("Location: spitivalley-winter-enquiry-form.php");
    exit();
}
?>