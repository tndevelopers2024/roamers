...
======================================== -->
  ...
  <section class=" form-content-holder">
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-8">
          <form enctype="multipart/form-data" class="form" id="booking-form" action="ooty-contact.php" method="POST">
            ...
            <div class="column">
              ...
              <div class="check-box">
                <label>
                  <input type="radio" name="traval-date" id="traval-date" value="NOV 22">NOV 22
                </label>
              </div>

              <div class="check-box">
                <label>
                  <input type="radio" name="traval-date" id="traval-date" value="DEC 06">DEC 06
                </label>
              </div>

              <div class="check-box">
                <label>
                  <input type="radio" name="traval-date" id="traval-date" value="DEC 21">DEC 21
                </label>
              </div>

              <div class="check-box">
                <label>
                  <input type="radio" name="traval-date" id="traval-date" value="DEC 29">DEC 29
                </label>
              </div>

              <!-- <div class="check-box">
                <label>
                  <input type="radio" name="traval-date" id="traval-date" value="JAN 10">JAN 10
                </label>
              </div> -->
            ...
            <div class="gender-box">
              ...
              <div class="gender-option">
                ...
                <div class="sharing">
                  <input type="radio" checked id="covai1" value="Coimbatore" name="pickdrop" />
                  <label for="covai1">Coimbatore</label>
                </div>
              </div>
            </div>
