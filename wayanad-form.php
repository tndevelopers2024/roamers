        ...
        <div class="col-md-8">
          <form enctype="multipart/form-data" class="form" id="booking-form" action="wayanad-contact.php" method="POST">
            ...
            <div class="column">
              <div class="check-box">
                <label>
                  <input type="radio" checked name="traval-date" id="traval-date" value="NOV 14">NOV 14
                </label>
              </div>
              <div class="check-box">
                <label>
                  <input type="radio" name="traval-date" id="traval-date" value="DEC 25">DEC 25
                </label>
              </div>
            ...
            <div class="gender-box">
              ...
              <div class="gender-option">
                ...
                <div class="sharing">
                  <input type="radio" checked id="covai1" value="Direct Wayanad" name="pickdrop" />
                  <label for="covai1">Direct Wayanad</label>
                </div>
              </div>
            </div>
