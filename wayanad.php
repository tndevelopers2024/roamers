  ...
  <main>
              ...
              <div class="col">
                <div class="enhanced-box">
                  ...
                  <div>
                    ...
                    <div class="info-value">Direct Wayanad / Chennai</div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-md-8">
                    ...
                    <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                      ...
                      <div class="accordion-body" style="background-color: #f5fdff;">
                        <ul class="ps-lg-3 ps-0">
                          ...
                          <li>
                            <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>
                            Overnight journey: We’ll travel from Chennai to Bangalore (Sleeper A/C Bus)
                          </li>
                          <li>
                            <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>
                    ...
                    <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                      ...
                      <div class="accordion-body" style="background-color: #f5fdff;">
                        ...
                        <ul class="ps-lg-3 ps-0">
                          ...
                          <li>
                            <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3" style="font-size: 0.65rem;"></i>
                            Relish a delicious dinner with the team and overnight stay at Resort.
                          </li>
                        </ul>
                      </div>
                    </div>
              ...
              <div class="important-notes shadow" style="border-radius: 30px; background-color: rgb(255, 244, 244);"
                ...
                <div>
                  ...
                  <p>
                    <i class="fa-solid fa-circle-xmark me-2 pulse" style="color: #ff6b6b;"></i>
                    Personal Expenses like shopping and for other optional activities like Kayaking or zipline.
                  </p>
                  <p>
                    <i class="fa-solid fa-circle-xmark me-2 pulse" style="color: #ff6b6b;"></i>
    ...
    <!-- <section class="scroll-section">
      ...
      <div class="swiper-container two">
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide">
            <div class="slider-image">
              <img src="assets\optimized-images\wayand-trip\wayand-img-by-roamers (2).avif" alt="Sri Lanka 3">
            </div>
          </div>
          <div class="swiper-slide">
            <div class="slider-image">
    ...
    <div class="mobile-bottom-bar">
      <div class="bottom-bar-content">
        ...
        <a href="wayanad-form.php" class="btn-book">Dates & Costing</a>
      </div>
    </div>
