    ...
    <section class="scroll-section">
      ...
      <div class="swiper-container two">
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide">
            <div class="slider-image">
              <img src="assets\optimized-images\wayand-trip\wayand-img-by-roamers (5).avif" alt="Sri Lanka 3">
            </div>
          </div>
          <div class="swiper-slide">
            <div class="slider-image">
              <img src="assets\optimized-images\wayand-trip\wayand-img-by-roamers (6).avif" alt="Sri Lanka 3">
            </div>
          </div>
          <div class="swiper-slide">
            <div class="slider-image">
              <img src="assets\optimized-images\wayand-trip\wayand-img-by-roamers (7).avif" alt="Sri Lanka 3">
            </div>
          </div>
          <div class="swiper-slide">
            <div class="slider-image">
              <img src="assets\optimized-images\wayand-trip\wayand-img-by-roamers (8).avif" alt="Sri Lanka 4">
            </div>
          </div>
        </div>
