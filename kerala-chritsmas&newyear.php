                            ...
                            <div class="col">
                                <div class="enhanced-box">
                                    ...
                                    <div>
                                        ...
                                        <div class="info-value "><span>₹16,990 /-</span></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col">
                                <div class="enhanced-box">
                                    ...
                                    <div>
                                        ...
                                        <div class="info-value">Kochi / Chennai</div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row text-center">
                            ...
                            <div class="col-7 px-0" style="border-left:1px solid #cbc9c9;">
                                <div class="enhanced-box">
                                    ...
                                    <div>
                                        <div class="info-label">Pickup & Drop</div>
                                        <div class="info-value">Kochi / Chennai
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-7">
                            <div class="travel-des p-3 p-md-4">
                                ...
                                <p style="color: #555;" class="desk-desc d-none d-md-block">
                                    Hey, folks! Get ready for our Kerala backpacking extravaganza! We'll kick off in the
                                    Vagamon Hills with epic paragliding, trek to Waterfalls and under star campfires,
                                    But hold onto your flip-flops because we're not done yet! We'll be heading to the
                                    laid-back vibes of Varkala for beachfront bliss, explore mangroves, and visit the
                                    world's largest sculpture, Jatayu Finally, it's off to Alleppey
                                    <br><br>
                                    to experience its mesmerizing backwater beauty, and unique boathouse stay and
                                    delicious Kerala cuisine. More surprises await as we explore 'God's Own Country' for
                                    unforgettable moments and good times! 🌴🌊🌟
                                </p>
                                ...
                                <p style="color: #555;" class="mob-desc d-block d-md-none">
                                    ...
                                    Vagamon Hills with epic paragliding, trek to Waterfalls and under star campfires,
                                    But hold onto your flip-flops because we're not done yet! We'll be heading to the
                                    laid-back vibes of Varkala for
                                    beachfront bliss, explore mangroves, and visit the world's largest sculpture, Jatayu
                                    Finally, it's off to Alleppey
                                    <br>
                                    <span id="dots">...</span>
                                    <span id="moreText" style="display: none;"><br><br>
                                        to experience its mesmerizing backwater beauty, and unique boathouse stay and
                                        delicious Kerala cuisine. More surprises await as we explore 'God's Own Country'
                                        for unforgettable moments and good times! 🌴🌊🌟
                                    </span>
                                </p>
                            ...
                            <div class="swiper miniSlider px-px-md-0 py-3">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <img src="assets/img/Kerala/Kerala-photos.jpg" class="img-fluid w-100"
                                            alt="Wayanad"
                                            style="border-radius: 10px; height: 350px; object-fit: cover;">
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="assets/img/Kerala/Kerala-backwater-village.jpg"
                                            class="img-fluid w-100" alt="Wayanad"
                                            style="border-radius: 10px; height: 350px; object-fit: cover;">
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <button
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <span class="badge bg-primary rounded-pill me-3 px-3 py-2">Day
                                                        1</span>
                                                    <span>Depart from Kochi | Athirapally Falls & Munnar Arrival
                                                    </span>
                                                </div>
                                            ...
                                            <div class="accordion-body" style="background-color: #f5fdff;">
                                                <ul class="ps-lg-3 ps-0">
                                                    <li>
                                                        ...
                                                        Hey Roamers, welcome to Kerala! Meet our trip lead, other
                                                        travellers and by <strong>10:00 AM </strong>let’s begin our
                                                        adventure to Munnar
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        Enroute, we’ll visit the mighty <strong>Athirapally
                                                            Waterfalls</strong> , Kerala’s
                                                        own “Bahubali Falls.”
                                                    ...
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        Continue the scenic drive to <strong>Munnar</strong> through
                                                        spice valleys and
                                                        tea-covered hills.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        Reach Munnar by evening, check in, and unwind.

                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        If time permits, let’s visit the <strong>hidden
                                                            waterfalls</strong> nearby before we settle in for the
                                                        night.
                                                    ...
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        Let’s end the day with a campfire, <strong> local food, stories,
                                                            laughter
                                                            and good music</strong> under the stars.
                                            ...
                                            <button
                                                ...
                                                <div class="d-flex align-items-center w-100">
                                                    <span
                                                        ...
                                                        2</span>
                                                    <span> Munnar Local Exploration</span>
                                            ...
                                            <div class="accordion-body" style="background-color: #f5fdff;">
                                                ...
                                                <ul class="ps-lg-3 ps-0">
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        Let’s have a delish breakfast and begin our exploration.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        First, let’s visit <strong> Mattupetty Dam,</strong> calm waters
                                                        surrounded by
                                                        rolling tea gardens.
                                                    ...
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        Go for <strong>Speed Boating</strong> across the lake, a
                                                        thrill-meets-chill
                                                        moment or simply relax near the tranquil atmosphere.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        Let’s stop at <strong>Echo Point</strong> , a stunning nature
                                                        spot where the lake
                                                        echoes over the hills. Try <strong>Kayaking</strong> if
                                                        interested here.
                                                    ...
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        Next up, we’ll visit <strong>Kundala Lake</strong> , a peaceful
                                                        stream to capture
                                                        the picture-perfect moment with nature.

                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        Time to grab some <strong>tea bags and spices</strong> Roamers!
                                                        get ready to shop
                                                        for souvenirs for your loved ones.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        Return to the hotel, and it’s time for group dinner and an
                                                        overnight stay in the chill hills of Munnar.
                                            ...
                                            <button
                                                ...
                                                <div class="d-flex align-items-center w-100">
                                                    <span
                                                        class="badge bg-primary rounded-pill me-3 px-3 py-2 animated-badge">Day
                                                        3</span>
                                                    <span>Zipline | Thekkady’s Cultural Show & Elephants</span>
                                                    <i class="bi bi-chevron-down ms-auto transition-arrow"
                                                        style="color:#0c63e4;"></i>
                                                </div>
                                            </button>
                                            ...
                                            <div class="accordion-body bg-white px-4 py-3">
                                                <ul class="ps-lg-3 ps-0">
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        After breakfast, it’s time for a road trip to
                                                    ...
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        On the way, we’ll stop for some adrenaline <strong> Ziplining &
                                                            Giant
                                                            Swing </strong>
                                                        in the Munnar mountains. A must-try adventure! (self-pay)
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        Arrive in Thekkady by evening and check in.

                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        Visit the <strong>Elephant Camp </strong> to feed, bathe, and
                                                        interact with these
                                                        gentle giants.
                                                    ...
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        Later, let’s witness Kerala’s cultural heartbeat at the
                                                        <strong>Kathakali</strong> or <strong>Kalaripayattu</strong>
                                                        show.
                                                    ...
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        End the night with <strong>dinner, stories, and relaxed
                                                            vibes</strong> with our
                                                        dear Roamers!
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        <strong>Overnight stay in Thekkady.</strong>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                            ...
                                            <button
                                                ...
                                                <div class="d-flex align-items-center w-100">
                                                    <span
                                                        class="badge bg-primary rounded-pill me-3 px-3 py-2 animated-badge">Day
                                                        4</span>
                                                    <span>Thekkady Jeep Safari | Houseboat & Farewell Dinner</span>
                                                    <i class="bi bi-chevron-down ms-auto transition-arrow"
                                                        style="color:#0c63e4;"></i>
                                                </div>
                                            </button>
                                            ...
                                            <div class="accordion-body bg-white px-4 py-3">
                                                <ul class="ps-lg-3 ps-0">
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        Rise early for an exciting <strong>Jeep Safari</strong> through
                                                        <strong>Periyar Tiger
                                                            Reserve</strong> — wild trails, misty forests, and animal
                                                        spotting await.
                                                    ...
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        After breakfast, start the drive to <strong>Alleppey</strong> ,
                                                        Kerala’s Venice of
                                                        the East.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        Let’s check in to our <strong>private Houseboat</strong> , a
                                                        relaxing and
                                                        wholesome day awaits!

                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        We’ll cruise through <strong>Backwater canals</strong> , passing
                                                        by palm trees,
                                                        fishermen, and floating villages.

                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        Enjoy tea and Kerala snacks onboard and watch the
                                                        <strong>sunset</strong> paint
                                                        the water gold.
                                                    ...
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        Spend the night with slow music, celebrations, and a
                                                        <strong>Farewell
                                                            Dinner</strong> , a traditional Kerala meal cooked fresh and
                                                        local.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        Let’s retire for the day in the houseboat, floating in the
                                            ...
                                            <button
                                                ...
                                                <div class="d-flex align-items-center w-100">
                                                    <span
                                                        class="badge bg-primary rounded-pill me-3 px-3 py-2 animated-badge">Day
                                                        5</span>
                                                    <span>Alleppey to Kochi | Fort Kochi & Return</span>
                                                    <i class="bi bi-chevron-down ms-auto transition-arrow"
                                                        style="color:#0c63e4;"></i>
                                                </div>
                                            </button>
                                            ...
                                            <div class="accordion-body bg-white px-4 py-3">
                                                <ul class="ps-lg-3 ps-0">
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        Wake up to the sound of gentle ripples and fresh backwater air.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        After breakfast, check out from your Houseboat.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        Bid bye to Alleppey and let’s head to Famous <strong>Fort
                                                            Kochi</strong>
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        Explore the vibrant streets filled with Boutiques and cafés.
                                                    </li>
                                                    <li>
                                                        <i class="fa-regular fa-circle-dot me-2 icon-blue mb-3"
                                                            style="font-size: 0.65rem;"></i>
                                                        Our day ends in Kochi by evening. <strong></strong> Bye-bye
                                                        Roamers!
                                                    </li>
                                                </ul>
                                            </div>
                                ...
                                <div class="important-notes shadow"
                                    ...
                                    <div>
                                        <p>
                                            ...
                                            All local sightseeing & transfers by AC Tempo Traveller/Cab (as per group size) from 9 AM – 6 PM.
                                        </p>
                                        <p>
                                            <i class="fa-solid fa-circle-check me-2 pulse" style="color: #1fa463;"></i>
                                        ...
                                        <p>
                                            <i class="fa-solid fa-circle-check me-2 pulse" style="color: #1fa463;"></i>
                                            Enries for sightseeing
                                        </p>
                                        <p>
                                            <i class="fa-solid fa-circle-check me-2 pulse" style="color: #1fa463;"></i>
                                            Accommodation on sharing basis: 2N Munnar, 1N Thekkady & 1N Alleppey (Deluxe Houseboat with AC from 6 PM – 6 AM).

                                        </p>
                                        <p>
                                            <i class="fa-solid fa-circle-check me-2 pulse" style="color: #1fa463;"></i>
                                            Meals: Daily breakfast from Day 2 to Day 5 + 1 lunch & 2 Dinner
                                        </p>
                                        <p>
                                            <i class="fa-solid fa-circle-check me-2 pulse" style="color: #1fa463;"></i>
                                            Airport pick-up & drop at fixed timings.
                                        </p>
                                        <p>
                                            <i class="fa-solid fa-circle-check me-2 pulse" style="color: #1fa463;"></i>
                                            Trip assistance throughout with experienced drivers.
                                        </p>
                                        <p>
                                            <i class="fa-solid fa-circle-check me-2 pulse" style="color: #1fa463;"></i>
                                            Driver allowances, tolls, parking & state taxes included.
                                        </p>
                                        <p>
                                            <i class="fa-solid fa-circle-check me-2 pulse" style="color: #1fa463;"></i>
                                            Note: AC will remain switched off in hilly areas.
                                        </p>
                            ...
                            <div class="important-notes shadow"
                                ...
                                <div>
                                    <p>
                                        ...
                                        Meals or stay not mentioned in the inclusions.
                                    </p>
                                    <p>
                                        <i class="fa-solid fa-circle-xmark me-2 pulse" style="color: #ff6b6b;"></i>
                                        Personal expenses like Shopping, laundry, tips, upgrades, room heaters, etc.
                                    </p>
                                    <p>
                                        <i class="fa-solid fa-circle-xmark me-2 pulse" style="color: #ff6b6b;"></i>
                                        Activities such as Boating, Zipline etc & optional tours.
                                    </p>
                                    <p>
                                        <i class="fa-solid fa-circle-xmark me-2 pulse" style="color: #ff6b6b;"></i>
                                        Extra costs due to natural calamities, landslides, delays, or roadblocks.
                                    </p>
                                    <p>
                                        <i class="fa-solid fa-circle-xmark me-2 pulse" style="color: #ff6b6b;"></i>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="price-sticky" style="position: sticky;">
                                ...
                                <div class="priceCard shadow" style="border-radius: 10px;">
                                    <img src="assets\optimized-images\wayand-trip\wayand-img-by-roamers (4).avif"
                                        alt="Wayanad Banner" style=" object-fit:cover; border-radius: 10px;">
                                </div>
                                    ...
                                    <div class="p-2">
                                        ...
                                        <div class="inner-box"
                                            ...
                                            <h5 class="special-offer">
                                                ...
                                                <span class="new-price"></span><span class="new-price">₹16,990 /-</span>
                                            </h5>

                                            <p>perfect for group adventures and shared <br> memories.</p>
                                            <div class="trip-form p-0">
                                                <a href="kerala-form-chritsmas-newyear.php"
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="slider-image">
                            <img src="assets/img/Kerala/places-to-visit-in-vagamon-FEATURE-compressed.jpg"
                                alt="Sri Lanka 1">
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="slider-image">
                            <img src="assets/img/Kerala/Paraglyding.jpg" alt="Sri Lanka 3">
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="slider-image">
                            <img src="assets/img/Kerala/jatayu.jpg" alt="Sri Lanka 3">
                        </div>
                    </div> -->
                    <!-- <div class="swiper-slide">
            <div class="slider-image">
              <img src="assets/img/Kerala/Kerala%20photos.jpg" alt="Sri Lanka 3">
            </div>
          </div> -->
                    <!-- <div class="swiper-slide">
            <div class="slider-image">
              <img src="assets/img/Kerala/black-beach.jpg" alt="Sri Lanka 3">
            </div>
          </div> -->
                    <!-- <div class="swiper-slide">
                        <div class="slider-image">
                            <img src="assets/img/Kerala/marmala.jpg" alt="Sri Lanka 3">
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="slider-image">
                            <img src="assets/img/Kerala/f5.jpg" alt="Sri Lanka 4">
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="slider-image">
                            <img src="assets/img/Kerala/cliffs.jpg" alt="Sri Lanka 4">
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="slider-image">
                            <img src="assets/img/Kerala/meadows.jpg" alt="Sri Lanka 4">
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="slider-image">
                            <img src="assets/img/Kerala/pine-forest.jpg" alt="Sri Lanka 4">
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="slider-image">
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="rewind-card">
                            <img src="assets/img/Kerala/places-to-visit-in-vagamon-FEATURE-compressed.jpg" alt="Sri Lanka 1">
                        </div>
                    </div>
            ...
            <div class="bottom-bar-content">
                <div class="price-box ">
                    ...
                    <div class="price-info">
                        <span class="price-amount ">₹16,990 /-</span>
                        <span class="per-person">(Per Person)</span>
                    </div>
                </div>
                <a href="kerala-form-chritsmas-newyear.php" class="btn-book">Dates & Costing</a>
            </div>
        </div>
