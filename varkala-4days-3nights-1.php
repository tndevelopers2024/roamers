...
<body>
  ...
  <section class="trip-home">
    <div class="container" style="  position: relative;">
      <h1>ADVENTUROUS VARKALA WITH TRIVANDRUM</h1>
    </div>
  </section>
                ...
                <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                  ...
                  <div class="accordion-body">
                    <ul class="acc-inner">
                      ...
                      <li>
                        Unwind at Papanasam Beach and the serene Black Beach (Thiruvambadi Beach) & more.
                      </li>
                      <li>Overnight stay in Varkala.</li>
                    </ul>
                  </div>
              ...
              <div class="accordion-item ai1">
                <h2 class="accordion-header" id="headingTwo">
                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                    ...
                    <div class="days"> Day 3 </div>: Forts, Kayaks & Nightlife
                  </button>
                </h2>
              ...
              <div class="accordion-item ai1">
                <h2 class="accordion-header" id="headingTwo">
                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                    ...
                    <div class="days">Day 4</div>: Farewell, Trivandrum sightseeing & Depart from Varkala
                  </button>
                </h2>
