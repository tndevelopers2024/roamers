...
<head>
    ...
    <title>Roamers - Varkala Trip 4 Days 3 Nights</title>
...
ADVENTUROUS VARKALA WITH TRIVANDRUM
            </h2>
                        ...
                        <div class="swiper miniSlider px-px-md-0 py-3">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <img src="https://roamers.in/assets/img/varkala/Munroesland.jpg"
                                        class="img-fluid w-100" alt="Varkala Beach"
                                        style="border-radius: 10px; height: 350px; object-fit: cover;">
                                </div>
                                <div class="swiper-slide">
                                    <img src="https://roamers.in/assets/img/varkala/varkalaimg-1.jpg"
        ...
        <section class="ilt-up" id="itinerary">
            ...
            <div class="price-sticky" style="position: sticky;">
              <div class="priceCard shadow" style="border-radius: 10px;">
                <img src="https://roamers.in/assets/img/varkala/varkala-1.jpg" alt="Varkala Banner"
                  ...
                  <div class="inner-box" style="background-color: #f0f0f0; padding: 15px; border-radius: 10px;">
                    ...
                    <div class="trip-form p-0">
                      <a href="https://wa.me/message/QYDBK5TO42TGH1" target="blank" class="btn butn butn__new bg-"
                        style="border-radius: 10px; background-color: light-green !imortant;">ENQUIRY NOW</a>
                    </div>
                  </div>
                </div>
              </div>
