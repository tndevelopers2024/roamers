...
<body>
    ...
    <section class="">
        <div class="container">
            <form action="spitivalley-winter-mail-send-christmas-new-year.php" method="POST" autocomplete="off">
                        ...
                        <div class="row px-2 px-md-4">
                            ...
                            <div class="cost-col mt-3" style="border-radius: 20px;">
                                ...
                                <div class="justify-content-center starting-price-box px-3">
                                    <p id="starting-price" class="starting-price">₹28,990/-</p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            fetch("./dynamic/varkala-data.json") // Check this path
                ...
                .then(data => {
                    const locationKey = "spiti-valley-winter-christmas-new-year";
