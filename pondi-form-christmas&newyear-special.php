...
<head>
  ...
  <style>
    ...
    .background-image {
      ...
      width: 100%;
      height: 100%;
      background: url('assets/img/pondicherry/Media/Pondy-cover2.jpg');
...
<body>
  ...
  <section class="">
    <div class="container">
      <form action="pondicherry-christmas-new-year" method="POST" autocomplete="off">
            ...
            <div class="row px-2 px-md-4">
              ...
              <div class="cost-col mt-3" style="border-radius: 20px;">
                ...
                <div class="justify-content-center starting-price-box px-3">
                  <p id="pondi-price" class="starting-price"></p>
                </div>
              </div>
            </div>
          </div>
  ...
  <script>
    document.addEventListener("DOMContentLoaded", function () {
      fetch("./dynamic/varkala-data.json") // Check this path
        ...
        .then(data => {
          const locationKey = "pondicherry-christmas-new-year";
          ...
          if (startingPriceElem) {
            startingPriceElem.textContent = `Starting Price: ₹4,990/- `;
          } else {
  ...
  <script>
    document.addEventListener("DOMContentLoaded", function () {
      fetch("./dynamic/varkala-data.json") // to change the price ... 
        ...
        .then(data => {
          const locationKey = "pondicherry-christmas-new-year"; // Change to "ooty" if needed
          const locationData = data[locationKey];
      ...
      if (nextBtn2) {
        nextBtn2.addEventListener("click", (e) => {
          ...
          if (sharing === "Triple Sharing") {
            perPersonAmount = 4990;
          } else if (sharing === "Double Sharing") {
            perPersonAmount = 5500;
          }
