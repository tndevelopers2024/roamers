                ...
                <div class="p-2">
                  ...
                  <div class="inner-box" style="background-color: #f0f0f0; padding: 15px; border-radius: 30px;">
                    ...
                    <div class="trip-form p-0">
                      <a href="kolukkumalai-form.php" class="btn butn butn__new bg-" style="border-radius: 30px;">Dates
                        & Costing</a>
                    </div>
                  </div>
                </div>
        ...
        <div style="position: relative;">
            <div class="swiper rewind-swiper" style="overflow: visible !important;">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="rewind-card">
                            <img src="https://www.roamers.in/assets/img/kolukkumalai-img/sunset%20trek.jpg" alt="Sri Lanka 7">
                        </div>
                    </div>
                    ...
                    <div class="swiper-slide">
                        <div class="rewind-card">
                            <img src="https://www.roamers.in/assets/img/kolukkumalai-img/Mattupetty-Dam.jpg" alt="Sri Lanka 8">
                        </div>
                    </div>
                    ...
                    <div class="swiper-slide">
                        <div class="rewind-card">
                            <img src="https://www.roamers.in/assets/img/kolukkumalai-img/Kundala-lake.jpg" alt="Sri Lanka 9">
                        </div>
                    </div>
                    ...
                    <div class="swiper-slide">
                        <div class="rewind-card">
                            <img src="https://www.roamers.in/assets/img/kolukkumalai-img/2.jpg" alt="Sri Lanka 11">
                        </div>
                    </div>
                    ...
                    <div class="swiper-slide">
                        <div class="rewind-card">
                            <img src="https://www.roamers.in/assets/img/kolukkumalai-img/Mattupetty-Dam.jpg" alt="Sri Lanka 12">
                        </div>
                    </div>
