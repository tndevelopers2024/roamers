...
<body>
  ...
  <section class="">
    <div class="container">
      <form action="kodaikanal1-mail-send.php" method="POST" autocomplete="off">
      ...
      fetch("./dynamic/varkala-data.json") // Check this path
        ...
        .then(data => {
          ...
          if (startingPriceElem) {
            startingPriceElem.textContent = `Starting Price: ₹8,500/- `;
          } else {
  ...
  <script>
    document.addEventListener("DOMContentLoaded", function () {
      fetch("./dynamic/varkala-data.json") // to change the price ... 
        ...
        .then(data => {
          const locationKey = "kodaikanal1"; // Change to "ooty" if needed
          const locationData = data[locationKey];
