...
<head>
  ...
  <meta property="og:title" content="Roamers - Kodaikanal" />
  <meta property="og:description"
    content="Get ready for the ultimate Kodaikanal adventure! We'll be conquering peaks, ticking off viewpoints, chasing waterfalls, and camping under the stars. Expect epic views, wildlife spotting, challenging treks, and getting fully immersed in nature. " />
  ...
  <meta name="twitter:title" content="Roamers - Kodaikanal" />
                ...
                <div class="p-2">
                  ...
                  <div class="inner-box" style="background-color: #f0f0f0; padding: 15px; border-radius: 10px;">
                    ...
                    <h5 class="special-offer">
                      ...
                      <span class="kodaikanal1-price new-price"></span><span class="new-price ">/-</span>
                    </h5>

                    <p>perfect for group adventures and shared <br> memories.</p>
                    <div class="trip-form p-0">
                      <a href="kodaikanal1-form.php" class="btn butn butn__new bg-" style="border-radius: 10px;">Dates
                        & Costing</a>
                    </div>
                  </div>
                </div>
    ...
    <div class="bottom-bar-content">
      <div class="price-box ">
        ...
        <div class="price-info">
          <span class="price-amount ">₹8990/-</span>
