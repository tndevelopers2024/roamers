...
<body>
            ...
            <div class="swiper miniSlider px-px-md-0 py-3">
              <div class="swiper-wrapper">
                <div class="swiper-slide">
                  <img src="assets/img/yelagiri/yelagiri-001.webp" class="img-fluid w-100"
                    alt="Varkala Beach" style="border-radius: 30px; height: 350px; object-fit: cover;">
                </div>
                <div class="swiper-slide">
                  <img src="assets/img/yelagiri/yelagiri-002.avif" class="img-fluid w-100"
                    alt="Varkala Black Beach" style="border-radius: 30px; height: 350px; object-fit: cover;">
                </div>
                <div class="swiper-slide">
                  <img src="assets/img/yelagiri/yelagiri-005.png" class="img-fluid w-100"
                    alt="Varkala Cliffs" style="border-radius: 30px; height: 350px; object-fit: cover;">
                </div>
                <div class="swiper-slide">
                  <img src="assets/img/yelagiri/yelagiri-006.webp" class="img-fluid w-100"
                    alt="Kappil Beach Varkala" style="border-radius: 30px; height: 350px; object-fit: cover;">
                </div>
                <div class="swiper-slide">
                  <img src="assets/img/yelagiri/yelagiri-007.jpg" class="img-fluid w-100"
                    alt="Kappil Beach Varkala" style="border-radius: 30px; height: 350px; object-fit: cover;">
                </div>
              </div>
            </div>
      ...
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <div class="slider-image">
            <img src="assets/img/yelagiri/yelagiri-003.jpeg" alt="Sri Lanka 1">
          </div>
        </div>
        <div class="swiper-slide">
          <div class="slider-image">
            <img src="assets/img/yelagiri/yelagiri-004.jpeg" alt="Sri Lanka 3">
          </div>
        </div>
        <div class="swiper-slide">
          <div class="slider-image">
            <img src="assets/img/yelagiri/yelagiri-005.png" alt="Sri Lanka 3">
          </div>
        </div>
        <div class="swiper-slide">
          <div class="slider-image">
            <img src="assets/img/yelagiri/yelagiri-006.webp" alt="Sri Lanka 3">
          </div>
        </div>
        <div class="swiper-slide">
          <div class="slider-image">
            <img src="assets/img/yelagiri/yelagiri-007.jpg" alt="Sri Lanka 3">
          </div>
        </div>
        <div class="swiper-slide">
          <div class="slider-image">
            <img src="assets/img/yelagiri/yelagiri-008.jpg" alt="Sri Lanka 3">
          </div>
        </div>
        <div class="swiper-slide">
          <div class="slider-image">
            <img src="assets/img/yelagiri/yelagiri-009.jpg" alt="Sri Lanka 3">
          </div>
        </div>
        <div class="swiper-slide">
          <div class="slider-image">
            <img src="assets/img/yelagiri/yelagiri-010.jpg" alt="Sri Lanka 4">
          </div>
        </div>
      </div>
  ...
  <script>
    ...
    const images = [
      "assets/img/yelagiri/yelagiri-002.avif",
    ];
