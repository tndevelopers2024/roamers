...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        $mail->isHTML(true);
        $mail->Subject = 'NEW MAGICAL VARKALA BOOKED';
        $mail->AddEmbeddedImage('assets/img/varkala/varkala-bg1.jpg', 'varkalaimg');
        ...
        '>
            <div style='background: linear-gradient(90deg, #4ec0db 0%, #1e90ff 100%); padding: 32px 0 18px 0; text-align: center;'>
                <img src='cid:varkalaimg' alt='varkalaimg' style='width: 100%; max-width: 420px; height: 180px; object-fit: cover; border-radius: 12px; box-shadow: 0 2px 12px rgba(0,0,0,0.08); margin-bottom: 18px;' />
        ...
        <body>
            <div class="thankyou-container">
                ...
                <div class="thankyou-msg">
                    Your Magical Varkala booking has been received.<br>
        ...
        echo "<script>
            document.body.innerHTML += `<div id='varkala-modal-error' style=\"
